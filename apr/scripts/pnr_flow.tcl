...
set VERILOG_TOPLEVEL ../../dc/TOP/TOP.v 
...
report_route
reportCongestion -overflow
reportPower -leakage -view view_slow_mission -outfile power_setup_leakage_opt.rpt
reportPower -leakage -view view_fast_mission -outfile power_hold_leakage_opt.rpt
reportPower -view view_slow_mission -hierarchy all -outfile power_signoff.rpt
