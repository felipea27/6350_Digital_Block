...
#Placement of the Standart Cells
setPlaceMode -reset
setPlaceMode -congEffort auto -timingDriven 1 -modulePlan 1 -clkGateAware 1 -powerDriven 1 -ignoreScan 1 -reorderScan 1 -ignoreSpare 0 -placeIOPins 1 -moduleAwareSpare 0 -checkPinLayerForAccess {  1 2 3 4 } -maxRouteLayer 11 -preserveRouting 0 -rmAffectedRouting 1 -checkRoute 1 -swapEEQ 0
