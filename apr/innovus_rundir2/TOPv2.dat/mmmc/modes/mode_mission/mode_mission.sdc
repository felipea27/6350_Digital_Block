...
#  Generated on:      Wed May 28 14:21:07 2025
#  Design:            TOP
#  Command:           saveDesign TOPv2
###############################################################
current_design TOP
...
set_max_capacitance 0.005  [get_pins {FE_PHC511_MOSI/X}]
set_max_fanout 4  [get_pins {FE_PHC511_MOSI/X}]
set_max_capacitance 0.005  [get_pins {FE_PHC505_CS/X}]
set_max_fanout 4  [get_pins {FE_PHC505_CS/X}]
set_max_capacitance 0.005  [get_pins {FE_PHC360_RX/X}]
set_max_fanout 4  [get_pins {FE_PHC360_RX/X}]
set_max_capacitance 0.005  [get_pins {FE_PHC81_MOSI/X}]
set_max_fanout 4  [get_pins {FE_PHC81_MOSI/X}]
set_max_capacitance 0.005  [get_pins {FE_PHC73_SCK/X}]
set_max_fanout 4  [get_pins {FE_PHC73_SCK/X}]
