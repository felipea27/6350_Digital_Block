...
#  OS:                Linux x86_64(Host ID linrack7.bioeelocal)
#  Generated on:      Sat May 31 22:02:56 2025
#  Design:            TOP
#  Command:           saveDesign TOPv7drcclean
###############################################################
current_design TOP
...
set_max_capacitance 0.005  [get_pins {FE_PHC1936_MOSI/X}]
set_max_fanout 4  [get_pins {FE_PHC1936_MOSI/X}]
set_max_capacitance 0.005  [get_pins {FE_PHC1282_CS/X}]
set_max_fanout 4  [get_pins {FE_PHC1282_CS/X}]
set_max_capacitance 0.005  [get_pins {FE_PHC1074_CS/X}]
set_max_fanout 4  [get_pins {FE_PHC1074_CS/X}]
set_max_capacitance 0.005  [get_pins {FE_PHC864_RX/X}]
set_max_fanout 4  [get_pins {FE_PHC864_RX/X}]
set_max_capacitance 0.005  [get_pins {FE_PHC853_MOSI/X}]
set_max_fanout 4  [get_pins {FE_PHC853_MOSI/X}]
set_max_capacitance 0.005  [get_pins {FE_PHC851_CS/X}]
set_max_fanout 4  [get_pins {FE_PHC851_CS/X}]
set_max_capacitance 0.005  [get_pins {FE_PHC611_CS/X}]
set_max_fanout 4  [get_pins {FE_PHC611_CS/X}]
set_max_capacitance 0.005  [get_pins {FE_PHC608_RX/X}]
set_max_fanout 4  [get_pins {FE_PHC608_RX/X}]
set_max_capacitance 0.005  [get_pins {FE_PHC605_MOSI/X}]
set_max_fanout 4  [get_pins {FE_PHC605_MOSI/X}]
set_max_capacitance 0.005  [get_pins {FE_PHC357_CS/X}]
set_max_fanout 4  [get_pins {FE_PHC357_CS/X}]
set_max_capacitance 0.005  [get_pins {FE_PHC344_MOSI/X}]
set_max_fanout 4  [get_pins {FE_PHC344_MOSI/X}]
set_max_capacitance 0.005  [get_pins {FE_PHC290_RX/X}]
set_max_fanout 4  [get_pins {FE_PHC290_RX/X}]
set_max_capacitance 0.005  [get_pins {FE_PHC83_CS/X}]
set_max_fanout 4  [get_pins {FE_PHC83_CS/X}]
set_max_capacitance 0.005  [get_pins {FE_PHC20_RX/X}]
set_max_fanout 4  [get_pins {FE_PHC20_RX/X}]
