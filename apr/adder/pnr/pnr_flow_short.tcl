...
set VERILOG_TOPLEVEL ../adder_nl.v 
...
#floorPlan -site GF22_DST -r 1.0 0.15 4 4 4 4 
uiSetTool select
getIoFlowFlag
fit
generateTracks
...
addRing -nets {vdd gnd} -layer {top M1 bottom M1 left M2 right M2} -width 0.1 -spacing 0.1 -offset 0.1 
...
#------------------------------------------------------------
#add_well_taps -cell */*_TAPSS -distance 100
#add_well_taps -cell */*_TAPPN_DN -distance 100
...
# Usually need futher HOLD violation optimization after initial routing
