...
=======
  ...
  UDB116SVT24_FDPQ_1 \OUT_reg[0]  ( .D(SHIFT_REG[0]), .CK(n4), .Q(OUT[0]) );
  UDB116SVT24_FDPQ_1 \OUT_reg[7]  ( .D(SHIFT_REG[7]), .CK(n2), .Q(OUT[7]) );
  UDB116SVT24_OR2_0P75 U1 ( .A1(SS_neg_flag), .A2(n8), .X(n27) );
  ...
  UDB116SVT24_INV_0P75 U21 ( .A(SS_neg_flag), .X(n26) );
  UDB116SVT24_INV_0P75 U22 ( .A(N47), .X(n16) );
  UDB116SVT24_OAI21_0P75 U23 ( .A1(n2), .A2(n26), .B(n16), .X(n19) );
  UDB116SVT24_ND2_MM_0P75 U24 ( .A1(n4), .A2(n29), .X(n20) );
  UDB116SVT24_OAI21_0P75 U25 ( .A1(n3), .A2(SS_neg_flag), .B(n16), .X(n18) );
  ...
  UDB116SVT24_NR2_0P75 U30 ( .A1(n8), .A2(n22), .X(N51) );
  UDB116SVT24_NR2_0P75 U31 ( .A1(counter[0]), .A2(n6), .X(N49) );
  UDB116SVT24_AOI211_0P75 U32 ( .A1(n25), .A2(n24), .B1(n6), .B2(n23), .X(N50)
         );
  UDB116SVT24_AO22_1 U33 ( .A1(n14), .A2(DATA[4]), .B1(n11), .B2(SHIFT_REG[3]), 
        .X(N42) );
  UDB116SVT24_AO22_1 U34 ( .A1(n15), .A2(DATA[5]), .B1(n13), .B2(SHIFT_REG[4]), 
        .X(N43) );
  UDB116SVT24_AO22_1 U35 ( .A1(n14), .A2(DATA[3]), .B1(n11), .B2(SHIFT_REG[2]), 
        .X(N41) );
  UDB116SVT24_AO22_1 U36 ( .A1(n15), .A2(DATA[6]), .B1(n13), .B2(SHIFT_REG[5]), 
        .X(N44) );
  UDB116SVT24_AO22_1 U37 ( .A1(n14), .A2(DATA[0]), .B1(n11), .B2(SHIFT_IN), 
        .X(N38) );
  UDB116SVT24_AO22_1 U38 ( .A1(n15), .A2(DATA[7]), .B1(n13), .B2(SHIFT_REG[6]), 
        .X(N45) );
  UDB116SVT24_AO22_1 U39 ( .A1(n14), .A2(DATA[2]), .B1(n11), .B2(SHIFT_REG[1]), 
        .X(N40) );
  UDB116SVT24_AO22_1 U40 ( .A1(n15), .A2(DATA[1]), .B1(n13), .B2(SHIFT_REG[0]), 
        .X(N39) );
  UDB116SVT24_AO22_1 U41 ( .A1(n2), .A2(SHIFT_IN), .B1(MOSI), .B2(n12), .X(n17) );
>>>>>>> 8334d12b4657a094ccdd22848e8853946d20d6e8
endmodule
...
=======
         \fsm_sync_inst/sh_en_prev , \fsm_sync_inst/n7 ,
         \fsm_sync_inst/state_neg , \fsm_sync_inst/N13 ,
         \fsm_sync_inst/state_pos , \fsm_sync_inst/N11 , \sh_sync_inst/n146 ,
...
=======
         \sh_sync_inst/rfin_edge , \sh_sync_inst/n145 , \sh_sync_inst/n148 ,
         \sh_sync_inst/n274 , \sh_sync_inst/n150 , \sh_sync_inst/n276 ,
         \sh_sync_inst/n152 , \sh_sync_inst/n278 , \sh_sync_inst/n154 ,
         \sh_sync_inst/n280 , \sh_sync_inst/n156 , \sh_sync_inst/n282 ,
         \sh_sync_inst/n158 , \sh_sync_inst/n284 , \sh_sync_inst/n160 ,
         \sh_sync_inst/n286 , \sh_sync_inst/intadd_0/A[12] ,
         \sh_sync_inst/n289 , \sh_sync_inst/intadd_0/A[9] ,
         \sh_sync_inst/n292 , \sh_sync_inst/intadd_0/A[6] ,
         \sh_sync_inst/n295 , \sh_sync_inst/intadd_0/A[3] ,
         \sh_sync_inst/n298 , \sh_sync_inst/n176 , \sh_sync_inst/n302 ,
         \sh_sync_inst/n177 , \sh_sync_inst/n303 , \sh_sync_inst/n178 ,
         \sh_sync_inst/n308 , \sh_sync_inst/n179 , \sh_sync_inst/n309 ,
         \sh_sync_inst/n181 , \sh_sync_inst/n311 , \sh_sync_inst/n182 ,
         \sh_sync_inst/n312 , \sh_sync_inst/n183 , \sh_sync_inst/n313 ,
         \sh_sync_inst/n184 , \sh_sync_inst/n314 , \sh_sync_inst/n185 ,
         \sh_sync_inst/n315 , \sh_sync_inst/n186 , \sh_sync_inst/n316 ,
         \sh_sync_inst/n187 , \sh_sync_inst/n317 , \sh_sync_inst/n188 ,
         \sh_sync_inst/n318 , \sh_sync_inst/n189 , \sh_sync_inst/n319 ,
         \sh_sync_inst/n190 , \sh_sync_inst/n320 , \sh_sync_inst/n191 ,
         \sh_sync_inst/n321 , \sh_sync_inst/n192 , \sh_sync_inst/n322 ,
         \sh_sync_inst/n193 , \sh_sync_inst/n323 , \sh_sync_inst/n194 ,
         \sh_sync_inst/n338 , \sh_sync_inst/intadd_0/B[7] ,
         \sh_sync_inst/n262 , \sh_sync_inst/intadd_0/B[6] ,
         \sh_sync_inst/n263 , \sh_sync_inst/intadd_0/B[5] ,
         \sh_sync_inst/n264 , \sh_sync_inst/n203 , \sh_sync_inst/n307 ,
         \sh_sync_inst/n204 , \sh_sync_inst/n356 , \sh_sync_inst/n205 ,
         ...
         \sh_sync_inst/N535 , \shift_buf_inst/n139 , \shift_buf_inst/n74 ,
         \shift_buf_inst/n89 , \shift_buf_inst/n104 , \shift_buf_inst/n120 ,
         \shift_buf_inst/n138 , \shift_buf_inst/N88 , \shift_buf_inst/N7 ,
         \shift_buf_inst/N8 , \shift_buf_inst/N9 , \shift_buf_inst/N10 ,
         \shift_buf_inst/N11 , \shift_buf_inst/N12 , \shift_buf_inst/N13 ,
         \shift_buf_inst/n71 , \shift_buf_inst/n72 , \shift_buf_inst/n73 ,
>>>>>>> 8334d12b4657a094ccdd22848e8853946d20d6e8
...
=======
         \shift_buf_inst/n87 , \shift_buf_inst/n88 , \shift_buf_inst/n90 ,
>>>>>>> 8334d12b4657a094ccdd22848e8853946d20d6e8
...
=======
         \shift_buf_inst/n103 , \shift_buf_inst/n105 , \shift_buf_inst/n106 ,
         \shift_buf_inst/n107 , \shift_buf_inst/n108 , \shift_buf_inst/n109 ,
         \shift_buf_inst/n111 , \shift_buf_inst/n112 , \shift_buf_inst/n113 ,
         \shift_buf_inst/n114 , \shift_buf_inst/n115 , \shift_buf_inst/n116 ,
         \shift_buf_inst/n117 , \shift_buf_inst/n118 , \shift_buf_inst/n119 ,
>>>>>>> 8334d12b4657a094ccdd22848e8853946d20d6e8
...
<<<<<<< HEAD
         ...
         net4587;
=======
         \shift_buf_inst/n133 , \shift_buf_inst/n134 , \pkt_reg_inst/n108 ,
         \pkt_reg_inst/n71 , \pkt_reg_inst/n61 , \pkt_reg_inst/n59 ,
         \pkt_reg_inst/n49 , \pkt_reg_inst/n109 , \pkt_reg_inst/n32 ,
         \pkt_reg_inst/n33 , \pkt_reg_inst/n34 , \pkt_reg_inst/n35 ,
         \pkt_reg_inst/n36 , \pkt_reg_inst/n37 , \pkt_reg_inst/n39 ,
         \pkt_reg_inst/n47 , \pkt_reg_inst/n55 , \pkt_reg_inst/n63 ,
         \pkt_reg_inst/n79 , \pkt_reg_inst/n87 , \pkt_reg_inst/n95 ,
         \pkt_reg_inst/n103 , \pkt_reg_inst/n46 , \pkt_reg_inst/n54 ,
         \pkt_reg_inst/n62 , \pkt_reg_inst/n70 , \pkt_reg_inst/n78 ,
         \pkt_reg_inst/n86 , \pkt_reg_inst/n94 , \pkt_reg_inst/n102 ,
         \pkt_reg_inst/n45 , \pkt_reg_inst/n53 , \pkt_reg_inst/n69 ,
         \pkt_reg_inst/n77 , \pkt_reg_inst/n85 , \pkt_reg_inst/n93 ,
         \pkt_reg_inst/n101 , \pkt_reg_inst/n44 , \pkt_reg_inst/n52 ,
         \pkt_reg_inst/n60 , \pkt_reg_inst/n68 , \pkt_reg_inst/n76 ,
         \pkt_reg_inst/n84 , \pkt_reg_inst/n92 , \pkt_reg_inst/n43 ,
         \pkt_reg_inst/n51 , \pkt_reg_inst/n67 , \pkt_reg_inst/n75 ,
         \pkt_reg_inst/n83 , \pkt_reg_inst/n91 , \pkt_reg_inst/n99 ,
         \pkt_reg_inst/n42 , \pkt_reg_inst/n50 , \pkt_reg_inst/n58 ,
         \pkt_reg_inst/n66 , \pkt_reg_inst/n74 , \pkt_reg_inst/n82 ,
         \pkt_reg_inst/n90 , \pkt_reg_inst/n98 , \pkt_reg_inst/n41 ,
         \pkt_reg_inst/n57 , \pkt_reg_inst/n65 , \pkt_reg_inst/n73 ,
         \pkt_reg_inst/n81 , \pkt_reg_inst/n89 , \pkt_reg_inst/n97 ,
         \pkt_reg_inst/n40 , \pkt_reg_inst/n48 , \pkt_reg_inst/n56 ,
         \pkt_reg_inst/n64 , \pkt_reg_inst/n72 , \pkt_reg_inst/n80 ,
         \pkt_reg_inst/n88 , \pkt_reg_inst/n96 , \tx_buf_inst/n11 ,
         \tx_buf_inst/n10 , \tx_buf_inst/n9 , \tx_buf_inst/n8 ,
         \tx_buf_inst/n7 , \tx_buf_inst/n6 , \tx_buf_inst/n5 ,
         \tx_buf_inst/n12 , n827, n828, n829, n830, n831, n832, n833, n834,
...
=======
  SPI_slave SPI_slave_inst ( .MOSI(MOSI), .SCK(SCK), .SS(n988), .MODE({net4591, 
        net4592}), .DATA(SPI_IN), .OUT(SPI_OUT), .MISO(MISO), .PRESETn_BAR(
        n985) );
  UDB116SVT24_FDPQB_1P5 \fsm_sync_inst/sh_en_prev_reg  ( .D(\fsm_sync_inst/n7 ), .CK(clk), .QN(\fsm_sync_inst/sh_en_prev ) );
  UDB116SVT24_FDNQ_V2_1 \fsm_sync_inst/state_neg_reg  ( .D(\fsm_sync_inst/N13 ), .CK(clk), .Q(\fsm_sync_inst/state_neg ) );
>>>>>>> 8334d12b4657a094ccdd22848e8853946d20d6e8
...
=======
  UDB116SVT24_FDPQB_1P5 \sh_sync_inst/state_reg[1]  ( .D(\sh_sync_inst/N31 ), 
        .CK(clk), .QN(\sh_sync_inst/n228 ) );
  UDB116SVT24_FDPQ_V2_3 \sh_sync_inst/rfin_edge_reg  ( .D(\sh_sync_inst/n145 ), 
...
=======
        \shift_buf_inst/n139 ), .CK(clk), .QN(SHIFT_OUT[24]) );
  UDB116SVT24_FDPQ_V2_3 \shift_buf_inst/shift_reg_reg[60]  ( .D(
        \shift_buf_inst/n74 ), .CK(clk), .Q(SHIFT_OUT[60]) );
  UDB116SVT24_FDPQ_V2_3 \shift_buf_inst/shift_reg_reg[45]  ( .D(
        \shift_buf_inst/n89 ), .CK(clk), .Q(SHIFT_OUT[45]) );
  UDB116SVT24_FDPQ_V2_3 \shift_buf_inst/shift_reg_reg[30]  ( .D(
        \shift_buf_inst/n104 ), .CK(clk), .Q(SHIFT_OUT[30]) );
  UDB116SVT24_FDPQ_V2_3 \shift_buf_inst/shift_reg_reg[14]  ( .D(
        \shift_buf_inst/n120 ), .CK(clk), .Q(SHIFT_OUT[14]) );
  UDB116SVT24_FDPQB_2 \shift_buf_inst/sync_reg[0]  ( .D(\shift_buf_inst/n138 ), 
>>>>>>> 8334d12b4657a094ccdd22848e8853946d20d6e8
...
=======
        \shift_buf_inst/n71 ), .CK(clk), .Q(SHIFT_OUT[63]) );
  UDB116SVT24_FDPQ_V2_3 \shift_buf_inst/shift_reg_reg[62]  ( .D(
        \shift_buf_inst/n72 ), .CK(clk), .Q(SHIFT_OUT[62]) );
  UDB116SVT24_FDPQ_V2_3 \shift_buf_inst/shift_reg_reg[61]  ( .D(
        \shift_buf_inst/n73 ), .CK(clk), .Q(SHIFT_OUT[61]) );
  UDB116SVT24_FDPQ_V2_3 \shift_buf_inst/shift_reg_reg[59]  ( .D(
        \shift_buf_inst/n75 ), .CK(clk), .Q(SHIFT_OUT[59]) );
  UDB116SVT24_FDPQ_V2_3 \shift_buf_inst/shift_reg_reg[58]  ( .D(
        \shift_buf_inst/n76 ), .CK(clk), .Q(SHIFT_OUT[58]) );
  UDB116SVT24_FDPQ_V2_3 \shift_buf_inst/shift_reg_reg[57]  ( .D(
        \shift_buf_inst/n77 ), .CK(clk), .Q(SHIFT_OUT[57]) );
  UDB116SVT24_FDPQ_V2_3 \shift_buf_inst/shift_reg_reg[56]  ( .D(
        \shift_buf_inst/n78 ), .CK(clk), .Q(SHIFT_OUT[56]) );
  UDB116SVT24_FDPQ_V2_3 \shift_buf_inst/shift_reg_reg[54]  ( .D(
        \shift_buf_inst/n80 ), .CK(clk), .Q(SHIFT_OUT[54]) );
  UDB116SVT24_FDPQ_V2_3 \shift_buf_inst/shift_reg_reg[53]  ( .D(
        \shift_buf_inst/n81 ), .CK(clk), .Q(SHIFT_OUT[53]) );
  UDB116SVT24_FDPQ_V2_3 \shift_buf_inst/shift_reg_reg[52]  ( .D(
        \shift_buf_inst/n82 ), .CK(clk), .Q(SHIFT_OUT[52]) );
  UDB116SVT24_FDPQ_V2_3 \shift_buf_inst/shift_reg_reg[51]  ( .D(
        \shift_buf_inst/n83 ), .CK(clk), .Q(SHIFT_OUT[51]) );
  UDB116SVT24_FDPQ_V2_3 \shift_buf_inst/shift_reg_reg[50]  ( .D(
        \shift_buf_inst/n84 ), .CK(clk), .Q(SHIFT_OUT[50]) );
  UDB116SVT24_FDPQ_V2_3 \shift_buf_inst/shift_reg_reg[49]  ( .D(
        \shift_buf_inst/n85 ), .CK(clk), .Q(SHIFT_OUT[49]) );
  UDB116SVT24_FDPQ_V2_3 \shift_buf_inst/shift_reg_reg[48]  ( .D(
        \shift_buf_inst/n86 ), .CK(clk), .Q(SHIFT_OUT[48]) );
  UDB116SVT24_FDPQ_V2_3 \shift_buf_inst/shift_reg_reg[47]  ( .D(
        \shift_buf_inst/n87 ), .CK(clk), .Q(SHIFT_OUT[47]) );
  UDB116SVT24_FDPQ_V2_3 \shift_buf_inst/shift_reg_reg[46]  ( .D(
        \shift_buf_inst/n88 ), .CK(clk), .Q(SHIFT_OUT[46]) );
  UDB116SVT24_FDPQ_V2_3 \shift_buf_inst/shift_reg_reg[44]  ( .D(
        \shift_buf_inst/n90 ), .CK(clk), .Q(SHIFT_OUT[44]) );
  UDB116SVT24_FDPQ_V2_3 \shift_buf_inst/shift_reg_reg[43]  ( .D(
        \shift_buf_inst/n91 ), .CK(clk), .Q(SHIFT_OUT[43]) );
  UDB116SVT24_FDPQ_V2_3 \shift_buf_inst/shift_reg_reg[42]  ( .D(
        \shift_buf_inst/n92 ), .CK(clk), .Q(SHIFT_OUT[42]) );
  UDB116SVT24_FDPQ_V2_3 \shift_buf_inst/shift_reg_reg[41]  ( .D(
        \shift_buf_inst/n93 ), .CK(clk), .Q(SHIFT_OUT[41]) );
  UDB116SVT24_FDPQ_V2_3 \shift_buf_inst/shift_reg_reg[40]  ( .D(
        \shift_buf_inst/n94 ), .CK(clk), .Q(SHIFT_OUT[40]) );
  UDB116SVT24_FDPQ_V2_3 \shift_buf_inst/shift_reg_reg[38]  ( .D(
        \shift_buf_inst/n96 ), .CK(clk), .Q(SHIFT_OUT[38]) );
  UDB116SVT24_FDPQ_V2_3 \shift_buf_inst/shift_reg_reg[37]  ( .D(
        \shift_buf_inst/n97 ), .CK(clk), .Q(SHIFT_OUT[37]) );
  UDB116SVT24_FDPQ_V2_3 \shift_buf_inst/shift_reg_reg[36]  ( .D(
        \shift_buf_inst/n98 ), .CK(clk), .Q(SHIFT_OUT[36]) );
  UDB116SVT24_FDPQ_V2_3 \shift_buf_inst/shift_reg_reg[35]  ( .D(
        \shift_buf_inst/n99 ), .CK(clk), .Q(SHIFT_OUT[35]) );
  UDB116SVT24_FDPQ_V2_3 \shift_buf_inst/shift_reg_reg[34]  ( .D(
        \shift_buf_inst/n100 ), .CK(clk), .Q(SHIFT_OUT[34]) );
  UDB116SVT24_FDPQ_V2_3 \shift_buf_inst/shift_reg_reg[33]  ( .D(
        \shift_buf_inst/n101 ), .CK(clk), .Q(SHIFT_OUT[33]) );
  UDB116SVT24_FDPQ_V2_3 \shift_buf_inst/shift_reg_reg[32]  ( .D(
        \shift_buf_inst/n102 ), .CK(clk), .Q(SHIFT_OUT[32]) );
  UDB116SVT24_FDPQ_V2_3 \shift_buf_inst/shift_reg_reg[31]  ( .D(
        \shift_buf_inst/n103 ), .CK(clk), .Q(SHIFT_OUT[31]) );
  UDB116SVT24_FDPQ_V2_3 \shift_buf_inst/shift_reg_reg[29]  ( .D(
        \shift_buf_inst/n105 ), .CK(clk), .Q(SHIFT_OUT[29]) );
  UDB116SVT24_FDPQ_V2_3 \shift_buf_inst/shift_reg_reg[28]  ( .D(
        \shift_buf_inst/n106 ), .CK(clk), .Q(SHIFT_OUT[28]) );
  UDB116SVT24_FDPQ_V2_3 \shift_buf_inst/shift_reg_reg[27]  ( .D(
        \shift_buf_inst/n107 ), .CK(clk), .Q(SHIFT_OUT[27]) );
  UDB116SVT24_FDPQ_V2_3 \shift_buf_inst/shift_reg_reg[26]  ( .D(
        \shift_buf_inst/n108 ), .CK(clk), .Q(SHIFT_OUT[26]) );
  UDB116SVT24_FDPQ_V2_3 \shift_buf_inst/shift_reg_reg[25]  ( .D(
        \shift_buf_inst/n109 ), .CK(clk), .Q(SHIFT_OUT[25]) );
  UDB116SVT24_FDPQ_V2_3 \shift_buf_inst/shift_reg_reg[23]  ( .D(
        \shift_buf_inst/n111 ), .CK(clk), .Q(SHIFT_OUT[23]) );
  UDB116SVT24_FDPQ_V2_3 \shift_buf_inst/shift_reg_reg[21]  ( .D(
        \shift_buf_inst/n113 ), .CK(clk), .Q(SHIFT_OUT[21]) );
  UDB116SVT24_FDPQ_V2_3 \shift_buf_inst/shift_reg_reg[20]  ( .D(
        \shift_buf_inst/n114 ), .CK(clk), .Q(SHIFT_OUT[20]) );
  UDB116SVT24_FDPQ_V2_3 \shift_buf_inst/shift_reg_reg[19]  ( .D(
        \shift_buf_inst/n115 ), .CK(clk), .Q(SHIFT_OUT[19]) );
  UDB116SVT24_FDPQ_V2_3 \shift_buf_inst/shift_reg_reg[18]  ( .D(
        \shift_buf_inst/n116 ), .CK(clk), .Q(SHIFT_OUT[18]) );
  UDB116SVT24_FDPQ_V2_3 \shift_buf_inst/shift_reg_reg[17]  ( .D(
        \shift_buf_inst/n117 ), .CK(clk), .Q(SHIFT_OUT[17]) );
  UDB116SVT24_FDPQ_V2_3 \shift_buf_inst/shift_reg_reg[16]  ( .D(
        \shift_buf_inst/n118 ), .CK(clk), .Q(SHIFT_OUT[16]) );
  UDB116SVT24_FDPQ_V2_3 \shift_buf_inst/shift_reg_reg[15]  ( .D(
        \shift_buf_inst/n119 ), .CK(clk), .Q(SHIFT_OUT[15]) );
  UDB116SVT24_FDPQ_V2_3 \shift_buf_inst/shift_reg_reg[13]  ( .D(
        \shift_buf_inst/n121 ), .CK(clk), .Q(SHIFT_OUT[13]) );
  UDB116SVT24_FDPQ_V2_3 \shift_buf_inst/shift_reg_reg[12]  ( .D(
        \shift_buf_inst/n122 ), .CK(clk), .Q(SHIFT_OUT[12]) );
  UDB116SVT24_FDPQ_V2_3 \shift_buf_inst/shift_reg_reg[11]  ( .D(
        \shift_buf_inst/n123 ), .CK(clk), .Q(SHIFT_OUT[11]) );
  UDB116SVT24_FDPQ_V2_3 \shift_buf_inst/shift_reg_reg[10]  ( .D(
        \shift_buf_inst/n124 ), .CK(clk), .Q(SHIFT_OUT[10]) );
  UDB116SVT24_FDPQ_V2_3 \shift_buf_inst/shift_reg_reg[9]  ( .D(
        \shift_buf_inst/n125 ), .CK(clk), .Q(SHIFT_OUT[9]) );
  UDB116SVT24_FDPQ_V2_3 \shift_buf_inst/shift_reg_reg[8]  ( .D(
        \shift_buf_inst/n126 ), .CK(clk), .Q(SHIFT_OUT[8]) );
  UDB116SVT24_FDPQ_V2_3 \shift_buf_inst/shift_reg_reg[7]  ( .D(
        \shift_buf_inst/n127 ), .CK(clk), .Q(SHIFT_OUT[7]) );
  UDB116SVT24_FDPQ_V2_3 \shift_buf_inst/shift_reg_reg[5]  ( .D(
        \shift_buf_inst/n129 ), .CK(clk), .Q(SHIFT_OUT[5]) );
  UDB116SVT24_FDPQ_V2_3 \shift_buf_inst/shift_reg_reg[4]  ( .D(
        \shift_buf_inst/n130 ), .CK(clk), .Q(SHIFT_OUT[4]) );
  UDB116SVT24_FDPQ_V2_3 \shift_buf_inst/shift_reg_reg[3]  ( .D(
        \shift_buf_inst/n131 ), .CK(clk), .Q(SHIFT_OUT[3]) );
  UDB116SVT24_FDPQ_V2_3 \shift_buf_inst/shift_reg_reg[2]  ( .D(
        \shift_buf_inst/n132 ), .CK(clk), .Q(SHIFT_OUT[2]) );
  UDB116SVT24_FDPQ_V2_3 \shift_buf_inst/shift_reg_reg[1]  ( .D(
        \shift_buf_inst/n133 ), .CK(clk), .Q(SHIFT_OUT[1]) );
  UDB116SVT24_FDPQ_V2_3 \shift_buf_inst/shift_reg_reg[0]  ( .D(
        \shift_buf_inst/n134 ), .CK(clk), .Q(SHIFT_OUT[0]) );
  UDB116SVT24_FDPQB_1P5 \pkt_reg_inst/dout_reg[6]  ( .D(\pkt_reg_inst/n108 ), 
        .CK(clk), .QN(SPI_IN[6]) );
  UDB116SVT24_FDPQ_V2_3 \pkt_reg_inst/pkt_reg_reg[32]  ( .D(\pkt_reg_inst/n71 ), .CK(clk), .Q(\pkt_reg_inst/pkt_reg [32]) );
  UDB116SVT24_FDPQ_V2_3 \pkt_reg_inst/pkt_reg_reg[42]  ( .D(\pkt_reg_inst/n61 ), .CK(clk), .Q(\pkt_reg_inst/pkt_reg [42]) );
  UDB116SVT24_FDPQ_V2_3 \pkt_reg_inst/pkt_reg_reg[44]  ( .D(\pkt_reg_inst/n59 ), .CK(clk), .Q(\pkt_reg_inst/pkt_reg [44]) );
  ...
  UDB116SVT24_FDPQ_V2_3 \pkt_reg_inst/dout_reg[0]  ( .D(\pkt_reg_inst/n32 ), 
        .CK(clk), .Q(SPI_IN[0]) );
  UDB116SVT24_FDPQ_V2_3 \pkt_reg_inst/dout_reg[1]  ( .D(\pkt_reg_inst/n33 ), 
        .CK(clk), .Q(SPI_IN[1]) );
  UDB116SVT24_FDPQ_V2_3 \pkt_reg_inst/dout_reg[3]  ( .D(\pkt_reg_inst/n35 ), 
        .CK(clk), .Q(SPI_IN[3]) );
  UDB116SVT24_FDPQ_V2_3 \pkt_reg_inst/dout_reg[4]  ( .D(\pkt_reg_inst/n36 ), 
        .CK(clk), .Q(SPI_IN[4]) );
  UDB116SVT24_FDPQ_V2_3 \pkt_reg_inst/dout_reg[5]  ( .D(\pkt_reg_inst/n37 ), 
        .CK(clk), .Q(SPI_IN[5]) );
  UDB116SVT24_FDPQ_V2_3 \pkt_reg_inst/dout_reg[7]  ( .D(\pkt_reg_inst/n39 ), 
        .CK(clk), .Q(SPI_IN[7]) );
  ...
  UDB116SVT24_FDPQ_V2_3 \pkt_reg_inst/pkt_reg_reg[24]  ( .D(\pkt_reg_inst/n79 ), .CK(clk), .Q(\pkt_reg_inst/pkt_reg [24]) );
  UDB116SVT24_FDPQ_V2_3 \pkt_reg_inst/pkt_reg_reg[16]  ( .D(\pkt_reg_inst/n87 ), .CK(clk), .Q(\pkt_reg_inst/pkt_reg [16]) );
  ...
  UDB116SVT24_FDPQ_V2_3 \pkt_reg_inst/pkt_reg_reg[41]  ( .D(\pkt_reg_inst/n62 ), .CK(clk), .Q(\pkt_reg_inst/pkt_reg [41]) );
  UDB116SVT24_FDPQ_V2_3 \pkt_reg_inst/pkt_reg_reg[25]  ( .D(\pkt_reg_inst/n78 ), .CK(clk), .Q(\pkt_reg_inst/pkt_reg [25]) );
  UDB116SVT24_FDPQ_V2_3 \pkt_reg_inst/pkt_reg_reg[17]  ( .D(\pkt_reg_inst/n86 ), .CK(clk), .Q(\pkt_reg_inst/pkt_reg [17]) );
  UDB116SVT24_FDPQ_V2_3 \pkt_reg_inst/pkt_reg_reg[9]  ( .D(\pkt_reg_inst/n94 ), 
        .CK(clk), .Q(\pkt_reg_inst/pkt_reg [9]) );
  UDB116SVT24_FDPQ_V2_3 \pkt_reg_inst/pkt_reg_reg[1]  ( .D(\pkt_reg_inst/n102 ), .CK(clk), .Q(\pkt_reg_inst/pkt_reg [1]) );
  ...
  UDB116SVT24_FDPQ_V2_3 \pkt_reg_inst/pkt_reg_reg[34]  ( .D(\pkt_reg_inst/n69 ), .CK(clk), .Q(\pkt_reg_inst/pkt_reg [34]) );
  UDB116SVT24_FDPQ_V2_3 \pkt_reg_inst/pkt_reg_reg[26]  ( .D(\pkt_reg_inst/n77 ), .CK(clk), .Q(\pkt_reg_inst/pkt_reg [26]) );
  UDB116SVT24_FDPQ_V2_3 \pkt_reg_inst/pkt_reg_reg[18]  ( .D(\pkt_reg_inst/n85 ), .CK(clk), .Q(\pkt_reg_inst/pkt_reg [18]) );
  UDB116SVT24_FDPQ_V2_3 \pkt_reg_inst/pkt_reg_reg[10]  ( .D(\pkt_reg_inst/n93 ), .CK(clk), .Q(\pkt_reg_inst/pkt_reg [10]) );
  UDB116SVT24_FDPQ_V2_3 \pkt_reg_inst/pkt_reg_reg[2]  ( .D(\pkt_reg_inst/n101 ), .CK(clk), .Q(\pkt_reg_inst/pkt_reg [2]) );
  ...
  UDB116SVT24_FDPQ_V2_3 \pkt_reg_inst/pkt_reg_reg[43]  ( .D(\pkt_reg_inst/n60 ), .CK(clk), .Q(\pkt_reg_inst/pkt_reg [43]) );
  UDB116SVT24_FDPQ_V2_3 \pkt_reg_inst/pkt_reg_reg[27]  ( .D(\pkt_reg_inst/n76 ), .CK(clk), .Q(\pkt_reg_inst/pkt_reg [27]) );
  UDB116SVT24_FDPQ_V2_3 \pkt_reg_inst/pkt_reg_reg[19]  ( .D(\pkt_reg_inst/n84 ), .CK(clk), .Q(\pkt_reg_inst/pkt_reg [19]) );
  UDB116SVT24_FDPQ_V2_3 \pkt_reg_inst/pkt_reg_reg[11]  ( .D(\pkt_reg_inst/n92 ), .CK(clk), .Q(\pkt_reg_inst/pkt_reg [11]) );
  UDB116SVT24_FDPQ_V2_3 \pkt_reg_inst/pkt_reg_reg[60]  ( .D(\pkt_reg_inst/n43 ), .CK(clk), .Q(\pkt_reg_inst/pkt_reg [60]) );
  UDB116SVT24_FDPQ_V2_3 \pkt_reg_inst/pkt_reg_reg[52]  ( .D(\pkt_reg_inst/n51 ), .CK(clk), .Q(\pkt_reg_inst/pkt_reg [52]) );
  UDB116SVT24_FDPQ_V2_3 \pkt_reg_inst/pkt_reg_reg[36]  ( .D(\pkt_reg_inst/n67 ), .CK(clk), .Q(\pkt_reg_inst/pkt_reg [36]) );
  UDB116SVT24_FDPQ_V2_3 \pkt_reg_inst/pkt_reg_reg[28]  ( .D(\pkt_reg_inst/n75 ), .CK(clk), .Q(\pkt_reg_inst/pkt_reg [28]) );
  UDB116SVT24_FDPQ_V2_3 \pkt_reg_inst/pkt_reg_reg[20]  ( .D(\pkt_reg_inst/n83 ), .CK(clk), .Q(\pkt_reg_inst/pkt_reg [20]) );
  UDB116SVT24_FDPQ_V2_3 \pkt_reg_inst/pkt_reg_reg[12]  ( .D(\pkt_reg_inst/n91 ), .CK(clk), .Q(\pkt_reg_inst/pkt_reg [12]) );
  UDB116SVT24_FDPQ_V2_3 \pkt_reg_inst/pkt_reg_reg[4]  ( .D(\pkt_reg_inst/n99 ), 
        .CK(clk), .Q(\pkt_reg_inst/pkt_reg [4]) );
  UDB116SVT24_FDPQ_V2_3 \pkt_reg_inst/pkt_reg_reg[61]  ( .D(\pkt_reg_inst/n42 ), .CK(clk), .Q(\pkt_reg_inst/pkt_reg [61]) );
  ...
  UDB116SVT24_FDPQ_V2_3 \pkt_reg_inst/pkt_reg_reg[21]  ( .D(\pkt_reg_inst/n82 ), .CK(clk), .Q(\pkt_reg_inst/pkt_reg [21]) );
  UDB116SVT24_FDPQ_V2_3 \pkt_reg_inst/pkt_reg_reg[13]  ( .D(\pkt_reg_inst/n90 ), .CK(clk), .Q(\pkt_reg_inst/pkt_reg [13]) );
  ...
  UDB116SVT24_FDPQ_V2_3 \pkt_reg_inst/pkt_reg_reg[30]  ( .D(\pkt_reg_inst/n73 ), .CK(clk), .Q(\pkt_reg_inst/pkt_reg [30]) );
  UDB116SVT24_FDPQ_V2_3 \pkt_reg_inst/pkt_reg_reg[22]  ( .D(\pkt_reg_inst/n81 ), .CK(clk), .Q(\pkt_reg_inst/pkt_reg [22]) );
  UDB116SVT24_FDPQ_V2_3 \pkt_reg_inst/pkt_reg_reg[14]  ( .D(\pkt_reg_inst/n89 ), .CK(clk), .Q(\pkt_reg_inst/pkt_reg [14]) );
  UDB116SVT24_FDPQ_V2_3 \pkt_reg_inst/pkt_reg_reg[6]  ( .D(\pkt_reg_inst/n97 ), 
        .CK(clk), .Q(\pkt_reg_inst/pkt_reg [6]) );
  UDB116SVT24_FDPQ_V2_3 \pkt_reg_inst/pkt_reg_reg[63]  ( .D(\pkt_reg_inst/n40 ), .CK(clk), .Q(\pkt_reg_inst/pkt_reg [63]) );
  UDB116SVT24_FDPQ_V2_3 \pkt_reg_inst/pkt_reg_reg[55]  ( .D(\pkt_reg_inst/n48 ), .CK(clk), .Q(\pkt_reg_inst/pkt_reg [55]) );
  ...
  UDB116SVT24_FDPQ_V2_3 \pkt_reg_inst/pkt_reg_reg[23]  ( .D(\pkt_reg_inst/n80 ), .CK(clk), .Q(\pkt_reg_inst/pkt_reg [23]) );
  UDB116SVT24_FDPQ_V2_3 \pkt_reg_inst/pkt_reg_reg[15]  ( .D(\pkt_reg_inst/n88 ), .CK(clk), .Q(\pkt_reg_inst/pkt_reg [15]) );
  UDB116SVT24_FDPQ_V2_3 \pkt_reg_inst/pkt_reg_reg[7]  ( .D(\pkt_reg_inst/n96 ), 
        .CK(clk), .Q(\pkt_reg_inst/pkt_reg [7]) );
  UDB116SVT24_FDPQB_1P5 \tx_buf_inst/dout_reg  ( .D(n848), .CK(clk), .QN(
        TX_OUT) );
  UDB116SVT24_FDPQ_V2_3 \tx_buf_inst/buffer_reg[7]  ( .D(\tx_buf_inst/n11 ), 
        .CK(clk), .Q(\tx_buf_inst/buffer [7]) );
  UDB116SVT24_FDPQ_V2_3 \tx_buf_inst/buffer_reg[6]  ( .D(\tx_buf_inst/n10 ), 
        .CK(clk), .Q(\tx_buf_inst/buffer [6]) );
  UDB116SVT24_FDPQ_V2_3 \tx_buf_inst/buffer_reg[5]  ( .D(\tx_buf_inst/n9 ), 
        .CK(clk), .Q(\tx_buf_inst/buffer [5]) );
  UDB116SVT24_FDPQ_V2_3 \tx_buf_inst/buffer_reg[4]  ( .D(\tx_buf_inst/n8 ), 
        .CK(clk), .Q(\tx_buf_inst/buffer [4]) );
  UDB116SVT24_FDPQ_V2_3 \tx_buf_inst/buffer_reg[3]  ( .D(\tx_buf_inst/n7 ), 
        .CK(clk), .Q(\tx_buf_inst/buffer [3]) );
  UDB116SVT24_FDPQ_V2_3 \tx_buf_inst/buffer_reg[2]  ( .D(\tx_buf_inst/n6 ), 
        .CK(clk), .Q(\tx_buf_inst/buffer [2]) );
  UDB116SVT24_FDPQ_V2_3 \tx_buf_inst/buffer_reg[1]  ( .D(\tx_buf_inst/n5 ), 
        .CK(clk), .Q(\tx_buf_inst/buffer [1]) );
  UDB116SVT24_FDPQ_V2_3 \tx_buf_inst/buffer_reg[0]  ( .D(\tx_buf_inst/n12 ), 
        .CK(clk), .Q(\tx_buf_inst/buffer [0]) );
  UDB116SVT24_FDPQ_V2_3 \counter3_reg[0]  ( .D(n833), .CK(clk), .Q(counter3[0]) );
  UDB116SVT24_FDPQ_V2_3 \counter3_reg[1]  ( .D(n832), .CK(clk), .Q(counter3[1]) );
  UDB116SVT24_FDPRBQ_V2_1 \tx_state_reg[1]  ( .D(n836), .CK(clk), .RD(n1956), 
        .Q(tx_state[1]) );
  UDB116SVT24_FDPRBQ_V2_1 \tx_state_reg[0]  ( .D(n837), .CK(clk), .RD(n1960), 
        .Q(tx_state[0]) );
  UDB116SVT24_FDPRBQ_V2_1 TX_SH_reg ( .D(n834), .CK(clk), .RD(n1959), .Q(TX_SH) );
  UDB116SVT24_FDPRBQ_V2_1 TX_LD_reg ( .D(n835), .CK(clk), .RD(n1959), .Q(TX_LD) );
  UDB116SVT24_FDPRBQ_V2_1 TX_EN_reg ( .D(n829), .CK(clk), .RD(n1959), .Q(TX_EN) );
  UDB116SVT24_FDPRBQ_V2_1 \counter_reg[0]  ( .D(n847), .CK(clk), .RD(n1958), 
        .Q(counter[0]) );
  UDB116SVT24_FDPRBQ_V2_1 \counter_reg[1]  ( .D(n839), .CK(clk), .RD(n1958), 
        .Q(counter[1]) );
  UDB116SVT24_FDPRBQ_V2_1 \counter_reg[2]  ( .D(n840), .CK(clk), .RD(n1958), 
        .Q(counter[2]) );
  UDB116SVT24_FDPRBQ_V2_1 \rx_state_reg[0]  ( .D(n843), .CK(clk), .RD(n1958), 
        .Q(rx_state[0]) );
  UDB116SVT24_FDPRBQ_V2_1 \rx_state_reg[1]  ( .D(n844), .CK(clk), .RD(n1957), 
        .Q(rx_state[1]) );
  UDB116SVT24_FDPRBQ_V2_1 \rx_state_reg[2]  ( .D(n845), .CK(clk), .RD(n1957), 
        .Q(rx_state[2]) );
  UDB116SVT24_FDPRBQ_V2_1 PKT_RST_reg ( .D(n838), .CK(clk), .RD(n1957), .Q(
        PKT_RST) );
  UDB116SVT24_FDPRBQ_V2_1 PKT_LD_reg ( .D(n842), .CK(clk), .RD(n1957), .Q(
        PKT_LD) );
  UDB116SVT24_FDPRBQ_V2_1 PKT_EN_reg ( .D(n841), .CK(clk), .RD(n1956), .Q(
        PKT_EN) );
  UDB116SVT24_FDPRBQ_V2_1 \counter_reg[3]  ( .D(n846), .CK(clk), .RD(n1956), 
        .Q(counter[3]) );
  UDB116SVT24_FDPRBQ_V2_1 SPI_LD_reg ( .D(n828), .CK(clk), .RD(n1956), .Q(
        SPI_LD) );
  UDB116SVT24_FDPRBQ_V2_1 pkt_rec_prev_reg ( .D(n827), .CK(clk), .RD(n1959), 
        .Q(pkt_rec_prev) );
  ...
  UDB116SVT24_FDPQB_1P5 \sh_sync_inst/interval_sum_reg[29]  ( .D(
        \sh_sync_inst/n274 ), .CK(clk), .QN(\sh_sync_inst/n148 ) );
  UDB116SVT24_FDPQB_1P5 \sh_sync_inst/counter_reg[5]  ( .D(\sh_sync_inst/n266 ), .CK(clk), .QN(\sh_sync_inst/intadd_0/B[3] ) );
  UDB116SVT24_FDPQ_1 \counter3_reg[2]  ( .D(n831), .CK(clk), .Q(counter3[2])
         );
  UDB116SVT24_FDPQB_1P5 \sh_sync_inst/counter_reg[14]  ( .D(
        \sh_sync_inst/n257 ), .CK(clk), .QN(\sh_sync_inst/intadd_0/B[12] ) );
  UDB116SVT24_FDPQB_1P5 \sh_sync_inst/counter_reg[2]  ( .D(\sh_sync_inst/n269 ), .CK(clk), .QN(\sh_sync_inst/intadd_0/B[0] ) );
  ...
  UDB116SVT24_FDPQB_1P5 \sh_sync_inst/interval_sum_reg[25]  ( .D(
        \sh_sync_inst/n278 ), .CK(clk), .QN(\sh_sync_inst/n152 ) );
  UDB116SVT24_FDPQB_1P5 \sh_sync_inst/counter_reg[7]  ( .D(\sh_sync_inst/n264 ), .CK(clk), .QN(\sh_sync_inst/intadd_0/B[5] ) );
  UDB116SVT24_FDPQ_1 \fsm_sync_inst/state_pos_reg  ( .D(\fsm_sync_inst/N11 ), 
>>>>>>> 8334d12b4657a094ccdd22848e8853946d20d6e8
...
=======
  ...
  UDB116SVT24_FDPQB_1P5 \sh_sync_inst/pulse_pack_count_reg[1]  ( .D(
        \sh_sync_inst/n331 ), .CK(clk), .QN(\sh_sync_inst/n245 ) );
  UDB116SVT24_FDPQ_1 \shift_buf_inst/pkt_rec_reg  ( .D(\shift_buf_inst/N88 ), 
        .CK(clk), .Q(pkt_rec) );
  UDB116SVT24_FDPQ_1 \shift_buf_inst/shift_reg_reg[55]  ( .D(
        \shift_buf_inst/n79 ), .CK(clk), .Q(SHIFT_OUT[55]) );
  UDB116SVT24_FDPQ_1 \shift_buf_inst/shift_reg_reg[39]  ( .D(
        \shift_buf_inst/n95 ), .CK(clk), .Q(SHIFT_OUT[39]) );
  UDB116SVT24_FDPQ_1 \shift_buf_inst/shift_reg_reg[22]  ( .D(
        \shift_buf_inst/n112 ), .CK(clk), .Q(SHIFT_OUT[22]) );
  UDB116SVT24_FDPQ_1 \shift_buf_inst/shift_reg_reg[6]  ( .D(
        \shift_buf_inst/n128 ), .CK(clk), .Q(SHIFT_OUT[6]) );
  UDB116SVT24_FDPQ_1 \pkt_reg_inst/dout_reg[2]  ( .D(\pkt_reg_inst/n34 ), .CK(
        clk), .Q(SPI_IN[2]) );
  UDB116SVT24_FDPQ_1 \pkt_reg_inst/pkt_reg_reg[33]  ( .D(\pkt_reg_inst/n70 ), 
        .CK(clk), .Q(\pkt_reg_inst/pkt_reg [33]) );
  UDB116SVT24_FDPQ_1 \pkt_reg_inst/pkt_reg_reg[35]  ( .D(\pkt_reg_inst/n68 ), 
        .CK(clk), .Q(\pkt_reg_inst/pkt_reg [35]) );
  UDB116SVT24_FDPQ_1 \pkt_reg_inst/pkt_reg_reg[29]  ( .D(\pkt_reg_inst/n74 ), 
        .CK(clk), .Q(\pkt_reg_inst/pkt_reg [29]) );
  UDB116SVT24_FDPQ_1 \pkt_reg_inst/pkt_reg_reg[31]  ( .D(\pkt_reg_inst/n72 ), 
        .CK(clk), .Q(\pkt_reg_inst/pkt_reg [31]) );
  UDB116SVT24_FDPQ_1 \counter3_reg[3]  ( .D(n830), .CK(clk), .Q(counter3[3])
         );
  UDB116SVT24_OA2BB2_0P75 U1117 ( .A1(n1019), .A2(n1313), .B1(n1313), .B2(
        n1019), .X(n1312) );
  UDB116SVT24_OA2BB2_0P75 U1118 ( .A1(n958), .A2(n1309), .B1(n1309), .B2(n957), 
        .X(n1308) );
  UDB116SVT24_OA2BB2_0P75 U1119 ( .A1(n934), .A2(n1305), .B1(n1305), .B2(n935), 
        .X(n1304) );
  UDB116SVT24_OA2BB2_0P75 U1120 ( .A1(n1013), .A2(n1301), .B1(n1301), .B2(
        n1013), .X(n1292) );
  UDB116SVT24_OR2_0P75 U1121 ( .A1(n1724), .A2(n880), .X(n1720) );
  UDB116SVT24_BUF_1 U1122 ( .A(n1571), .X(n1724) );
  UDB116SVT24_OA2BB2_0P75 U1123 ( .A1(n1006), .A2(n1289), .B1(n1289), .B2(
        n1007), .X(n1264) );
  UDB116SVT24_OR2_0P75 U1124 ( .A1(n1325), .A2(n1028), .X(n1610) );
  UDB116SVT24_OA2BB2_0P75 U1125 ( .A1(n1016), .A2(n1609), .B1(n1609), .B2(
        n1015), .X(n1613) );
  UDB116SVT24_OR2_0P75 U1126 ( .A1(n1029), .A2(n1178), .X(n1746) );
  UDB116SVT24_BUF_1 U1127 ( .A(n1027), .X(n1615) );
  UDB116SVT24_BUF_1 U1128 ( .A(n1722), .X(n1711) );
  UDB116SVT24_OR2_0P75 U1129 ( .A1(n985), .A2(n1565), .X(n1212) );
  UDB116SVT24_OR4_1 U1130 ( .A1(n986), .A2(\sh_sync_inst/n244 ), .A3(n917), 
        .A4(n1083), .X(n1726) );
  UDB116SVT24_BUF_1 U1131 ( .A(\sh_sync_inst/intadd_0/B[9] ), .X(n1588) );
  UDB116SVT24_OR2_0P75 U1132 ( .A1(rst), .A2(n1036), .X(n1932) );
  UDB116SVT24_OAI21B_1 U1133 ( .A1(PKT_EN), .A2(n853), .B(n984), .X(n1931) );
  UDB116SVT24_OR3_1 U1134 ( .A1(n986), .A2(TX_EN), .A3(TX_LD), .X(n1933) );
  UDB116SVT24_INV_0P75 U1135 ( .A(\sh_sync_inst/n194 ), .X(n1160) );
  UDB116SVT24_BUF_1 U1136 ( .A(\sh_sync_inst/intadd_0/B[13] ), .X(n1683) );
  UDB116SVT24_BUF_1 U1137 ( .A(\sh_sync_inst/intadd_0/B[7] ), .X(n1302) );
  UDB116SVT24_BUF_1 U1138 ( .A(rx_state[0]), .X(n1176) );
  UDB116SVT24_BUF_1 U1139 ( .A(\sh_sync_inst/n228 ), .X(n1133) );
  UDB116SVT24_BUF_1 U1140 ( .A(n1293), .X(n849) );
  UDB116SVT24_BUF_1 U1141 ( .A(n1169), .X(n850) );
  UDB116SVT24_BUF_1 U1142 ( .A(n1446), .X(n851) );
  UDB116SVT24_BUF_1 U1143 ( .A(n1552), .X(n852) );
  UDB116SVT24_BUF_1 U1144 ( .A(PKT_LD), .X(n853) );
  UDB116SVT24_BUF_1 U1145 ( .A(\sh_sync_inst/n249 ), .X(n854) );
  UDB116SVT24_INV_0P75 U1146 ( .A(n1179), .X(n855) );
  UDB116SVT24_BUF_1 U1147 ( .A(\sh_sync_inst/n215 ), .X(n856) );
  UDB116SVT24_INV_0P75 U1148 ( .A(n1104), .X(n857) );
  UDB116SVT24_BUF_1 U1149 ( .A(\sh_sync_inst/n176 ), .X(n858) );
  UDB116SVT24_INV_0P75 U1150 ( .A(n1381), .X(n859) );
  UDB116SVT24_INV_0P75 U1151 ( .A(n1504), .X(n860) );
  UDB116SVT24_INV_0P75 U1152 ( .A(n979), .X(n861) );
  UDB116SVT24_BUF_1 U1153 ( .A(n1023), .X(n862) );
  UDB116SVT24_INV_0P75 U1154 ( .A(n920), .X(n863) );
  UDB116SVT24_INV_0P75 U1155 ( .A(tx_state[1]), .X(n864) );
  UDB116SVT24_INV_0P75 U1156 ( .A(tx_state[1]), .X(n865) );
  UDB116SVT24_INV_0P75 U1157 ( .A(rx_state[1]), .X(n866) );
  UDB116SVT24_INV_0P75 U1158 ( .A(n1000), .X(n867) );
  UDB116SVT24_INV_0P75 U1159 ( .A(n1176), .X(n868) );
  UDB116SVT24_INV_0P75 U1160 ( .A(n1176), .X(n869) );
  UDB116SVT24_INV_0P75 U1161 ( .A(counter3[2]), .X(n870) );
  UDB116SVT24_INV_0P75 U1162 ( .A(counter3[2]), .X(n871) );
  UDB116SVT24_INV_0P75 U1163 ( .A(\sh_sync_inst/n208 ), .X(n872) );
  UDB116SVT24_INV_0P75 U1164 ( .A(\sh_sync_inst/n208 ), .X(n873) );
  UDB116SVT24_INV_0P75 U1165 ( .A(n1683), .X(n874) );
  UDB116SVT24_INV_0P75 U1166 ( .A(n1683), .X(n875) );
  UDB116SVT24_INV_0P75 U1167 ( .A(n935), .X(n876) );
  UDB116SVT24_INV_0P75 U1168 ( .A(n906), .X(n877) );
  UDB116SVT24_INV_0P75 U1169 ( .A(\sh_sync_inst/intadd_0/A[2] ), .X(n878) );
  UDB116SVT24_INV_0P75 U1170 ( .A(\sh_sync_inst/intadd_0/A[2] ), .X(n879) );
  UDB116SVT24_INV_0P75 U1171 ( .A(n1711), .X(n880) );
  UDB116SVT24_INV_0P75 U1172 ( .A(n1711), .X(n881) );
  UDB116SVT24_INV_0P75 U1173 ( .A(n1724), .X(n882) );
  UDB116SVT24_INV_0P75 U1174 ( .A(n1724), .X(n883) );
  UDB116SVT24_INV_0P75 U1175 ( .A(\sh_sync_inst/intadd_0/A[8] ), .X(n884) );
  UDB116SVT24_INV_0P75 U1176 ( .A(\sh_sync_inst/intadd_0/A[8] ), .X(n885) );
  UDB116SVT24_INV_0P75 U1177 ( .A(\sh_sync_inst/n160 ), .X(n886) );
  UDB116SVT24_INV_0P75 U1178 ( .A(\sh_sync_inst/n160 ), .X(n887) );
  UDB116SVT24_INV_0P75 U1179 ( .A(\sh_sync_inst/n161 ), .X(n888) );
  UDB116SVT24_INV_0P75 U1180 ( .A(\sh_sync_inst/n161 ), .X(n889) );
  UDB116SVT24_INV_0P75 U1181 ( .A(\sh_sync_inst/n159 ), .X(n890) );
  UDB116SVT24_INV_0P75 U1182 ( .A(\sh_sync_inst/n159 ), .X(n891) );
  UDB116SVT24_INV_0P75 U1183 ( .A(\sh_sync_inst/n153 ), .X(n892) );
  UDB116SVT24_INV_0P75 U1184 ( .A(\sh_sync_inst/n153 ), .X(n893) );
  UDB116SVT24_INV_0P75 U1185 ( .A(\sh_sync_inst/n148 ), .X(n894) );
  UDB116SVT24_INV_0P75 U1186 ( .A(\sh_sync_inst/n148 ), .X(n895) );
  UDB116SVT24_INV_0P75 U1187 ( .A(rx_state[2]), .X(n896) );
  UDB116SVT24_INV_0P75 U1188 ( .A(n896), .X(n897) );
  UDB116SVT24_INV_0P75 U1189 ( .A(n1212), .X(n898) );
  UDB116SVT24_INV_0P75 U1190 ( .A(n1212), .X(n899) );
  UDB116SVT24_INV_0P75 U1191 ( .A(n1535), .X(n900) );
  UDB116SVT24_INV_0P75 U1192 ( .A(n900), .X(n901) );
  UDB116SVT24_INV_0P75 U1193 ( .A(n900), .X(n902) );
  UDB116SVT24_INV_0P75 U1194 ( .A(\sh_sync_inst/n244 ), .X(n903) );
  UDB116SVT24_INV_0P75 U1195 ( .A(n903), .X(n904) );
  UDB116SVT24_INV_0P75 U1196 ( .A(\sh_sync_inst/intadd_0/B[1] ), .X(n905) );
  UDB116SVT24_INV_0P75 U1197 ( .A(n905), .X(n906) );
  UDB116SVT24_INV_0P75 U1198 ( .A(\sh_sync_inst/n152 ), .X(n907) );
  UDB116SVT24_INV_0P75 U1199 ( .A(n907), .X(n908) );
  UDB116SVT24_INV_0P75 U1200 ( .A(\sh_sync_inst/n235 ), .X(n909) );
  UDB116SVT24_INV_0P75 U1201 ( .A(n909), .X(n910) );
  UDB116SVT24_INV_0P75 U1202 ( .A(\sh_sync_inst/intadd_0/B[11] ), .X(n911) );
  UDB116SVT24_INV_0P75 U1203 ( .A(n911), .X(n912) );
  UDB116SVT24_INV_0P75 U1204 ( .A(\sh_sync_inst/n251 ), .X(n913) );
  UDB116SVT24_INV_0P75 U1205 ( .A(n913), .X(n914) );
  UDB116SVT24_INV_0P75 U1206 ( .A(\sh_sync_inst/n146 ), .X(n915) );
  UDB116SVT24_INV_0P75 U1207 ( .A(n915), .X(n916) );
  UDB116SVT24_INV_0P75 U1208 ( .A(n1133), .X(n917) );
  UDB116SVT24_INV_0P75 U1209 ( .A(n1133), .X(n918) );
  UDB116SVT24_INV_0P75 U1210 ( .A(n1615), .X(n919) );
  UDB116SVT24_INV_0P75 U1211 ( .A(n1615), .X(n920) );
  UDB116SVT24_INV_0P75 U1212 ( .A(n1588), .X(n921) );
  UDB116SVT24_INV_0P75 U1213 ( .A(n1588), .X(n922) );
  UDB116SVT24_INV_0P75 U1214 ( .A(\sh_sync_inst/intadd_0/B[11] ), .X(n923) );
  UDB116SVT24_INV_0P75 U1215 ( .A(\sh_sync_inst/n202 ), .X(n924) );
  UDB116SVT24_INV_0P75 U1216 ( .A(\sh_sync_inst/intadd_0/B[5] ), .X(n925) );
  UDB116SVT24_INV_0P75 U1217 ( .A(\sh_sync_inst/n157 ), .X(n926) );
  UDB116SVT24_INV_0P75 U1218 ( .A(\sh_sync_inst/n157 ), .X(n927) );
  UDB116SVT24_INV_0P75 U1219 ( .A(RX), .X(n928) );
  UDB116SVT24_INV_0P75 U1220 ( .A(n928), .X(n929) );
  UDB116SVT24_INV_0P75 U1221 ( .A(n928), .X(n930) );
  UDB116SVT24_INV_0P75 U1222 ( .A(n1726), .X(n931) );
  UDB116SVT24_INV_0P75 U1223 ( .A(n1726), .X(n932) );
  UDB116SVT24_INV_0P75 U1224 ( .A(\sh_sync_inst/intadd_0/B[8] ), .X(n933) );
  UDB116SVT24_INV_0P75 U1225 ( .A(n933), .X(n934) );
  UDB116SVT24_INV_0P75 U1226 ( .A(n933), .X(n935) );
  UDB116SVT24_INV_0P75 U1227 ( .A(\sh_sync_inst/n202 ), .X(n936) );
  UDB116SVT24_INV_0P75 U1228 ( .A(n936), .X(n937) );
  UDB116SVT24_INV_0P75 U1229 ( .A(n1077), .X(n938) );
  UDB116SVT24_INV_0P75 U1230 ( .A(n1077), .X(n939) );
  UDB116SVT24_INV_0P75 U1231 ( .A(n1302), .X(n940) );
  UDB116SVT24_INV_0P75 U1232 ( .A(n1302), .X(n941) );
  UDB116SVT24_INV_0P75 U1233 ( .A(n1933), .X(n942) );
  UDB116SVT24_INV_0P75 U1234 ( .A(n1933), .X(n943) );
  UDB116SVT24_INV_0P75 U1235 ( .A(n1931), .X(n944) );
  UDB116SVT24_INV_0P75 U1236 ( .A(n1931), .X(n945) );
  UDB116SVT24_INV_0P75 U1237 ( .A(n1932), .X(n946) );
  UDB116SVT24_INV_0P75 U1238 ( .A(n1932), .X(n947) );
  UDB116SVT24_INV_0P75 U1239 ( .A(n1610), .X(n948) );
  UDB116SVT24_INV_0P75 U1240 ( .A(n1610), .X(n949) );
  UDB116SVT24_INV_0P75 U1241 ( .A(\sh_sync_inst/intadd_0/B[2] ), .X(n950) );
  UDB116SVT24_INV_0P75 U1242 ( .A(n950), .X(n951) );
  UDB116SVT24_INV_0P75 U1243 ( .A(n950), .X(n952) );
  UDB116SVT24_INV_0P75 U1244 ( .A(\sh_sync_inst/intadd_0/B[5] ), .X(n953) );
  UDB116SVT24_INV_0P75 U1245 ( .A(n953), .X(n954) );
  UDB116SVT24_INV_0P75 U1246 ( .A(n953), .X(n955) );
  UDB116SVT24_INV_0P75 U1247 ( .A(\sh_sync_inst/intadd_0/B[10] ), .X(n956) );
  UDB116SVT24_INV_0P75 U1248 ( .A(n956), .X(n957) );
  UDB116SVT24_INV_0P75 U1249 ( .A(n956), .X(n958) );
  UDB116SVT24_INV_0P75 U1250 ( .A(n961), .X(n959) );
  UDB116SVT24_INV_0P75 U1251 ( .A(n963), .X(n960) );
  UDB116SVT24_INV_0P75 U1252 ( .A(n1720), .X(n961) );
  UDB116SVT24_INV_0P75 U1253 ( .A(n1720), .X(n962) );
  UDB116SVT24_INV_0P75 U1254 ( .A(n1720), .X(n963) );
  UDB116SVT24_INV_0P75 U1255 ( .A(\sh_sync_inst/intadd_0/B[3] ), .X(n964) );
  UDB116SVT24_INV_0P75 U1256 ( .A(n964), .X(n965) );
  UDB116SVT24_INV_0P75 U1257 ( .A(n964), .X(n966) );
  UDB116SVT24_INV_0P75 U1258 ( .A(\sh_sync_inst/intadd_0/B[0] ), .X(n967) );
  UDB116SVT24_INV_0P75 U1259 ( .A(n967), .X(n968) );
  UDB116SVT24_INV_0P75 U1260 ( .A(n967), .X(n969) );
  UDB116SVT24_INV_0P75 U1261 ( .A(rx_state[2]), .X(n970) );
  UDB116SVT24_INV_0P75 U1262 ( .A(n897), .X(n971) );
  UDB116SVT24_INV_0P75 U1263 ( .A(n901), .X(n972) );
  UDB116SVT24_INV_0P75 U1264 ( .A(n902), .X(n973) );
  UDB116SVT24_INV_0P75 U1265 ( .A(n901), .X(n974) );
  UDB116SVT24_INV_0P75 U1266 ( .A(n1746), .X(n975) );
  UDB116SVT24_INV_0P75 U1267 ( .A(n1746), .X(n976) );
  UDB116SVT24_INV_0P75 U1268 ( .A(n1746), .X(n977) );
  UDB116SVT24_INV_0P75 U1269 ( .A(n1746), .X(n978) );
  UDB116SVT24_INV_0P75 U1270 ( .A(n1736), .X(n979) );
  UDB116SVT24_INV_0P75 U1271 ( .A(n979), .X(n980) );
  UDB116SVT24_INV_0P75 U1272 ( .A(n979), .X(n981) );
  UDB116SVT24_INV_0P75 U1273 ( .A(n979), .X(n982) );
  UDB116SVT24_INV_0P75 U1274 ( .A(rst), .X(n983) );
  UDB116SVT24_INV_0P75 U1275 ( .A(n983), .X(n984) );
  UDB116SVT24_INV_0P75 U1276 ( .A(n983), .X(n985) );
  UDB116SVT24_INV_0P75 U1277 ( .A(n983), .X(n986) );
  UDB116SVT24_INV_0P75 U1278 ( .A(CS), .X(n987) );
  UDB116SVT24_INV_0P75 U1279 ( .A(n987), .X(n988) );
  UDB116SVT24_BUF_1 U1280 ( .A(n1531), .X(n989) );
  UDB116SVT24_BUF_1 U1281 ( .A(n1482), .X(n990) );
  UDB116SVT24_INV_0P75 U1282 ( .A(n1417), .X(n991) );
  UDB116SVT24_INV_0P75 U1283 ( .A(n1388), .X(n992) );
  UDB116SVT24_BUF_1 U1284 ( .A(\sh_sync_inst/n207 ), .X(n993) );
  UDB116SVT24_BUF_1 U1285 ( .A(counter3[1]), .X(n994) );
  UDB116SVT24_INV_0P75 U1286 ( .A(n1346), .X(n995) );
  UDB116SVT24_INV_0P75 U1287 ( .A(n1486), .X(n996) );
  UDB116SVT24_INV_0P75 U1288 ( .A(n1682), .X(n997) );
  UDB116SVT24_INV_0P75 U1289 ( .A(n1735), .X(n998) );
  UDB116SVT24_INV_0P75 U1290 ( .A(n1457), .X(n999) );
  UDB116SVT24_BUF_1 U1291 ( .A(rx_state[1]), .X(n1000) );
  UDB116SVT24_BUF_1 U1292 ( .A(n1051), .X(n1001) );
  UDB116SVT24_INV_0P75 U1293 ( .A(n1296), .X(n1002) );
  UDB116SVT24_ND2_MM_0P75 U1294 ( .A1(n1925), .A2(SPI_LD), .X(n1930) );
  UDB116SVT24_INV_0P75 U1295 ( .A(n1930), .X(n1003) );
  UDB116SVT24_INV_0P75 U1296 ( .A(n1930), .X(n1004) );
  UDB116SVT24_INV_0P75 U1297 ( .A(n1627), .X(n1005) );
  UDB116SVT24_BUF_1 U1298 ( .A(\sh_sync_inst/intadd_0/B[4] ), .X(n1006) );
  UDB116SVT24_BUF_1 U1299 ( .A(\sh_sync_inst/intadd_0/B[4] ), .X(n1007) );
  UDB116SVT24_INV_0P75 U1300 ( .A(\sh_sync_inst/n147 ), .X(n1008) );
  UDB116SVT24_INV_0P75 U1301 ( .A(n1008), .X(n1009) );
  UDB116SVT24_INV_0P75 U1302 ( .A(n1008), .X(n1010) );
  UDB116SVT24_INV_0P75 U1303 ( .A(\sh_sync_inst/intadd_0/B[6] ), .X(n1011) );
  UDB116SVT24_INV_0P75 U1304 ( .A(n1011), .X(n1012) );
  UDB116SVT24_INV_0P75 U1305 ( .A(n1011), .X(n1013) );
  UDB116SVT24_INV_0P75 U1306 ( .A(\sh_sync_inst/n201 ), .X(n1014) );
  UDB116SVT24_INV_0P75 U1307 ( .A(n1014), .X(n1015) );
  UDB116SVT24_INV_0P75 U1308 ( .A(n1014), .X(n1016) );
  UDB116SVT24_INV_0P75 U1309 ( .A(\sh_sync_inst/intadd_0/B[12] ), .X(n1017) );
  UDB116SVT24_INV_0P75 U1310 ( .A(n1017), .X(n1018) );
  UDB116SVT24_INV_0P75 U1311 ( .A(n1017), .X(n1019) );
  UDB116SVT24_INV_0P75 U1312 ( .A(n929), .X(n1020) );
  UDB116SVT24_INV_0P75 U1313 ( .A(n929), .X(n1021) );
  UDB116SVT24_INV_0P75 U1314 ( .A(n930), .X(n1022) );
  UDB116SVT24_OA21_V2_1 U1315 ( .A1(n1752), .A2(n1331), .B(n1960), .X(n1667)
         );
  UDB116SVT24_INV_0P75 U1316 ( .A(n1667), .X(n1023) );
  UDB116SVT24_INV_0P75 U1317 ( .A(n1667), .X(n1024) );
  UDB116SVT24_INV_0P75 U1318 ( .A(n1667), .X(n1025) );
  UDB116SVT24_INV_0P75 U1319 ( .A(n1667), .X(n1026) );
  UDB116SVT24_AN2_1 U1320 ( .A1(n1565), .A2(n1757), .X(n1753) );
  UDB116SVT24_INV_0P75 U1321 ( .A(n1753), .X(n1027) );
  UDB116SVT24_INV_0P75 U1322 ( .A(n1753), .X(n1028) );
  UDB116SVT24_INV_0P75 U1323 ( .A(n1753), .X(n1029) );
  UDB116SVT24_INV_0P75 U1324 ( .A(n1753), .X(n1030) );
  UDB116SVT24_BUF_1 U1325 ( .A(n1562), .X(n1210) );
  UDB116SVT24_BUF_1 U1326 ( .A(n1160), .X(n1190) );
  UDB116SVT24_INV_0P75 U1328 ( .A(rst), .X(n1033) );
  UDB116SVT24_BUF_1 U1329 ( .A(n1033), .X(n1055) );
  UDB116SVT24_BUF_1 U1330 ( .A(n1055), .X(n1956) );
  UDB116SVT24_BUF_1 U1331 ( .A(n1033), .X(n1583) );
  UDB116SVT24_BUF_1 U1332 ( .A(n1583), .X(n1959) );
  UDB116SVT24_BUF_1 U1333 ( .A(n1055), .X(n1957) );
  UDB116SVT24_BUF_1 U1334 ( .A(n1055), .X(n1958) );
  UDB116SVT24_NR2_0P75 U1335 ( .A1(n984), .A2(\sh_sync_inst/n227 ), .X(
        \sh_sync_inst/N529 ) );
  UDB116SVT24_NR2_0P75 U1336 ( .A1(n985), .A2(\sh_sync_inst/n226 ), .X(
        \sh_sync_inst/N530 ) );
  UDB116SVT24_BUF_1 U1337 ( .A(n1033), .X(n1580) );
  UDB116SVT24_ND3_0P75 U1338 ( .A1(TX_EN), .A2(\tx_buf_inst/buffer [7]), .A3(
        n1580), .X(n848) );
  UDB116SVT24_NR2_0P75 U1339 ( .A1(n986), .A2(PKT_RST), .X(n1077) );
  UDB116SVT24_ND2_MM_0P75 U1340 ( .A1(n1077), .A2(SHIFT_OUT[45]), .X(
        \shift_buf_inst/n138 ) );
  UDB116SVT24_ND4_0P75 U1341 ( .A1(\shift_buf_inst/sync [0]), .A2(
        \shift_buf_inst/sync [1]), .A3(\shift_buf_inst/sync [2]), .A4(
        \shift_buf_inst/sync [3]), .X(n1032) );
  UDB116SVT24_ND4_0P75 U1342 ( .A1(\shift_buf_inst/sync [4]), .A2(
        \shift_buf_inst/sync [5]), .A3(\shift_buf_inst/sync [6]), .A4(
        \shift_buf_inst/sync [7]), .X(n1031) );
  UDB116SVT24_NR2_0P75 U1343 ( .A1(n1032), .A2(n1031), .X(\shift_buf_inst/N88 ) );
  UDB116SVT24_BUF_1 U1344 ( .A(n1033), .X(n1436) );
  UDB116SVT24_ND2_MM_0P75 U1345 ( .A1(n1436), .A2(n1160), .X(
        \fsm_sync_inst/n7 ) );
  UDB116SVT24_INV_0P75 U1346 ( .A(pkt_rec), .X(n1052) );
  UDB116SVT24_INV_0P75 U1347 ( .A(pkt_rec_prev), .X(n1143) );
  UDB116SVT24_AOI22_1 U1348 ( .A1(n929), .A2(n1052), .B1(n1143), .B2(n1022), 
        .X(n827) );
  UDB116SVT24_INV_0P75 U1349 ( .A(TX_SH), .X(n1034) );
  UDB116SVT24_NR2_0P75 U1350 ( .A1(n986), .A2(n1034), .X(\sh_sync_inst/N535 )
         );
  UDB116SVT24_INV_0P75 U1351 ( .A(SHIFT_OUT[43]), .X(n1819) );
  UDB116SVT24_NR2_0P75 U1352 ( .A1(n938), .A2(n1819), .X(\shift_buf_inst/N8 )
         );
  UDB116SVT24_INV_0P75 U1353 ( .A(SHIFT_OUT[41]), .X(n1825) );
  UDB116SVT24_NR2_0P75 U1354 ( .A1(n939), .A2(n1825), .X(\shift_buf_inst/N10 )
         );
  UDB116SVT24_INV_0P75 U1355 ( .A(SHIFT_OUT[40]), .X(n1829) );
  UDB116SVT24_NR2_0P75 U1356 ( .A1(n938), .A2(n1829), .X(\shift_buf_inst/N11 )
         );
  UDB116SVT24_INV_0P75 U1357 ( .A(SHIFT_OUT[44]), .X(n1816) );
  UDB116SVT24_NR2_0P75 U1358 ( .A1(n939), .A2(n1816), .X(\shift_buf_inst/N7 )
         );
  UDB116SVT24_INV_0P75 U1359 ( .A(SHIFT_OUT[38]), .X(n1835) );
  UDB116SVT24_NR2_0P75 U1360 ( .A1(n938), .A2(n1835), .X(\shift_buf_inst/N13 )
         );
  UDB116SVT24_INV_0P75 U1361 ( .A(SHIFT_OUT[42]), .X(n1822) );
  UDB116SVT24_NR2_0P75 U1362 ( .A1(n939), .A2(n1822), .X(\shift_buf_inst/N9 )
         );
  UDB116SVT24_INV_0P75 U1363 ( .A(SHIFT_OUT[39]), .X(n1831) );
  UDB116SVT24_NR2_0P75 U1364 ( .A1(n938), .A2(n1831), .X(\shift_buf_inst/N12 )
         );
  UDB116SVT24_INV_0P75 U1365 ( .A(tx_state[0]), .X(n1066) );
  UDB116SVT24_ND2_MM_0P75 U1366 ( .A1(n1020), .A2(n1066), .X(n1148) );
  UDB116SVT24_AOI22_1 U1367 ( .A1(n1021), .A2(n864), .B1(n1148), .B2(n1034), 
        .X(n834) );
  UDB116SVT24_NR2_0P75 U1368 ( .A1(rx_state[2]), .A2(n1020), .X(n1953) );
  UDB116SVT24_AOI21_0P75 U1369 ( .A1(n1000), .A2(n1953), .B(PKT_RST), .X(n1035) );
  UDB116SVT24_AOI21_0P75 U1370 ( .A1(n1953), .A2(rx_state[0]), .B(n1035), .X(
        n838) );
  UDB116SVT24_ND3_0P75 U1371 ( .A1(n988), .A2(tx_state[0]), .A3(n865), .X(
        n1062) );
  UDB116SVT24_OAI21_0P75 U1372 ( .A1(n864), .A2(n1066), .B(n1022), .X(n1952)
         );
  UDB116SVT24_AO2BB2_0P75 U1373 ( .A1(n930), .A2(n1062), .B1(TX_LD), .B2(n1952), .X(n835) );
  UDB116SVT24_INV_0P75 U1374 ( .A(TX_LD), .X(n1036) );
  UDB116SVT24_ND3_0P75 U1375 ( .A1(TX_EN), .A2(n1580), .A3(n1036), .X(n1051)
         );
  UDB116SVT24_INV_0P75 U1376 ( .A(\tx_buf_inst/buffer [0]), .X(n1038) );
  UDB116SVT24_AOI22_1 U1377 ( .A1(n942), .A2(\tx_buf_inst/buffer [1]), .B1(
        n946), .B2(SPI_OUT[1]), .X(n1037) );
  UDB116SVT24_OAI21_0P75 U1378 ( .A1(n1051), .A2(n1038), .B(n1037), .X(
        \tx_buf_inst/n5 ) );
  UDB116SVT24_INV_0P75 U1379 ( .A(\tx_buf_inst/buffer [6]), .X(n1040) );
  UDB116SVT24_AOI22_1 U1380 ( .A1(n943), .A2(\tx_buf_inst/buffer [7]), .B1(
        n947), .B2(SPI_OUT[7]), .X(n1039) );
  UDB116SVT24_OAI21_0P75 U1381 ( .A1(n1051), .A2(n1040), .B(n1039), .X(
        \tx_buf_inst/n11 ) );
  UDB116SVT24_INV_0P75 U1382 ( .A(\tx_buf_inst/buffer [1]), .X(n1042) );
  UDB116SVT24_AOI22_1 U1383 ( .A1(n942), .A2(\tx_buf_inst/buffer [2]), .B1(
        n946), .B2(SPI_OUT[2]), .X(n1041) );
  UDB116SVT24_OAI21_0P75 U1384 ( .A1(n1051), .A2(n1042), .B(n1041), .X(
        \tx_buf_inst/n6 ) );
  UDB116SVT24_INV_0P75 U1385 ( .A(\tx_buf_inst/buffer [4]), .X(n1044) );
  UDB116SVT24_AOI22_1 U1386 ( .A1(n943), .A2(\tx_buf_inst/buffer [5]), .B1(
        n947), .B2(SPI_OUT[5]), .X(n1043) );
  UDB116SVT24_OAI21_0P75 U1387 ( .A1(n1001), .A2(n1044), .B(n1043), .X(
        \tx_buf_inst/n9 ) );
  UDB116SVT24_INV_0P75 U1388 ( .A(\tx_buf_inst/buffer [5]), .X(n1046) );
  UDB116SVT24_AOI22_1 U1389 ( .A1(n942), .A2(\tx_buf_inst/buffer [6]), .B1(
        n946), .B2(SPI_OUT[6]), .X(n1045) );
  UDB116SVT24_OAI21_0P75 U1390 ( .A1(n1001), .A2(n1046), .B(n1045), .X(
        \tx_buf_inst/n10 ) );
  UDB116SVT24_INV_0P75 U1391 ( .A(\tx_buf_inst/buffer [2]), .X(n1048) );
  UDB116SVT24_AOI22_1 U1392 ( .A1(n943), .A2(\tx_buf_inst/buffer [3]), .B1(
        n947), .B2(SPI_OUT[3]), .X(n1047) );
  UDB116SVT24_OAI21_0P75 U1393 ( .A1(n1001), .A2(n1048), .B(n1047), .X(
        \tx_buf_inst/n7 ) );
  UDB116SVT24_INV_0P75 U1394 ( .A(\tx_buf_inst/buffer [3]), .X(n1050) );
  UDB116SVT24_AOI22_1 U1395 ( .A1(n942), .A2(\tx_buf_inst/buffer [4]), .B1(
        n946), .B2(SPI_OUT[4]), .X(n1049) );
  UDB116SVT24_OAI21_0P75 U1396 ( .A1(n1001), .A2(n1050), .B(n1049), .X(
        \tx_buf_inst/n8 ) );
  UDB116SVT24_NR2_0P75 U1397 ( .A1(pkt_rec_prev), .A2(n1052), .X(n1053) );
  UDB116SVT24_AOAI211_0P75 U1398 ( .A1(n1053), .A2(n867), .B(n868), .C(n1953), 
        .X(n1054) );
  UDB116SVT24_ND3_0P75 U1399 ( .A1(rx_state[0]), .A2(n970), .A3(n866), .X(
        n1142) );
  UDB116SVT24_AO2BB2_0P75 U1400 ( .A1(n1054), .A2(n1142), .B1(n1054), .B2(n853), .X(n842) );
  UDB116SVT24_BUF_1 U1401 ( .A(n1055), .X(n1757) );
  UDB116SVT24_ND2_MM_0P75 U1402 ( .A1(PKT_LD), .A2(n1757), .X(n1756) );
  UDB116SVT24_INV_0P75 U1403 ( .A(n1756), .X(n1784) );
  UDB116SVT24_BUF_1 U1404 ( .A(n1784), .X(n1771) );
  UDB116SVT24_INV_0P75 U1405 ( .A(n1771), .X(n1060) );
  UDB116SVT24_INV_0P75 U1406 ( .A(SHIFT_OUT[7]), .X(n1206) );
  UDB116SVT24_NR3_0P75 U1407 ( .A1(n985), .A2(PKT_EN), .A3(PKT_LD), .X(n1826)
         );
  UDB116SVT24_BUF_1 U1408 ( .A(n1826), .X(n1813) );
  UDB116SVT24_BUF_1 U1409 ( .A(n1813), .X(n1780) );
  UDB116SVT24_AO2BB2_0P75 U1410 ( .A1(n1060), .A2(n1206), .B1(n1780), .B2(
        \pkt_reg_inst/pkt_reg [7]), .X(\pkt_reg_inst/n96 ) );
  UDB116SVT24_OAI21_0P75 U1411 ( .A1(rx_state[0]), .A2(n987), .B(n897), .X(
        n1056) );
  UDB116SVT24_ND3_0P75 U1412 ( .A1(n930), .A2(n866), .A3(n1056), .X(n1938) );
  UDB116SVT24_NR3_0P75 U1413 ( .A1(counter[0]), .A2(n970), .A3(n1938), .X(
        n1566) );
  UDB116SVT24_INV_0P75 U1414 ( .A(counter[1]), .X(n1945) );
  UDB116SVT24_ND2_MM_0P75 U1415 ( .A1(n1566), .A2(n1945), .X(n1944) );
  UDB116SVT24_INV_0P75 U1416 ( .A(counter[2]), .X(n1057) );
  UDB116SVT24_AOI21_0P75 U1417 ( .A1(n897), .A2(counter[0]), .B(n1938), .X(
        n1946) );
  UDB116SVT24_OAI21_0P75 U1418 ( .A1(n971), .A2(n1945), .B(n1946), .X(n1936)
         );
  UDB116SVT24_OA2BB2_0P75 U1419 ( .A1(n1944), .A2(n1057), .B1(n1057), .B2(
        n1936), .X(n840) );
  UDB116SVT24_AOAI211_0P75 U1420 ( .A1(n867), .A2(CS), .B(n971), .C(n868), .X(
        n1145) );
  UDB116SVT24_AO21_0P75 U1421 ( .A1(n1142), .A2(n1145), .B(n1020), .X(n1058)
         );
  UDB116SVT24_AO2BB2_0P75 U1422 ( .A1(n1058), .A2(n970), .B1(n1058), .B2(
        PKT_EN), .X(n841) );
  UDB116SVT24_BUF_1 U1423 ( .A(n1826), .X(n1912) );
  UDB116SVT24_BUF_1 U1424 ( .A(n1912), .X(n1858) );
  UDB116SVT24_BUF_1 U1425 ( .A(n1858), .X(n1844) );
  UDB116SVT24_AOI22_1 U1426 ( .A1(n1784), .A2(SHIFT_OUT[3]), .B1(n1844), .B2(
        \pkt_reg_inst/pkt_reg [3]), .X(\pkt_reg_inst/n109 ) );
  UDB116SVT24_INV_0P75 U1427 ( .A(SHIFT_OUT[2]), .X(n1162) );
  UDB116SVT24_BUF_1 U1428 ( .A(n1813), .X(n1059) );
  UDB116SVT24_AO2BB2_0P75 U1429 ( .A1(n1060), .A2(n1162), .B1(n1059), .B2(
        \pkt_reg_inst/pkt_reg [2]), .X(\pkt_reg_inst/n101 ) );
  UDB116SVT24_INV_0P75 U1430 ( .A(n1771), .X(n1061) );
  UDB116SVT24_INV_0P75 U1431 ( .A(SHIFT_OUT[6]), .X(n1221) );
  UDB116SVT24_AO2BB2_0P75 U1432 ( .A1(n1061), .A2(n1221), .B1(n1780), .B2(
        \pkt_reg_inst/pkt_reg [6]), .X(\pkt_reg_inst/n97 ) );
  UDB116SVT24_INV_0P75 U1433 ( .A(SHIFT_OUT[0]), .X(n1561) );
  UDB116SVT24_AO2BB2_0P75 U1434 ( .A1(n1561), .A2(n1061), .B1(n1059), .B2(
        \pkt_reg_inst/pkt_reg [0]), .X(\pkt_reg_inst/n103 ) );
  UDB116SVT24_INV_0P75 U1435 ( .A(SHIFT_OUT[4]), .X(n1225) );
  UDB116SVT24_AO2BB2_0P75 U1436 ( .A1(n1061), .A2(n1225), .B1(n1059), .B2(
        \pkt_reg_inst/pkt_reg [4]), .X(\pkt_reg_inst/n99 ) );
  UDB116SVT24_INV_0P75 U1437 ( .A(SHIFT_OUT[1]), .X(n1159) );
  UDB116SVT24_AO2BB2_0P75 U1438 ( .A1(n1060), .A2(n1159), .B1(n1059), .B2(
        \pkt_reg_inst/pkt_reg [1]), .X(\pkt_reg_inst/n102 ) );
  UDB116SVT24_INV_0P75 U1439 ( .A(SHIFT_OUT[5]), .X(n1224) );
  UDB116SVT24_BUF_1 U1440 ( .A(n1813), .X(n1790) );
  UDB116SVT24_AO2BB2_0P75 U1441 ( .A1(n1061), .A2(n1224), .B1(n1790), .B2(
        \pkt_reg_inst/pkt_reg [5]), .X(\pkt_reg_inst/n98 ) );
  UDB116SVT24_INV_0P75 U1442 ( .A(counter3[0]), .X(n1150) );
  UDB116SVT24_ND4B_1 U1443 ( .A(counter3[1]), .B1(n870), .B2(n1150), .B3(
        counter3[3]), .X(n1147) );
  UDB116SVT24_OA31_1 U1444 ( .A1(n1147), .A2(n864), .A3(tx_state[0]), .B(n1021), .X(n1063) );
  UDB116SVT24_OAI211_0P75 U1445 ( .A1(n988), .A2(tx_state[0]), .B1(n1063), 
        .B2(n1062), .X(n1067) );
  UDB116SVT24_INV_0P75 U1446 ( .A(n1067), .X(n1065) );
  UDB116SVT24_ND2_MM_0P75 U1447 ( .A1(tx_state[1]), .A2(n1063), .X(n1064) );
  UDB116SVT24_OAI31_1 U1448 ( .A1(n929), .A2(n1065), .A3(n1066), .B(n1064), 
        .X(n836) );
  UDB116SVT24_ND2_MM_0P75 U1449 ( .A1(n1067), .A2(n865), .X(n1068) );
  UDB116SVT24_OAI22_0P75 U1450 ( .A1(n1068), .A2(n1148), .B1(n1067), .B2(n1066), .X(n837) );
  UDB116SVT24_BUF_1 U1451 ( .A(n1583), .X(n1960) );
  UDB116SVT24_INV_0P75 U1452 ( .A(\sh_sync_inst/n205 ), .X(n1083) );
  UDB116SVT24_INV_0P75 U1453 ( .A(n932), .X(n1273) );
  UDB116SVT24_INV_0P75 U1454 ( .A(\sh_sync_inst/n232 ), .X(n1568) );
  UDB116SVT24_INV_0P75 U1455 ( .A(\sh_sync_inst/n230 ), .X(n1279) );
  UDB116SVT24_NR2_0P75 U1456 ( .A1(n1568), .A2(n1279), .X(n1069) );
  UDB116SVT24_ND4_0P75 U1457 ( .A1(\sh_sync_inst/n231 ), .A2(
        \sh_sync_inst/n233 ), .A3(\sh_sync_inst/n234 ), .A4(n1069), .X(n1129)
         );
  UDB116SVT24_NR3_0P75 U1458 ( .A1(\sh_sync_inst/n229 ), .A2(n910), .A3(n1129), 
        .X(n1084) );
  UDB116SVT24_ND2_MM_0P75 U1459 ( .A1(n904), .A2(n1083), .X(n1259) );
  UDB116SVT24_NR2_0P75 U1460 ( .A1(\sh_sync_inst/n228 ), .A2(n1259), .X(n1268)
         );
  UDB116SVT24_INV_0P75 U1461 ( .A(n1268), .X(n1128) );
  UDB116SVT24_NR3_0P75 U1462 ( .A1(\sh_sync_inst/n205 ), .A2(n904), .A3(n918), 
        .X(n1156) );
  UDB116SVT24_INV_0P75 U1463 ( .A(\sh_sync_inst/n248 ), .X(n1628) );
  UDB116SVT24_INV_0P75 U1464 ( .A(\sh_sync_inst/n246 ), .X(n1621) );
  UDB116SVT24_NR4_0P75 U1465 ( .A1(\sh_sync_inst/n247 ), .A2(
        \sh_sync_inst/n250 ), .A3(n1628), .A4(n1621), .X(n1070) );
  UDB116SVT24_ND4_0P75 U1466 ( .A1(n914), .A2(\sh_sync_inst/n245 ), .A3(
        \sh_sync_inst/n249 ), .A4(n1070), .X(n1082) );
  UDB116SVT24_AOI22_1 U1467 ( .A1(n1133), .A2(\sh_sync_inst/n205 ), .B1(n1156), 
        .B2(n1082), .X(n1071) );
  UDB116SVT24_OAI21_0P75 U1468 ( .A1(n1084), .A2(n1128), .B(n1071), .X(n1075)
         );
  UDB116SVT24_INV_0P75 U1469 ( .A(\sh_sync_inst/n206 ), .X(n1618) );
  UDB116SVT24_AN3B_0P75 U1470 ( .B1(\sh_sync_inst/n207 ), .B2(
        \sh_sync_inst/n203 ), .A(n872), .X(n1153) );
  UDB116SVT24_ND2_MM_0P75 U1471 ( .A1(n1618), .A2(n1153), .X(n1752) );
  UDB116SVT24_NR2_0P75 U1472 ( .A1(\sh_sync_inst/n214 ), .A2(
        \sh_sync_inst/n215 ), .X(n1184) );
  UDB116SVT24_INV_0P75 U1473 ( .A(\sh_sync_inst/n220 ), .X(n1743) );
  UDB116SVT24_INV_0P75 U1474 ( .A(\sh_sync_inst/n219 ), .X(n1245) );
  UDB116SVT24_ND2_MM_0P75 U1475 ( .A1(n1743), .A2(n1245), .X(n1749) );
  UDB116SVT24_AOAI211_0P75 U1476 ( .A1(\sh_sync_inst/n218 ), .A2(n1749), .B(
        \sh_sync_inst/n217 ), .C(\sh_sync_inst/n216 ), .X(n1074) );
  UDB116SVT24_INV_0P75 U1477 ( .A(\sh_sync_inst/n213 ), .X(n1073) );
  UDB116SVT24_NR2_0P75 U1478 ( .A1(\sh_sync_inst/n212 ), .A2(
        \sh_sync_inst/n211 ), .X(n1072) );
  UDB116SVT24_AOAI211_0P75 U1479 ( .A1(n1184), .A2(n1074), .B(n1073), .C(n1072), .X(n1078) );
  UDB116SVT24_NR2_0P75 U1480 ( .A1(n917), .A2(n1259), .X(n1565) );
  UDB116SVT24_AN3B_0P75 U1481 ( .B1(n1752), .B2(n1078), .A(n1027), .X(n1080)
         );
  UDB116SVT24_AOI21_0P75 U1482 ( .A1(n1960), .A2(n1075), .B(n1080), .X(n1076)
         );
  UDB116SVT24_OAI22_0P75 U1483 ( .A1(\sh_sync_inst/n253 ), .A2(n1273), .B1(
        n930), .B2(n1076), .X(\sh_sync_inst/N32 ) );
  UDB116SVT24_BUF_1 U1484 ( .A(n1190), .X(n1191) );
  UDB116SVT24_BUF_1 U1485 ( .A(n1191), .X(sh_en) );
  UDB116SVT24_INV_0P75 U1486 ( .A(sh_en), .X(n1234) );
  UDB116SVT24_INV_0P75 U1487 ( .A(SHIFT_OUT[62]), .X(n1762) );
  UDB116SVT24_INV_0P75 U1488 ( .A(SHIFT_OUT[63]), .X(n1760) );
  UDB116SVT24_INV_0P75 U1489 ( .A(n1191), .X(n1559) );
  UDB116SVT24_ND2_MM_0P75 U1490 ( .A1(n1559), .A2(n1077), .X(n1562) );
  UDB116SVT24_OAI22_0P75 U1491 ( .A1(n1234), .A2(n1762), .B1(n1760), .B2(n1562), .X(\shift_buf_inst/n71 ) );
  UDB116SVT24_NR2B_0P75 U1492 ( .A(\sh_sync_inst/n244 ), .B(n1083), .X(n1131)
         );
  UDB116SVT24_INV_0P75 U1493 ( .A(n898), .X(n1250) );
  UDB116SVT24_INV_0P75 U1494 ( .A(\sh_sync_inst/rfin_edge ), .X(n1584) );
  UDB116SVT24_ND2_MM_0P75 U1495 ( .A1(n1584), .A2(n1078), .X(n1178) );
  UDB116SVT24_ND2_MM_0P75 U1496 ( .A1(n920), .A2(n1178), .X(n1079) );
  UDB116SVT24_OAI31_1 U1497 ( .A1(n1131), .A2(\sh_sync_inst/n204 ), .A3(n1250), 
        .B(n1079), .X(\sh_sync_inst/n356 ) );
  UDB116SVT24_BUF_1 U1498 ( .A(n1912), .X(n1920) );
  UDB116SVT24_BUF_1 U1499 ( .A(n1920), .X(n1925) );
  UDB116SVT24_AOI22_1 U1500 ( .A1(\pkt_reg_inst/pkt_reg [62]), .A2(n1004), 
        .B1(SPI_IN[6]), .B2(n944), .X(\pkt_reg_inst/n108 ) );
  UDB116SVT24_AOI31_0P75 U1501 ( .A1(n1131), .A2(\sh_sync_inst/N530 ), .A3(
        \sh_sync_inst/n225 ), .B(n1080), .X(n1087) );
  UDB116SVT24_ND2_MM_0P75 U1502 ( .A1(n1156), .A2(n1757), .X(n1255) );
  UDB116SVT24_INV_0P75 U1503 ( .A(n1255), .X(n1170) );
  UDB116SVT24_NR2_0P75 U1504 ( .A1(\sh_sync_inst/n253 ), .A2(n1273), .X(n1081)
         );
  UDB116SVT24_AOI31_0P75 U1505 ( .A1(n1170), .A2(n1021), .A3(n1082), .B(n1081), 
        .X(n1086) );
  UDB116SVT24_ND2_MM_0P75 U1506 ( .A1(n1436), .A2(n917), .X(n1258) );
  UDB116SVT24_OAOI211_0P75 U1507 ( .A1(n1084), .A2(n1021), .B(n1083), .C(n1258), .X(n1085) );
  UDB116SVT24_ND2_MM_0P75 U1508 ( .A1(n904), .A2(n1085), .X(n1751) );
  UDB116SVT24_OAI211_0P75 U1509 ( .A1(n1087), .A2(n1022), .B1(n1086), .B2(
        n1751), .X(\sh_sync_inst/N30 ) );
  UDB116SVT24_INV_0P75 U1510 ( .A(\sh_sync_inst/n179 ), .X(n1117) );
  UDB116SVT24_INV_0P75 U1511 ( .A(n952), .X(n1714) );
  UDB116SVT24_INV_0P75 U1512 ( .A(\sh_sync_inst/n181 ), .X(n1119) );
  UDB116SVT24_AOI2222_V2_0P75 U1513 ( .A1(n1117), .A2(n968), .B1(
        \sh_sync_inst/n181 ), .B2(n1714), .C1(n967), .C2(\sh_sync_inst/n179 ), 
        .D1(n952), .D2(n1119), .X(n1093) );
  UDB116SVT24_INV_0P75 U1514 ( .A(\sh_sync_inst/n186 ), .X(n1106) );
  UDB116SVT24_INV_0P75 U1515 ( .A(\sh_sync_inst/n188 ), .X(n1105) );
  UDB116SVT24_AOI2222_V2_0P75 U1516 ( .A1(n1106), .A2(
        \sh_sync_inst/intadd_0/B[7] ), .B1(\sh_sync_inst/n188 ), .B2(n921), 
        .C1(n941), .C2(\sh_sync_inst/n186 ), .D1(\sh_sync_inst/intadd_0/B[9] ), 
        .D2(n1105), .X(n1092) );
  UDB116SVT24_INV_0P75 U1517 ( .A(\sh_sync_inst/n192 ), .X(n1113) );
  UDB116SVT24_AOI22_1 U1518 ( .A1(\sh_sync_inst/n192 ), .A2(
        \sh_sync_inst/intadd_0/B[13] ), .B1(n875), .B2(n1113), .X(n1089) );
  UDB116SVT24_OAI21_0P75 U1519 ( .A1(n923), .A2(\sh_sync_inst/n190 ), .B(
        \sh_sync_inst/n195 ), .X(n1088) );
  UDB116SVT24_AOI211_0P75 U1520 ( .A1(n911), .A2(\sh_sync_inst/n190 ), .B1(
        n1089), .B2(n1088), .X(n1091) );
  UDB116SVT24_INV_0P75 U1521 ( .A(\sh_sync_inst/n183 ), .X(n1118) );
  UDB116SVT24_INV_0P75 U1522 ( .A(n1007), .X(n1718) );
  UDB116SVT24_INV_0P75 U1523 ( .A(\sh_sync_inst/n187 ), .X(n1111) );
  UDB116SVT24_AOI2222_V2_0P75 U1524 ( .A1(n1118), .A2(n1006), .B1(
        \sh_sync_inst/n187 ), .B2(n876), .C1(n1718), .C2(\sh_sync_inst/n183 ), 
        .D1(n935), .D2(n1111), .X(n1090) );
  UDB116SVT24_ND4_0P75 U1525 ( .A1(n1093), .A2(n1092), .A3(n1091), .A4(n1090), 
        .X(n1127) );
  UDB116SVT24_INV_0P75 U1526 ( .A(\sh_sync_inst/n193 ), .X(n1094) );
  UDB116SVT24_INV_0P75 U1527 ( .A(\sh_sync_inst/intadd_0/B[3] ), .X(n1262) );
  UDB116SVT24_INV_0P75 U1528 ( .A(\sh_sync_inst/n182 ), .X(n1101) );
  UDB116SVT24_AOI2222_V2_0P75 U1529 ( .A1(n1094), .A2(n937), .B1(
        \sh_sync_inst/n182 ), .B2(n1262), .C1(n936), .C2(\sh_sync_inst/n193 ), 
        .D1(n966), .D2(n1101), .X(n1098) );
  UDB116SVT24_INV_0P75 U1530 ( .A(\sh_sync_inst/n178 ), .X(n1102) );
  UDB116SVT24_INV_0P75 U1531 ( .A(n1016), .X(n1592) );
  UDB116SVT24_INV_0P75 U1532 ( .A(\sh_sync_inst/n180 ), .X(n1116) );
  UDB116SVT24_AOI2222_V2_0P75 U1533 ( .A1(n1102), .A2(n1015), .B1(
        \sh_sync_inst/n180 ), .B2(n877), .C1(n1592), .C2(\sh_sync_inst/n178 ), 
        .D1(n906), .D2(n1116), .X(n1097) );
  UDB116SVT24_INV_0P75 U1534 ( .A(\sh_sync_inst/n189 ), .X(n1115) );
  UDB116SVT24_INV_0P75 U1535 ( .A(n1018), .X(n1114) );
  UDB116SVT24_INV_0P75 U1536 ( .A(n958), .X(n1288) );
  UDB116SVT24_INV_0P75 U1537 ( .A(\sh_sync_inst/n191 ), .X(n1103) );
  UDB116SVT24_AOI2222_V2_0P75 U1538 ( .A1(n1115), .A2(n958), .B1(
        \sh_sync_inst/n191 ), .B2(n1114), .C1(n1288), .C2(\sh_sync_inst/n189 ), 
        .D1(n1019), .D2(n1103), .X(n1096) );
  UDB116SVT24_INV_0P75 U1539 ( .A(\sh_sync_inst/n184 ), .X(n1100) );
  UDB116SVT24_INV_0P75 U1540 ( .A(n1012), .X(n1135) );
  UDB116SVT24_INV_0P75 U1541 ( .A(\sh_sync_inst/n185 ), .X(n1099) );
  UDB116SVT24_AOI2222_V2_0P75 U1542 ( .A1(n1100), .A2(n955), .B1(
        \sh_sync_inst/n185 ), .B2(n1135), .C1(n925), .C2(\sh_sync_inst/n184 ), 
        .D1(n1013), .D2(n1099), .X(n1095) );
  UDB116SVT24_ND4_0P75 U1543 ( .A1(n1098), .A2(n1097), .A3(n1096), .A4(n1095), 
        .X(n1126) );
  UDB116SVT24_AOI2222_V2_0P75 U1544 ( .A1(n1100), .A2(n1007), .B1(
        \sh_sync_inst/n185 ), .B2(n953), .C1(n1718), .C2(\sh_sync_inst/n184 ), 
        .D1(n954), .D2(n1099), .X(n1110) );
  UDB116SVT24_AOI2222_V2_0P75 U1545 ( .A1(n1102), .A2(n937), .B1(
        \sh_sync_inst/n182 ), .B2(n1714), .C1(n924), .C2(\sh_sync_inst/n178 ), 
        .D1(n951), .D2(n1101), .X(n1109) );
  UDB116SVT24_INV_0P75 U1546 ( .A(\sh_sync_inst/n190 ), .X(n1104) );
  UDB116SVT24_AOI2222_V2_0P75 U1547 ( .A1(n1104), .A2(n957), .B1(
        \sh_sync_inst/n191 ), .B2(n923), .C1(n1288), .C2(n857), .D1(
        \sh_sync_inst/intadd_0/B[11] ), .D2(n1103), .X(n1108) );
  UDB116SVT24_AOI2222_V2_0P75 U1548 ( .A1(n1106), .A2(n1013), .B1(
        \sh_sync_inst/n188 ), .B2(n876), .C1(n1135), .C2(\sh_sync_inst/n186 ), 
        .D1(n934), .D2(n1105), .X(n1107) );
  UDB116SVT24_ND4_0P75 U1549 ( .A1(n1110), .A2(n1109), .A3(n1108), .A4(n1107), 
        .X(n1125) );
  UDB116SVT24_AOI22_1 U1550 ( .A1(\sh_sync_inst/n187 ), .A2(
        \sh_sync_inst/intadd_0/B[7] ), .B1(n940), .B2(n1111), .X(n1112) );
  UDB116SVT24_NR3_0P75 U1551 ( .A1(\sh_sync_inst/n195 ), .A2(n1112), .A3(n874), 
        .X(n1123) );
  UDB116SVT24_AOI2222_V2_0P75 U1552 ( .A1(n1115), .A2(n1588), .B1(
        \sh_sync_inst/n192 ), .B2(n1114), .C1(n922), .C2(\sh_sync_inst/n189 ), 
        .D1(n1019), .D2(n1113), .X(n1122) );
  UDB116SVT24_AOI2222_V2_0P75 U1553 ( .A1(n1117), .A2(n1015), .B1(
        \sh_sync_inst/n180 ), .B2(n967), .C1(n1592), .C2(\sh_sync_inst/n179 ), 
        .D1(n968), .D2(n1116), .X(n1121) );
  UDB116SVT24_AOI2222_V2_0P75 U1554 ( .A1(n1119), .A2(n906), .B1(
        \sh_sync_inst/n183 ), .B2(n1262), .C1(n877), .C2(\sh_sync_inst/n181 ), 
        .D1(n966), .D2(n1118), .X(n1120) );
  UDB116SVT24_ND4_0P75 U1555 ( .A1(n1123), .A2(n1122), .A3(n1121), .A4(n1120), 
        .X(n1124) );
  UDB116SVT24_OAI22_0P75 U1556 ( .A1(n1127), .A2(n1126), .B1(n1125), .B2(n1124), .X(n1269) );
  UDB116SVT24_NR2B_0P75 U1557 ( .A(n1269), .B(n1128), .X(n1130) );
  UDB116SVT24_NR2B_0P75 U1558 ( .A(n1129), .B(\sh_sync_inst/n229 ), .X(n1271)
         );
  UDB116SVT24_INV_0P75 U1559 ( .A(n1271), .X(n1132) );
  UDB116SVT24_AOI21_0P75 U1560 ( .A1(\sh_sync_inst/n228 ), .A2(n1131), .B(n984), .X(n1152) );
  UDB116SVT24_AOAI211_0P75 U1561 ( .A1(n1130), .A2(n1132), .B(
        \sh_sync_inst/n195 ), .C(n1152), .X(\sh_sync_inst/n355 ) );
  UDB116SVT24_ND2_MM_0P75 U1562 ( .A1(n918), .A2(n1131), .X(n1331) );
  UDB116SVT24_AOAI211_0P75 U1563 ( .A1(n918), .A2(n1132), .B(n1259), .C(n1331), 
        .X(n1134) );
  UDB116SVT24_INV_0P75 U1564 ( .A(n1134), .X(n1141) );
  UDB116SVT24_NR2_0P75 U1565 ( .A1(n968), .A2(n1015), .X(n1573) );
  UDB116SVT24_ND3_0P75 U1566 ( .A1(n1573), .A2(n877), .A3(n936), .X(n1713) );
  UDB116SVT24_ND4_0P75 U1567 ( .A1(\sh_sync_inst/intadd_0/B[13] ), .A2(n954), 
        .A3(n965), .A4(n1135), .X(n1138) );
  UDB116SVT24_ND4_0P75 U1568 ( .A1(n957), .A2(n1018), .A3(
        \sh_sync_inst/intadd_0/B[9] ), .A4(n941), .X(n1137) );
  UDB116SVT24_ND4_0P75 U1569 ( .A1(n1006), .A2(n952), .A3(n923), .A4(n876), 
        .X(n1136) );
  UDB116SVT24_NR4_0P75 U1570 ( .A1(n1713), .A2(n1138), .A3(n1137), .A4(n1136), 
        .X(n1256) );
  UDB116SVT24_AOI22_1 U1571 ( .A1(n1256), .A2(n1156), .B1(n1268), .B2(n1269), 
        .X(n1140) );
  UDB116SVT24_OAI21_0P75 U1572 ( .A1(sh_en), .A2(n1141), .B(n1960), .X(n1139)
         );
  UDB116SVT24_AOI21_0P75 U1573 ( .A1(n1141), .A2(n1140), .B(n1139), .X(
        \sh_sync_inst/n338 ) );
  UDB116SVT24_INV_0P75 U1574 ( .A(n1152), .X(n1267) );
  UDB116SVT24_AOI31_0P75 U1575 ( .A1(\sh_sync_inst/n228 ), .A2(
        \sh_sync_inst/n244 ), .A3(\sh_sync_inst/rfin_edge ), .B(n1267), .X(
        n1151) );
  UDB116SVT24_AOI21_0P75 U1576 ( .A1(\sh_sync_inst/n203 ), .A2(n920), .B(n1151), .X(n1175) );
  UDB116SVT24_AOI21_0P75 U1577 ( .A1(n1151), .A2(\sh_sync_inst/n203 ), .B(
        n1175), .X(\sh_sync_inst/n307 ) );
  UDB116SVT24_NR3_0P75 U1578 ( .A1(\sh_sync_inst/n203 ), .A2(n1151), .A3(n1030), .X(n1174) );
  UDB116SVT24_OA2BB2_0P75 U1579 ( .A1(n1175), .A2(n872), .B1(n873), .B2(n1174), 
        .X(\sh_sync_inst/n304 ) );
  UDB116SVT24_BUF_1 U1580 ( .A(n1160), .X(n1205) );
  UDB116SVT24_INV_0P75 U1581 ( .A(n1205), .X(n1207) );
  UDB116SVT24_BUF_1 U1582 ( .A(n1562), .X(n1203) );
  UDB116SVT24_OAI22_0P75 U1583 ( .A1(n1207), .A2(n1221), .B1(n1206), .B2(n1203), .X(\shift_buf_inst/n127 ) );
  UDB116SVT24_INV_0P75 U1584 ( .A(n1142), .X(n1934) );
  UDB116SVT24_ND3_0P75 U1585 ( .A1(n1143), .A2(pkt_rec), .A3(n1934), .X(n1955)
         );
  UDB116SVT24_NR4_0P75 U1586 ( .A1(counter[1]), .A2(counter[0]), .A3(
        counter[2]), .A4(counter[3]), .X(n1935) );
  UDB116SVT24_OAI211_0P75 U1587 ( .A1(n987), .A2(n1935), .B1(n971), .B2(
        rx_state[1]), .X(n1144) );
  UDB116SVT24_AOI31_0P75 U1588 ( .A1(n1145), .A2(n1955), .A3(n1144), .B(n1022), 
        .X(n1177) );
  UDB116SVT24_AOAI211_0P75 U1589 ( .A1(rx_state[1]), .A2(n1935), .B(n869), .C(
        n896), .X(n1146) );
  UDB116SVT24_INV_0P75 U1590 ( .A(n1177), .X(n1943) );
  UDB116SVT24_AOI22_1 U1591 ( .A1(n1177), .A2(n1146), .B1(n868), .B2(n1943), 
        .X(n843) );
  UDB116SVT24_OAI22_0P75 U1592 ( .A1(n1207), .A2(n1831), .B1(n1829), .B2(n1203), .X(\shift_buf_inst/n94 ) );
  UDB116SVT24_ND2_MM_0P75 U1593 ( .A1(n1147), .A2(tx_state[1]), .X(n1149) );
  UDB116SVT24_NR2_0P75 U1594 ( .A1(n1149), .A2(n1234), .X(n1196) );
  UDB116SVT24_INV_0P75 U1595 ( .A(n1196), .X(n1951) );
  UDB116SVT24_NR2_0P75 U1596 ( .A1(counter3[0]), .A2(n1951), .X(n1947) );
  UDB116SVT24_NR2_0P75 U1597 ( .A1(n984), .A2(n1148), .X(n1948) );
  UDB116SVT24_OAI21_0P75 U1598 ( .A1(sh_en), .A2(n1149), .B(n1948), .X(n1949)
         );
  UDB116SVT24_NR2_0P75 U1599 ( .A1(n1947), .A2(n1949), .X(n1183) );
  UDB116SVT24_NR3_0P75 U1600 ( .A1(n1150), .A2(n1951), .A3(n1949), .X(n1182)
         );
  UDB116SVT24_OA2BB2_0P75 U1601 ( .A1(n994), .A2(n1183), .B1(n1182), .B2(n994), 
        .X(n832) );
  UDB116SVT24_INV_0P75 U1602 ( .A(\sh_sync_inst/intadd_0/A[0] ), .X(n1546) );
  UDB116SVT24_INV_0P75 U1603 ( .A(\sh_sync_inst/n177 ), .X(n1229) );
  UDB116SVT24_ND2_MM_0P75 U1604 ( .A1(n1229), .A2(n924), .X(n1609) );
  UDB116SVT24_MAJ3_0P75 U1605 ( .A1(\sh_sync_inst/n176 ), .A2(
        \sh_sync_inst/n201 ), .A3(n1609), .X(n1199) );
  UDB116SVT24_OA2BB2_0P75 U1606 ( .A1(n968), .A2(n1199), .B1(n1199), .B2(n969), 
        .X(n1155) );
  UDB116SVT24_AOI31_0P75 U1607 ( .A1(n1153), .A2(\sh_sync_inst/n206 ), .A3(
        n1152), .B(n1151), .X(n1306) );
  UDB116SVT24_INV_0P75 U1608 ( .A(n1306), .X(n1314) );
  UDB116SVT24_BUF_1 U1609 ( .A(n1314), .X(n1694) );
  UDB116SVT24_INV_0P75 U1610 ( .A(n1694), .X(n1291) );
  UDB116SVT24_AOI21_0P75 U1611 ( .A1(n1306), .A2(n1155), .B(n1546), .X(n1154)
         );
  UDB116SVT24_AOAOI2111_0P75 U1612 ( .A1(n1546), .A2(n1155), .B(n1029), .C(
        n1291), .D(n1154), .X(\sh_sync_inst/n301 ) );
  UDB116SVT24_AOI21_0P75 U1613 ( .A1(n1156), .A2(n1256), .B(n1267), .X(n1169)
         );
  UDB116SVT24_NR2_0P75 U1614 ( .A1(n1169), .A2(n1255), .X(n1624) );
  UDB116SVT24_INV_0P75 U1615 ( .A(n1624), .X(n1627) );
  UDB116SVT24_OA2BB2_0P75 U1616 ( .A1(n914), .A2(n1627), .B1(n850), .B2(n914), 
        .X(\sh_sync_inst/n337 ) );
  UDB116SVT24_NR2_0P75 U1617 ( .A1(\sh_sync_inst/n251 ), .A2(
        \sh_sync_inst/n245 ), .X(n1168) );
  UDB116SVT24_INV_0P75 U1618 ( .A(\sh_sync_inst/n247 ), .X(n1173) );
  UDB116SVT24_ND3_0P75 U1619 ( .A1(n1168), .A2(n1621), .A3(n1173), .X(n1626)
         );
  UDB116SVT24_NR2_0P75 U1620 ( .A1(\sh_sync_inst/n248 ), .A2(n1626), .X(n1164)
         );
  UDB116SVT24_INV_0P75 U1621 ( .A(n1164), .X(n1157) );
  UDB116SVT24_AOI21_0P75 U1622 ( .A1(n1157), .A2(n1170), .B(n1169), .X(n1165)
         );
  UDB116SVT24_ND2_MM_0P75 U1623 ( .A1(n1005), .A2(\sh_sync_inst/n249 ), .X(
        n1158) );
  UDB116SVT24_OAI22_0P75 U1624 ( .A1(n854), .A2(n1165), .B1(n1158), .B2(n1157), 
        .X(\sh_sync_inst/n335 ) );
  UDB116SVT24_INV_0P75 U1625 ( .A(n1190), .X(n1563) );
  UDB116SVT24_BUF_1 U1626 ( .A(n1210), .X(n1163) );
  UDB116SVT24_OAI22_0P75 U1627 ( .A1(n1563), .A2(n1159), .B1(n1162), .B2(n1163), .X(\shift_buf_inst/n132 ) );
  UDB116SVT24_INV_0P75 U1628 ( .A(SHIFT_OUT[45]), .X(n1812) );
  UDB116SVT24_BUF_1 U1629 ( .A(n1210), .X(n1754) );
  UDB116SVT24_OAI22_0P75 U1630 ( .A1(n1563), .A2(n1816), .B1(n1812), .B2(n1754), .X(\shift_buf_inst/n89 ) );
  UDB116SVT24_OAI22_0P75 U1631 ( .A1(n1563), .A2(n1561), .B1(n1159), .B2(n1754), .X(\shift_buf_inst/n133 ) );
  UDB116SVT24_BUF_1 U1632 ( .A(n1160), .X(n1233) );
  UDB116SVT24_INV_0P75 U1633 ( .A(n1233), .X(n1232) );
  UDB116SVT24_INV_0P75 U1634 ( .A(SHIFT_OUT[3]), .X(n1161) );
  UDB116SVT24_OAI22_0P75 U1635 ( .A1(n1232), .A2(n1161), .B1(n1225), .B2(n1163), .X(\shift_buf_inst/n130 ) );
  UDB116SVT24_AOI21_0P75 U1636 ( .A1(n914), .A2(n1624), .B(n850), .X(n1622) );
  UDB116SVT24_ND2_MM_0P75 U1637 ( .A1(\sh_sync_inst/n245 ), .A2(n1624), .X(
        n1620) );
  UDB116SVT24_OAI22_0P75 U1638 ( .A1(\sh_sync_inst/n245 ), .A2(n1622), .B1(
        \sh_sync_inst/n251 ), .B2(n1620), .X(\sh_sync_inst/n331 ) );
  UDB116SVT24_OAI22_0P75 U1639 ( .A1(n1232), .A2(n1162), .B1(n1161), .B2(n1163), .X(\shift_buf_inst/n131 ) );
  UDB116SVT24_INV_0P75 U1640 ( .A(SHIFT_OUT[47]), .X(n1806) );
  UDB116SVT24_INV_0P75 U1641 ( .A(SHIFT_OUT[48]), .X(n1804) );
  UDB116SVT24_OAI22_0P75 U1642 ( .A1(n1232), .A2(n1806), .B1(n1804), .B2(n1163), .X(\shift_buf_inst/n86 ) );
  UDB116SVT24_ND3_0P75 U1643 ( .A1(n1005), .A2(\sh_sync_inst/n250 ), .A3(n1164), .X(n1167) );
  UDB116SVT24_AOI21B_0P75 U1644 ( .A1(n1005), .A2(\sh_sync_inst/n249 ), .B(
        n1165), .X(n1166) );
  UDB116SVT24_OAI22_0P75 U1645 ( .A1(n854), .A2(n1167), .B1(
        \sh_sync_inst/n250 ), .B2(n1166), .X(\sh_sync_inst/n336 ) );
  UDB116SVT24_ND2_MM_0P75 U1646 ( .A1(n1624), .A2(n1168), .X(n1619) );
  UDB116SVT24_ND2_MM_0P75 U1647 ( .A1(n1621), .A2(n1168), .X(n1171) );
  UDB116SVT24_AO21_0P75 U1648 ( .A1(n1171), .A2(n1170), .B(n1169), .X(n1623)
         );
  UDB116SVT24_ND2_MM_0P75 U1649 ( .A1(n1173), .A2(n1623), .X(n1172) );
  UDB116SVT24_OAI31_1 U1650 ( .A1(n1173), .A2(n1619), .A3(\sh_sync_inst/n246 ), 
        .B(n1172), .X(\sh_sync_inst/n333 ) );
  UDB116SVT24_ND2_MM_0P75 U1651 ( .A1(n1174), .A2(n872), .X(n1617) );
  UDB116SVT24_OAI21_0P75 U1652 ( .A1(n873), .A2(n1030), .B(n1175), .X(n1614)
         );
  UDB116SVT24_OA2BB2_0P75 U1653 ( .A1(n993), .A2(n1617), .B1(n1614), .B2(
        \sh_sync_inst/n207 ), .X(\sh_sync_inst/n305 ) );
  UDB116SVT24_NR2_0P75 U1654 ( .A1(n869), .A2(n1943), .X(n1941) );
  UDB116SVT24_ND2_MM_0P75 U1655 ( .A1(n1000), .A2(n1941), .X(n1940) );
  UDB116SVT24_OAI22_0P75 U1656 ( .A1(n1935), .A2(n1940), .B1(n1177), .B2(n970), 
        .X(n845) );
  UDB116SVT24_INV_0P75 U1657 ( .A(n975), .X(n1254) );
  UDB116SVT24_INV_0P75 U1658 ( .A(\sh_sync_inst/n224 ), .X(n1179) );
  UDB116SVT24_AOI22_1 U1659 ( .A1(\sh_sync_inst/n224 ), .A2(n1254), .B1(n1250), 
        .B2(n1179), .X(\sh_sync_inst/n354 ) );
  UDB116SVT24_AOI21_0P75 U1660 ( .A1(\sh_sync_inst/n224 ), .A2(n978), .B(n899), 
        .X(n1189) );
  UDB116SVT24_ND2_MM_0P75 U1661 ( .A1(n977), .A2(\sh_sync_inst/n223 ), .X(
        n1188) );
  UDB116SVT24_OAI22_0P75 U1662 ( .A1(\sh_sync_inst/n223 ), .A2(n1189), .B1(
        \sh_sync_inst/n224 ), .B2(n1188), .X(\sh_sync_inst/n353 ) );
  UDB116SVT24_OR3B_0P75 U1663 ( .B1(\sh_sync_inst/n222 ), .B2(
        \sh_sync_inst/n223 ), .A(n1179), .X(n1185) );
  UDB116SVT24_NR2_0P75 U1664 ( .A1(n1185), .A2(\sh_sync_inst/n221 ), .X(n1243)
         );
  UDB116SVT24_INV_0P75 U1665 ( .A(\sh_sync_inst/n218 ), .X(n1750) );
  UDB116SVT24_AN4_1 U1666 ( .A1(n1743), .A2(n1245), .A3(n1243), .A4(n1750), 
        .X(n1635) );
  UDB116SVT24_INV_0P75 U1667 ( .A(\sh_sync_inst/n217 ), .X(n1634) );
  UDB116SVT24_ND2_MM_0P75 U1668 ( .A1(n1635), .A2(n1634), .X(n1252) );
  UDB116SVT24_NR2_0P75 U1669 ( .A1(\sh_sync_inst/n216 ), .A2(n1252), .X(n1246)
         );
  UDB116SVT24_INV_0P75 U1670 ( .A(n1246), .X(n1180) );
  UDB116SVT24_AOI21_0P75 U1671 ( .A1(n1180), .A2(n977), .B(n898), .X(n1247) );
  UDB116SVT24_ND2_MM_0P75 U1672 ( .A1(\sh_sync_inst/n215 ), .A2(n978), .X(
        n1181) );
  UDB116SVT24_OAI22_0P75 U1673 ( .A1(n856), .A2(n1247), .B1(n1181), .B2(n1180), 
        .X(\sh_sync_inst/n345 ) );
  UDB116SVT24_ND2_MM_0P75 U1674 ( .A1(counter3[1]), .A2(n1182), .X(n1198) );
  UDB116SVT24_OAI21_0P75 U1675 ( .A1(counter3[1]), .A2(n1951), .B(n1183), .X(
        n1195) );
  UDB116SVT24_OA2BB2_0P75 U1676 ( .A1(n1198), .A2(n870), .B1(n870), .B2(n1195), 
        .X(n831) );
  UDB116SVT24_ND2_MM_0P75 U1677 ( .A1(n1184), .A2(n1246), .X(n1213) );
  UDB116SVT24_AOI21_0P75 U1678 ( .A1(n976), .A2(n1213), .B(n899), .X(n1632) );
  UDB116SVT24_ND2_MM_0P75 U1679 ( .A1(\sh_sync_inst/n213 ), .A2(n978), .X(
        n1630) );
  UDB116SVT24_OAI22_0P75 U1680 ( .A1(\sh_sync_inst/n213 ), .A2(n1632), .B1(
        n1630), .B2(n1213), .X(\sh_sync_inst/n343 ) );
  UDB116SVT24_AOI21_0P75 U1681 ( .A1(n977), .A2(n1185), .B(n898), .X(n1744) );
  UDB116SVT24_ND2_MM_0P75 U1682 ( .A1(n975), .A2(\sh_sync_inst/n221 ), .X(
        n1742) );
  UDB116SVT24_OAI22_0P75 U1683 ( .A1(\sh_sync_inst/n221 ), .A2(n1744), .B1(
        n1742), .B2(n1185), .X(\sh_sync_inst/n351 ) );
  UDB116SVT24_NR2_0P75 U1684 ( .A1(n855), .A2(\sh_sync_inst/n223 ), .X(n1186)
         );
  UDB116SVT24_ND3_0P75 U1685 ( .A1(n976), .A2(\sh_sync_inst/n222 ), .A3(n1186), 
        .X(n1187) );
  UDB116SVT24_AOAI211_0P75 U1686 ( .A1(n1189), .A2(n1188), .B(
        \sh_sync_inst/n222 ), .C(n1187), .X(\sh_sync_inst/n352 ) );
  UDB116SVT24_INV_0P75 U1687 ( .A(n1191), .X(n1194) );
  UDB116SVT24_INV_0P75 U1688 ( .A(SHIFT_OUT[27]), .X(n1867) );
  UDB116SVT24_INV_0P75 U1689 ( .A(SHIFT_OUT[28]), .X(n1863) );
  UDB116SVT24_BUF_1 U1690 ( .A(n1210), .X(n1192) );
  UDB116SVT24_BUF_1 U1691 ( .A(n1192), .X(n1204) );
  UDB116SVT24_OAI22_0P75 U1692 ( .A1(n1194), .A2(n1867), .B1(n1863), .B2(n1204), .X(\shift_buf_inst/n106 ) );
  UDB116SVT24_BUF_1 U1693 ( .A(n1190), .X(n1209) );
  UDB116SVT24_INV_0P75 U1694 ( .A(n1209), .X(n1211) );
  UDB116SVT24_INV_0P75 U1695 ( .A(SHIFT_OUT[29]), .X(n1860) );
  UDB116SVT24_OAI22_0P75 U1696 ( .A1(n1211), .A2(n1863), .B1(n1860), .B2(n1204), .X(\shift_buf_inst/n105 ) );
  UDB116SVT24_INV_0P75 U1697 ( .A(SHIFT_OUT[25]), .X(n1872) );
  UDB116SVT24_INV_0P75 U1698 ( .A(SHIFT_OUT[26]), .X(n1870) );
  UDB116SVT24_BUF_1 U1699 ( .A(n1192), .X(n1193) );
  UDB116SVT24_OAI22_0P75 U1700 ( .A1(n1194), .A2(n1872), .B1(n1870), .B2(n1193), .X(\shift_buf_inst/n108 ) );
  UDB116SVT24_OAI22_0P75 U1701 ( .A1(n1194), .A2(n1870), .B1(n1867), .B2(n1204), .X(\shift_buf_inst/n107 ) );
  UDB116SVT24_INV_0P75 U1702 ( .A(n1191), .X(n1216) );
  UDB116SVT24_INV_0P75 U1703 ( .A(SHIFT_OUT[22]), .X(n1882) );
  UDB116SVT24_INV_0P75 U1704 ( .A(SHIFT_OUT[23]), .X(n1879) );
  UDB116SVT24_OAI22_0P75 U1705 ( .A1(n1216), .A2(n1882), .B1(n1879), .B2(n1193), .X(\shift_buf_inst/n111 ) );
  UDB116SVT24_INV_0P75 U1706 ( .A(SHIFT_OUT[21]), .X(n1884) );
  UDB116SVT24_OAI22_0P75 U1707 ( .A1(n1216), .A2(n1884), .B1(n1882), .B2(n1193), .X(\shift_buf_inst/n112 ) );
  UDB116SVT24_INV_0P75 U1708 ( .A(n1209), .X(n1222) );
  UDB116SVT24_INV_0P75 U1709 ( .A(SHIFT_OUT[36]), .X(n1841) );
  UDB116SVT24_INV_0P75 U1710 ( .A(SHIFT_OUT[37]), .X(n1838) );
  UDB116SVT24_BUF_1 U1711 ( .A(n1203), .X(n1208) );
  UDB116SVT24_BUF_1 U1712 ( .A(n1208), .X(n1217) );
  UDB116SVT24_OAI22_0P75 U1713 ( .A1(n1222), .A2(n1841), .B1(n1838), .B2(n1217), .X(\shift_buf_inst/n97 ) );
  UDB116SVT24_INV_0P75 U1714 ( .A(SHIFT_OUT[33]), .X(n1848) );
  UDB116SVT24_INV_0P75 U1715 ( .A(SHIFT_OUT[34]), .X(n1846) );
  UDB116SVT24_BUF_1 U1716 ( .A(n1192), .X(n1755) );
  UDB116SVT24_OAI22_0P75 U1717 ( .A1(n1211), .A2(n1848), .B1(n1846), .B2(n1755), .X(\shift_buf_inst/n100 ) );
  UDB116SVT24_INV_0P75 U1718 ( .A(SHIFT_OUT[24]), .X(n1875) );
  UDB116SVT24_OAI22_0P75 U1719 ( .A1(n1194), .A2(n1875), .B1(n1872), .B2(n1193), .X(\shift_buf_inst/n109 ) );
  UDB116SVT24_AOAI211_0P75 U1720 ( .A1(n1196), .A2(n871), .B(n1195), .C(
        counter3[3]), .X(n1197) );
  UDB116SVT24_OAI31_1 U1721 ( .A1(counter3[3]), .A2(n871), .A3(n1198), .B(
        n1197), .X(n830) );
  UDB116SVT24_MAJ3_0P75 U1722 ( .A1(\sh_sync_inst/intadd_0/B[0] ), .A2(
        \sh_sync_inst/intadd_0/A[0] ), .A3(n1199), .X(n1739) );
  UDB116SVT24_MAJ3_0P75 U1723 ( .A1(\sh_sync_inst/intadd_0/A[1] ), .A2(
        \sh_sync_inst/intadd_0/B[1] ), .A3(n1739), .X(n1261) );
  UDB116SVT24_INV_0P75 U1724 ( .A(n1261), .X(n1200) );
  UDB116SVT24_AOI22_1 U1725 ( .A1(n951), .A2(n1261), .B1(n1200), .B2(n1714), 
        .X(n1202) );
  UDB116SVT24_INV_0P75 U1726 ( .A(n1694), .X(n1693) );
  UDB116SVT24_AOI21_0P75 U1727 ( .A1(n1693), .A2(n1202), .B(n879), .X(n1201)
         );
  UDB116SVT24_AOAOI2111_0P75 U1728 ( .A1(n878), .A2(n1202), .B(n1030), .C(
        n1291), .D(n1201), .X(\sh_sync_inst/n299 ) );
  UDB116SVT24_INV_0P75 U1729 ( .A(SHIFT_OUT[46]), .X(n1809) );
  UDB116SVT24_OAI22_0P75 U1730 ( .A1(n1222), .A2(n1812), .B1(n1809), .B2(n1217), .X(\shift_buf_inst/n88 ) );
  UDB116SVT24_INV_0P75 U1731 ( .A(n1209), .X(n1226) );
  UDB116SVT24_BUF_1 U1732 ( .A(n1203), .X(n1214) );
  UDB116SVT24_BUF_1 U1733 ( .A(n1214), .X(n1223) );
  UDB116SVT24_OAI22_0P75 U1734 ( .A1(n1226), .A2(n1819), .B1(n1816), .B2(n1223), .X(\shift_buf_inst/n90 ) );
  UDB116SVT24_BUF_1 U1735 ( .A(n1208), .X(n1220) );
  UDB116SVT24_OAI22_0P75 U1736 ( .A1(n1226), .A2(n1822), .B1(n1819), .B2(n1220), .X(\shift_buf_inst/n91 ) );
  UDB116SVT24_INV_0P75 U1737 ( .A(n1205), .X(n1227) );
  UDB116SVT24_OAI22_0P75 U1738 ( .A1(n1227), .A2(n1825), .B1(n1822), .B2(n1223), .X(\shift_buf_inst/n92 ) );
  UDB116SVT24_OAI22_0P75 U1739 ( .A1(n1226), .A2(n1829), .B1(n1825), .B2(n1220), .X(\shift_buf_inst/n93 ) );
  UDB116SVT24_OAI22_0P75 U1740 ( .A1(n1222), .A2(n1835), .B1(n1831), .B2(n1220), .X(\shift_buf_inst/n95 ) );
  UDB116SVT24_OAI22_0P75 U1741 ( .A1(n1211), .A2(n1838), .B1(n1835), .B2(n1204), .X(\shift_buf_inst/n96 ) );
  UDB116SVT24_INV_0P75 U1742 ( .A(n1205), .X(n1231) );
  UDB116SVT24_INV_0P75 U1743 ( .A(SHIFT_OUT[9]), .X(n1924) );
  UDB116SVT24_INV_0P75 U1744 ( .A(SHIFT_OUT[10]), .X(n1922) );
  UDB116SVT24_BUF_1 U1745 ( .A(n1214), .X(n1215) );
  UDB116SVT24_OAI22_0P75 U1746 ( .A1(n1231), .A2(n1924), .B1(n1922), .B2(n1215), .X(\shift_buf_inst/n124 ) );
  UDB116SVT24_INV_0P75 U1747 ( .A(SHIFT_OUT[8]), .X(n1928) );
  UDB116SVT24_OAI22_0P75 U1748 ( .A1(n1207), .A2(n1928), .B1(n1924), .B2(n1215), .X(\shift_buf_inst/n125 ) );
  UDB116SVT24_OAI22_0P75 U1749 ( .A1(n1207), .A2(n1206), .B1(n1928), .B2(n1215), .X(\shift_buf_inst/n126 ) );
  UDB116SVT24_INV_0P75 U1750 ( .A(SHIFT_OUT[30]), .X(n1857) );
  UDB116SVT24_BUF_1 U1751 ( .A(n1208), .X(n1218) );
  UDB116SVT24_OAI22_0P75 U1752 ( .A1(n1216), .A2(n1860), .B1(n1857), .B2(n1218), .X(\shift_buf_inst/n104 ) );
  UDB116SVT24_INV_0P75 U1753 ( .A(n1209), .X(n1219) );
  UDB116SVT24_INV_0P75 U1754 ( .A(SHIFT_OUT[16]), .X(n1900) );
  UDB116SVT24_INV_0P75 U1755 ( .A(SHIFT_OUT[17]), .X(n1897) );
  UDB116SVT24_OAI22_0P75 U1756 ( .A1(n1219), .A2(n1900), .B1(n1897), .B2(n1217), .X(\shift_buf_inst/n117 ) );
  UDB116SVT24_INV_0P75 U1757 ( .A(SHIFT_OUT[15]), .X(n1904) );
  UDB116SVT24_OAI22_0P75 U1758 ( .A1(n1227), .A2(n1904), .B1(n1900), .B2(n1223), .X(\shift_buf_inst/n118 ) );
  UDB116SVT24_BUF_1 U1759 ( .A(n1210), .X(n1235) );
  UDB116SVT24_BUF_1 U1760 ( .A(n1235), .X(n1237) );
  UDB116SVT24_OA2BB2_0P75 U1761 ( .A1(SHIFT_OUT[23]), .A2(n1233), .B1(n1875), 
        .B2(n1237), .X(\shift_buf_inst/n139 ) );
  UDB116SVT24_INV_0P75 U1762 ( .A(SHIFT_OUT[31]), .X(n1854) );
  UDB116SVT24_INV_0P75 U1763 ( .A(SHIFT_OUT[32]), .X(n1851) );
  UDB116SVT24_OAI22_0P75 U1764 ( .A1(n1559), .A2(n1854), .B1(n1851), .B2(n1755), .X(\shift_buf_inst/n102 ) );
  UDB116SVT24_OAI22_0P75 U1765 ( .A1(n1211), .A2(n1857), .B1(n1854), .B2(n1755), .X(\shift_buf_inst/n103 ) );
  UDB116SVT24_INV_0P75 U1766 ( .A(SHIFT_OUT[19]), .X(n1891) );
  UDB116SVT24_INV_0P75 U1767 ( .A(SHIFT_OUT[20]), .X(n1887) );
  UDB116SVT24_OAI22_0P75 U1768 ( .A1(n1219), .A2(n1891), .B1(n1887), .B2(n1218), .X(\shift_buf_inst/n114 ) );
  UDB116SVT24_NR2_0P75 U1769 ( .A1(n976), .A2(n899), .X(n1242) );
  UDB116SVT24_OR3B_0P75 U1770 ( .B1(\sh_sync_inst/n213 ), .B2(n1213), .A(n975), 
        .X(n1629) );
  UDB116SVT24_OAI22_0P75 U1771 ( .A1(\sh_sync_inst/n211 ), .A2(n1242), .B1(
        \sh_sync_inst/n212 ), .B2(n1629), .X(\sh_sync_inst/n341 ) );
  UDB116SVT24_INV_0P75 U1772 ( .A(SHIFT_OUT[11]), .X(n1918) );
  UDB116SVT24_INV_0P75 U1773 ( .A(SHIFT_OUT[12]), .X(n1915) );
  UDB116SVT24_BUF_1 U1774 ( .A(n1214), .X(n1230) );
  UDB116SVT24_OAI22_0P75 U1775 ( .A1(n1231), .A2(n1918), .B1(n1915), .B2(n1230), .X(\shift_buf_inst/n122 ) );
  UDB116SVT24_OAI22_0P75 U1776 ( .A1(n1231), .A2(n1922), .B1(n1918), .B2(n1215), .X(\shift_buf_inst/n123 ) );
  UDB116SVT24_OAI22_0P75 U1777 ( .A1(n1216), .A2(n1887), .B1(n1884), .B2(n1218), .X(\shift_buf_inst/n113 ) );
  UDB116SVT24_INV_0P75 U1778 ( .A(SHIFT_OUT[13]), .X(n1911) );
  UDB116SVT24_INV_0P75 U1779 ( .A(SHIFT_OUT[14]), .X(n1909) );
  UDB116SVT24_OAI22_0P75 U1780 ( .A1(n1227), .A2(n1911), .B1(n1909), .B2(n1230), .X(\shift_buf_inst/n120 ) );
  UDB116SVT24_INV_0P75 U1781 ( .A(SHIFT_OUT[18]), .X(n1894) );
  UDB116SVT24_OAI22_0P75 U1782 ( .A1(n1219), .A2(n1894), .B1(n1891), .B2(n1217), .X(\shift_buf_inst/n115 ) );
  UDB116SVT24_OAI22_0P75 U1783 ( .A1(n1219), .A2(n1897), .B1(n1894), .B2(n1218), .X(\shift_buf_inst/n116 ) );
  UDB116SVT24_OAI22_0P75 U1784 ( .A1(n1222), .A2(n1224), .B1(n1221), .B2(n1220), .X(\shift_buf_inst/n128 ) );
  UDB116SVT24_OAI22_0P75 U1785 ( .A1(n1226), .A2(n1225), .B1(n1224), .B2(n1223), .X(\shift_buf_inst/n129 ) );
  UDB116SVT24_OAI22_0P75 U1786 ( .A1(n1227), .A2(n1909), .B1(n1904), .B2(n1230), .X(\shift_buf_inst/n119 ) );
  UDB116SVT24_INV_0P75 U1787 ( .A(n1314), .X(n1327) );
  UDB116SVT24_BUF_1 U1788 ( .A(n1314), .X(n1325) );
  UDB116SVT24_INV_0P75 U1789 ( .A(n1325), .X(n1310) );
  UDB116SVT24_AOI21_0P75 U1790 ( .A1(n1310), .A2(n924), .B(n1229), .X(n1228)
         );
  UDB116SVT24_AOAOI2111_0P75 U1791 ( .A1(n1229), .A2(n924), .B(n1028), .C(
        n1327), .D(n1228), .X(\sh_sync_inst/n303 ) );
  UDB116SVT24_OAI22_0P75 U1792 ( .A1(n1231), .A2(n1915), .B1(n1911), .B2(n1230), .X(\shift_buf_inst/n121 ) );
  UDB116SVT24_OAI22_0P75 U1793 ( .A1(n1232), .A2(n1809), .B1(n1806), .B2(n1208), .X(\shift_buf_inst/n87 ) );
  UDB116SVT24_INV_0P75 U1794 ( .A(SHIFT_OUT[61]), .X(n1764) );
  UDB116SVT24_OAI22_0P75 U1795 ( .A1(n1234), .A2(n1764), .B1(n1762), .B2(n1237), .X(\shift_buf_inst/n72 ) );
  UDB116SVT24_INV_0P75 U1796 ( .A(n1233), .X(n1240) );
  UDB116SVT24_INV_0P75 U1797 ( .A(SHIFT_OUT[49]), .X(n1801) );
  UDB116SVT24_OAI22_0P75 U1798 ( .A1(n1240), .A2(n1804), .B1(n1801), .B2(n1214), .X(\shift_buf_inst/n85 ) );
  UDB116SVT24_INV_0P75 U1799 ( .A(sh_en), .X(n1238) );
  UDB116SVT24_INV_0P75 U1800 ( .A(SHIFT_OUT[60]), .X(n1767) );
  UDB116SVT24_OAI22_0P75 U1801 ( .A1(n1238), .A2(n1767), .B1(n1764), .B2(n1237), .X(\shift_buf_inst/n73 ) );
  UDB116SVT24_INV_0P75 U1802 ( .A(n1233), .X(n1241) );
  UDB116SVT24_INV_0P75 U1803 ( .A(SHIFT_OUT[56]), .X(n1779) );
  UDB116SVT24_INV_0P75 U1804 ( .A(SHIFT_OUT[57]), .X(n1776) );
  UDB116SVT24_BUF_1 U1805 ( .A(n1235), .X(n1236) );
  UDB116SVT24_OAI22_0P75 U1806 ( .A1(n1241), .A2(n1779), .B1(n1776), .B2(n1236), .X(\shift_buf_inst/n77 ) );
  UDB116SVT24_INV_0P75 U1807 ( .A(SHIFT_OUT[58]), .X(n1774) );
  UDB116SVT24_OAI22_0P75 U1808 ( .A1(n1238), .A2(n1776), .B1(n1774), .B2(n1236), .X(\shift_buf_inst/n76 ) );
  UDB116SVT24_INV_0P75 U1809 ( .A(SHIFT_OUT[59]), .X(n1769) );
  UDB116SVT24_OAI22_0P75 U1810 ( .A1(n1234), .A2(n1769), .B1(n1767), .B2(n1236), .X(\shift_buf_inst/n74 ) );
  UDB116SVT24_INV_0P75 U1811 ( .A(SHIFT_OUT[55]), .X(n1782) );
  UDB116SVT24_BUF_1 U1812 ( .A(n1235), .X(n1239) );
  UDB116SVT24_OAI22_0P75 U1813 ( .A1(n1238), .A2(n1782), .B1(n1779), .B2(n1239), .X(\shift_buf_inst/n78 ) );
  UDB116SVT24_INV_0P75 U1814 ( .A(SHIFT_OUT[52]), .X(n1793) );
  UDB116SVT24_INV_0P75 U1815 ( .A(SHIFT_OUT[53]), .X(n1789) );
  UDB116SVT24_OAI22_0P75 U1816 ( .A1(n1240), .A2(n1793), .B1(n1789), .B2(n1239), .X(\shift_buf_inst/n81 ) );
  UDB116SVT24_INV_0P75 U1817 ( .A(SHIFT_OUT[54]), .X(n1786) );
  UDB116SVT24_OAI22_0P75 U1818 ( .A1(n1241), .A2(n1789), .B1(n1786), .B2(n1239), .X(\shift_buf_inst/n80 ) );
  UDB116SVT24_OAI22_0P75 U1819 ( .A1(n1241), .A2(n1786), .B1(n1782), .B2(n1236), .X(\shift_buf_inst/n79 ) );
  UDB116SVT24_OAI22_0P75 U1820 ( .A1(n1238), .A2(n1774), .B1(n1769), .B2(n1237), .X(\shift_buf_inst/n75 ) );
  UDB116SVT24_INV_0P75 U1821 ( .A(SHIFT_OUT[50]), .X(n1798) );
  UDB116SVT24_INV_0P75 U1822 ( .A(SHIFT_OUT[51]), .X(n1795) );
  UDB116SVT24_OAI22_0P75 U1823 ( .A1(n1240), .A2(n1798), .B1(n1795), .B2(n1239), .X(\shift_buf_inst/n83 ) );
  UDB116SVT24_OAI22_0P75 U1824 ( .A1(n1240), .A2(n1801), .B1(n1798), .B2(n1235), .X(\shift_buf_inst/n84 ) );
  UDB116SVT24_OAI22_0P75 U1825 ( .A1(n1241), .A2(n1795), .B1(n1793), .B2(n1192), .X(\shift_buf_inst/n82 ) );
  UDB116SVT24_ND2_MM_0P75 U1826 ( .A1(n978), .A2(n1243), .X(n1748) );
  UDB116SVT24_AOI31_0P75 U1827 ( .A1(n1243), .A2(n1743), .A3(n1250), .B(n1242), 
        .X(n1745) );
  UDB116SVT24_ND2_MM_0P75 U1828 ( .A1(n1245), .A2(n1745), .X(n1244) );
  UDB116SVT24_OAI31_1 U1829 ( .A1(n1245), .A2(n1748), .A3(\sh_sync_inst/n220 ), 
        .B(n1244), .X(\sh_sync_inst/n349 ) );
  UDB116SVT24_ND3_0P75 U1830 ( .A1(\sh_sync_inst/n214 ), .A2(n975), .A3(n1246), 
        .X(n1249) );
  UDB116SVT24_AOI21B_0P75 U1831 ( .A1(\sh_sync_inst/n215 ), .A2(n977), .B(
        n1247), .X(n1248) );
  UDB116SVT24_OAI22_0P75 U1832 ( .A1(n856), .A2(n1249), .B1(
        \sh_sync_inst/n214 ), .B2(n1248), .X(\sh_sync_inst/n344 ) );
  UDB116SVT24_INV_0P75 U1833 ( .A(\sh_sync_inst/n216 ), .X(n1253) );
  UDB116SVT24_NR2_0P75 U1834 ( .A1(n1634), .A2(n1254), .X(n1636) );
  UDB116SVT24_OAI21_0P75 U1835 ( .A1(n1635), .A2(n1254), .B(n1250), .X(n1633)
         );
  UDB116SVT24_OAI21_0P75 U1836 ( .A1(n1636), .A2(n1633), .B(n1253), .X(n1251)
         );
  UDB116SVT24_OAI31_1 U1837 ( .A1(n1254), .A2(n1253), .A3(n1252), .B(n1251), 
        .X(\sh_sync_inst/n346 ) );
  UDB116SVT24_ND2_MM_0P75 U1838 ( .A1(n1268), .A2(n1436), .X(n1270) );
  UDB116SVT24_OAI22_0P75 U1839 ( .A1(n1256), .A2(n1255), .B1(n1269), .B2(n1270), .X(n1257) );
  UDB116SVT24_AOI21_0P75 U1840 ( .A1(n919), .A2(n1584), .B(n1257), .X(n1571)
         );
  UDB116SVT24_OAI21B_1 U1841 ( .A1(n1259), .A2(n1271), .B(n1258), .X(n1722) );
  UDB116SVT24_OR2_0P75 U1842 ( .A1(n1713), .A2(n951), .X(n1266) );
  UDB116SVT24_NR2_0P75 U1843 ( .A1(n966), .A2(n1266), .X(n1715) );
  UDB116SVT24_ND2_MM_0P75 U1844 ( .A1(n1715), .A2(n1718), .X(n1725) );
  UDB116SVT24_NR3_0P75 U1845 ( .A1(n1012), .A2(n955), .A3(n1725), .X(n1272) );
  UDB116SVT24_ND2_MM_0P75 U1846 ( .A1(n1272), .A2(n940), .X(n1283) );
  UDB116SVT24_NR2_0P75 U1847 ( .A1(n934), .A2(n1283), .X(n1590) );
  UDB116SVT24_ND2_MM_0P75 U1848 ( .A1(n1590), .A2(n922), .X(n1287) );
  UDB116SVT24_NR2_0P75 U1849 ( .A1(n958), .A2(n1287), .X(n1298) );
  UDB116SVT24_INV_0P75 U1850 ( .A(n1298), .X(n1260) );
  UDB116SVT24_AOI21_0P75 U1851 ( .A1(n962), .A2(n1260), .B(n880), .X(n1300) );
  UDB116SVT24_ND2_MM_0P75 U1852 ( .A1(n912), .A2(n963), .X(n1299) );
  UDB116SVT24_OAI22_0P75 U1853 ( .A1(n912), .A2(n1300), .B1(n1299), .B2(n1260), 
        .X(\sh_sync_inst/n258 ) );
  UDB116SVT24_INV_0P75 U1854 ( .A(\sh_sync_inst/intadd_0/A[4] ), .X(n1516) );
  UDB116SVT24_NR2_0P75 U1855 ( .A1(\sh_sync_inst/intadd_0/A[3] ), .A2(n965), 
        .X(n1730) );
  UDB116SVT24_MAJI3_1 U1856 ( .A1(n951), .A2(\sh_sync_inst/intadd_0/A[2] ), 
        .A3(n1261), .X(n1732) );
  UDB116SVT24_INV_0P75 U1857 ( .A(\sh_sync_inst/intadd_0/A[3] ), .X(n1523) );
  UDB116SVT24_OAI22_0P75 U1858 ( .A1(n1730), .A2(n1732), .B1(n1523), .B2(n1262), .X(n1289) );
  UDB116SVT24_AOI21_0P75 U1859 ( .A1(n1310), .A2(n1264), .B(n1516), .X(n1263)
         );
  UDB116SVT24_AOAOI2111_0P75 U1860 ( .A1(n1516), .A2(n1264), .B(n863), .C(
        n1291), .D(n1263), .X(\sh_sync_inst/n297 ) );
  UDB116SVT24_AO21B_0P75 U1861 ( .A1(n883), .A2(n1725), .B(n1722), .X(n1723)
         );
  UDB116SVT24_AOI21_0P75 U1862 ( .A1(n953), .A2(n1723), .B(n931), .X(n1265) );
  UDB116SVT24_OAI31_1 U1863 ( .A1(n925), .A2(n960), .A3(n1725), .B(n1265), .X(
        \sh_sync_inst/n264 ) );
  UDB116SVT24_AOI21_0P75 U1864 ( .A1(n883), .A2(n1266), .B(n881), .X(n1717) );
  UDB116SVT24_ND2_MM_0P75 U1865 ( .A1(n965), .A2(n963), .X(n1719) );
  UDB116SVT24_OAI22_0P75 U1866 ( .A1(n966), .A2(n1717), .B1(n1719), .B2(n1266), 
        .X(\sh_sync_inst/n266 ) );
  UDB116SVT24_OAOI211_0P75 U1867 ( .A1(n1271), .A2(n1269), .B(n1268), .C(n1267), .X(n1293) );
  UDB116SVT24_NR3_0P75 U1868 ( .A1(n1271), .A2(n1293), .A3(n1270), .X(n1569)
         );
  UDB116SVT24_INV_0P75 U1869 ( .A(n1569), .X(n1296) );
  UDB116SVT24_OA2BB2_0P75 U1870 ( .A1(n910), .A2(n1296), .B1(n849), .B2(n910), 
        .X(\sh_sync_inst/n330 ) );
  UDB116SVT24_NR2_0P75 U1871 ( .A1(n941), .A2(n959), .X(n1280) );
  UDB116SVT24_OAI21_0P75 U1872 ( .A1(n1571), .A2(n1272), .B(n1722), .X(n1281)
         );
  UDB116SVT24_AOI22_1 U1873 ( .A1(n1280), .A2(n1272), .B1(n1281), .B2(n940), 
        .X(n1274) );
  UDB116SVT24_ND2_MM_0P75 U1874 ( .A1(n1274), .A2(n1273), .X(
        \sh_sync_inst/n262 ) );
  UDB116SVT24_AOI21_0P75 U1875 ( .A1(n1569), .A2(n910), .B(n1293), .X(n1276)
         );
  UDB116SVT24_ND2_MM_0P75 U1876 ( .A1(\sh_sync_inst/n234 ), .A2(n1002), .X(
        n1277) );
  UDB116SVT24_NR2_0P75 U1877 ( .A1(\sh_sync_inst/n234 ), .A2(
        \sh_sync_inst/n235 ), .X(n1278) );
  UDB116SVT24_ND3_0P75 U1878 ( .A1(\sh_sync_inst/n233 ), .A2(n1002), .A3(n1278), .X(n1275) );
  UDB116SVT24_AOAI211_0P75 U1879 ( .A1(n1276), .A2(n1277), .B(
        \sh_sync_inst/n233 ), .C(n1275), .X(\sh_sync_inst/n328 ) );
  UDB116SVT24_OAI22_0P75 U1880 ( .A1(\sh_sync_inst/n235 ), .A2(n1277), .B1(
        \sh_sync_inst/n234 ), .B2(n1276), .X(\sh_sync_inst/n329 ) );
  UDB116SVT24_NR2B_0P75 U1881 ( .A(n1278), .B(\sh_sync_inst/n233 ), .X(n1570)
         );
  UDB116SVT24_ND2_MM_0P75 U1882 ( .A1(n1570), .A2(n1568), .X(n1295) );
  UDB116SVT24_OR3B_0P75 U1883 ( .B1(\sh_sync_inst/n231 ), .B2(n1295), .A(n1569), .X(n1284) );
  UDB116SVT24_OAOI211_0P75 U1884 ( .A1(\sh_sync_inst/n231 ), .A2(n1295), .B(
        n1569), .C(n849), .X(n1285) );
  UDB116SVT24_AOI22_1 U1885 ( .A1(\sh_sync_inst/n230 ), .A2(n1284), .B1(n1285), 
        .B2(n1279), .X(\sh_sync_inst/n325 ) );
  UDB116SVT24_OAI21_0P75 U1886 ( .A1(n1281), .A2(n1280), .B(n933), .X(n1282)
         );
  UDB116SVT24_OAI31_1 U1887 ( .A1(n959), .A2(n876), .A3(n1283), .B(n1282), .X(
        \sh_sync_inst/n261 ) );
  UDB116SVT24_OAI22_0P75 U1888 ( .A1(\sh_sync_inst/n229 ), .A2(n1285), .B1(
        \sh_sync_inst/n230 ), .B2(n1284), .X(\sh_sync_inst/n324 ) );
  UDB116SVT24_NR2_0P75 U1889 ( .A1(n921), .A2(n960), .X(n1591) );
  UDB116SVT24_OAI21_0P75 U1890 ( .A1(n1571), .A2(n1590), .B(n1722), .X(n1589)
         );
  UDB116SVT24_OAOI211_0P75 U1891 ( .A1(n1591), .A2(n1589), .B(n1288), .C(n931), 
        .X(n1286) );
  UDB116SVT24_OAI31_1 U1892 ( .A1(n1288), .A2(n960), .A3(n1287), .B(n1286), 
        .X(\sh_sync_inst/n259 ) );
  UDB116SVT24_INV_0P75 U1893 ( .A(\sh_sync_inst/intadd_0/A[6] ), .X(n1489) );
  UDB116SVT24_NR2_0P75 U1894 ( .A1(n860), .A2(n955), .X(n1706) );
  UDB116SVT24_MAJI3_1 U1895 ( .A1(n1006), .A2(\sh_sync_inst/intadd_0/A[4] ), 
        .A3(n1289), .X(n1708) );
  UDB116SVT24_INV_0P75 U1896 ( .A(\sh_sync_inst/intadd_0/A[5] ), .X(n1504) );
  UDB116SVT24_OAI22_0P75 U1897 ( .A1(n1706), .A2(n1708), .B1(n1504), .B2(n925), 
        .X(n1301) );
  UDB116SVT24_AOI21_0P75 U1898 ( .A1(n1310), .A2(n1292), .B(n1489), .X(n1290)
         );
  UDB116SVT24_AOAOI2111_0P75 U1899 ( .A1(n1489), .A2(n1292), .B(n1029), .C(
        n1291), .D(n1290), .X(\sh_sync_inst/n295 ) );
  UDB116SVT24_INV_0P75 U1900 ( .A(\sh_sync_inst/n231 ), .X(n1297) );
  UDB116SVT24_OAI21B_1 U1901 ( .A1(n1570), .A2(n1296), .B(n1293), .X(n1567) );
  UDB116SVT24_AOAI211_0P75 U1902 ( .A1(n1002), .A2(\sh_sync_inst/n232 ), .B(
        n1567), .C(n1297), .X(n1294) );
  UDB116SVT24_OAI31_1 U1903 ( .A1(n1297), .A2(n1296), .A3(n1295), .B(n1294), 
        .X(\sh_sync_inst/n326 ) );
  UDB116SVT24_ND3_0P75 U1904 ( .A1(n962), .A2(n1298), .A3(n911), .X(n1587) );
  UDB116SVT24_ND2_MM_0P75 U1905 ( .A1(n1300), .A2(n1299), .X(n1585) );
  UDB116SVT24_OA2BB2_0P75 U1906 ( .A1(n1018), .A2(n1587), .B1(n1585), .B2(
        \sh_sync_inst/intadd_0/B[12] ), .X(\sh_sync_inst/n257 ) );
  UDB116SVT24_NR2_0P75 U1907 ( .A1(\sh_sync_inst/intadd_0/A[7] ), .A2(
        \sh_sync_inst/intadd_0/B[7] ), .X(n1700) );
  UDB116SVT24_MAJI3_1 U1908 ( .A1(\sh_sync_inst/intadd_0/B[6] ), .A2(
        \sh_sync_inst/intadd_0/A[6] ), .A3(n1301), .X(n1702) );
  UDB116SVT24_INV_0P75 U1909 ( .A(\sh_sync_inst/intadd_0/A[7] ), .X(n1486) );
  UDB116SVT24_OAI22_0P75 U1910 ( .A1(n1700), .A2(n1702), .B1(n1486), .B2(n940), 
        .X(n1305) );
  UDB116SVT24_INV_0P75 U1911 ( .A(n1694), .X(n1705) );
  UDB116SVT24_AOI21_0P75 U1912 ( .A1(n1693), .A2(n1304), .B(n885), .X(n1303)
         );
  UDB116SVT24_AOAOI2111_0P75 U1913 ( .A1(n884), .A2(n1304), .B(n1027), .C(
        n1705), .D(n1303), .X(\sh_sync_inst/n293 ) );
  UDB116SVT24_INV_0P75 U1914 ( .A(\sh_sync_inst/intadd_0/A[10] ), .X(n1467) );
  UDB116SVT24_NR2_0P75 U1915 ( .A1(\sh_sync_inst/intadd_0/A[9] ), .A2(
        \sh_sync_inst/intadd_0/B[9] ), .X(n1695) );
  UDB116SVT24_MAJI3_1 U1916 ( .A1(n934), .A2(\sh_sync_inst/intadd_0/A[8] ), 
        .A3(n1305), .X(n1697) );
  UDB116SVT24_INV_0P75 U1917 ( .A(\sh_sync_inst/intadd_0/A[9] ), .X(n1474) );
  UDB116SVT24_OAI22_0P75 U1918 ( .A1(n1695), .A2(n1697), .B1(n1474), .B2(n921), 
        .X(n1309) );
  UDB116SVT24_AOI21_0P75 U1919 ( .A1(n1306), .A2(n1308), .B(n1467), .X(n1307)
         );
  UDB116SVT24_AOAOI2111_0P75 U1920 ( .A1(n1467), .A2(n1308), .B(n1028), .C(
        n1705), .D(n1307), .X(\sh_sync_inst/n291 ) );
  UDB116SVT24_INV_0P75 U1921 ( .A(\sh_sync_inst/intadd_0/A[12] ), .X(n1453) );
  UDB116SVT24_NR2_0P75 U1922 ( .A1(\sh_sync_inst/intadd_0/A[11] ), .A2(n912), 
        .X(n1688) );
  UDB116SVT24_MAJI3_1 U1923 ( .A1(n957), .A2(\sh_sync_inst/intadd_0/A[10] ), 
        .A3(n1309), .X(n1690) );
  UDB116SVT24_INV_0P75 U1924 ( .A(\sh_sync_inst/intadd_0/A[11] ), .X(n1457) );
  UDB116SVT24_OAI22_0P75 U1925 ( .A1(n1688), .A2(n1690), .B1(n1457), .B2(n923), 
        .X(n1313) );
  UDB116SVT24_AOI21_0P75 U1926 ( .A1(n1310), .A2(n1312), .B(n1453), .X(n1311)
         );
  UDB116SVT24_AOAOI2111_0P75 U1927 ( .A1(n1453), .A2(n1312), .B(n1030), .C(
        n1705), .D(n1311), .X(\sh_sync_inst/n289 ) );
  UDB116SVT24_INV_0P75 U1928 ( .A(n948), .X(n1736) );
  UDB116SVT24_MAJ3_0P75 U1929 ( .A1(\sh_sync_inst/intadd_0/B[12] ), .A2(
        \sh_sync_inst/intadd_0/A[12] ), .A3(n1313), .X(n1686) );
  UDB116SVT24_INV_0P75 U1930 ( .A(\sh_sync_inst/intadd_0/A[13] ), .X(n1682) );
  UDB116SVT24_ND2_MM_0P75 U1931 ( .A1(n1682), .A2(n874), .X(n1681) );
  UDB116SVT24_AOI22_1 U1932 ( .A1(n997), .A2(\sh_sync_inst/intadd_0/B[13] ), 
        .B1(n1686), .B2(n1681), .X(n1679) );
  UDB116SVT24_ND2_MM_0P75 U1933 ( .A1(n1679), .A2(n888), .X(n1316) );
  UDB116SVT24_NR2_0P75 U1934 ( .A1(n889), .A2(n980), .X(n1680) );
  UDB116SVT24_INV_0P75 U1935 ( .A(n1314), .X(n1612) );
  UDB116SVT24_OAI21_0P75 U1936 ( .A1(n1679), .A2(n863), .B(n1612), .X(n1678)
         );
  UDB116SVT24_OAI21_0P75 U1937 ( .A1(n1680), .A2(n1678), .B(n887), .X(n1315)
         );
  UDB116SVT24_OAI31_1 U1938 ( .A1(n980), .A2(n886), .A3(n1316), .B(n1315), .X(
        \sh_sync_inst/n286 ) );
  UDB116SVT24_INV_0P75 U1939 ( .A(\sh_sync_inst/n158 ), .X(n1405) );
  UDB116SVT24_NR2_0P75 U1940 ( .A1(\sh_sync_inst/n160 ), .A2(n1316), .X(n1676)
         );
  UDB116SVT24_ND2_MM_0P75 U1941 ( .A1(n1676), .A2(n890), .X(n1318) );
  UDB116SVT24_OAI21_0P75 U1942 ( .A1(n1676), .A2(n1028), .B(n1327), .X(n1675)
         );
  UDB116SVT24_NR2_0P75 U1943 ( .A1(n891), .A2(n982), .X(n1677) );
  UDB116SVT24_OAI21_0P75 U1944 ( .A1(n1675), .A2(n1677), .B(n1405), .X(n1317)
         );
  UDB116SVT24_OAI31_1 U1945 ( .A1(n981), .A2(n1405), .A3(n1318), .B(n1317), 
        .X(\sh_sync_inst/n284 ) );
  UDB116SVT24_INV_0P75 U1946 ( .A(\sh_sync_inst/n156 ), .X(n1393) );
  UDB116SVT24_NR2_0P75 U1947 ( .A1(\sh_sync_inst/n158 ), .A2(n1318), .X(n1673)
         );
  UDB116SVT24_ND2_MM_0P75 U1948 ( .A1(n1673), .A2(n927), .X(n1320) );
  UDB116SVT24_OAI21_0P75 U1949 ( .A1(n1673), .A2(n1029), .B(n1327), .X(n1672)
         );
  UDB116SVT24_NR2_0P75 U1950 ( .A1(n926), .A2(n861), .X(n1674) );
  UDB116SVT24_OAI21_0P75 U1951 ( .A1(n1672), .A2(n1674), .B(n1393), .X(n1319)
         );
  UDB116SVT24_OAI31_1 U1952 ( .A1(n982), .A2(n1393), .A3(n1320), .B(n1319), 
        .X(\sh_sync_inst/n282 ) );
  UDB116SVT24_NR2_0P75 U1953 ( .A1(\sh_sync_inst/n156 ), .A2(n1320), .X(n1322)
         );
  UDB116SVT24_INV_0P75 U1954 ( .A(n1322), .X(n1321) );
  UDB116SVT24_AOI21_0P75 U1955 ( .A1(n919), .A2(n1321), .B(n1325), .X(n1608)
         );
  UDB116SVT24_ND2_MM_0P75 U1956 ( .A1(\sh_sync_inst/n155 ), .A2(n949), .X(
        n1606) );
  UDB116SVT24_OAI22_0P75 U1957 ( .A1(\sh_sync_inst/n155 ), .A2(n1608), .B1(
        n1606), .B2(n1321), .X(\sh_sync_inst/n281 ) );
  UDB116SVT24_INV_0P75 U1958 ( .A(\sh_sync_inst/n150 ), .X(n1340) );
  UDB116SVT24_INV_0P75 U1959 ( .A(\sh_sync_inst/n155 ), .X(n1381) );
  UDB116SVT24_ND2_MM_0P75 U1960 ( .A1(n1322), .A2(n1381), .X(n1574) );
  UDB116SVT24_NR2_0P75 U1961 ( .A1(\sh_sync_inst/n154 ), .A2(n1574), .X(n1575)
         );
  UDB116SVT24_ND2_MM_0P75 U1962 ( .A1(n1575), .A2(n893), .X(n1603) );
  UDB116SVT24_NR2_0P75 U1963 ( .A1(\sh_sync_inst/n152 ), .A2(n1603), .X(n1670)
         );
  UDB116SVT24_INV_0P75 U1964 ( .A(\sh_sync_inst/n151 ), .X(n1668) );
  UDB116SVT24_ND2_MM_0P75 U1965 ( .A1(n1670), .A2(n1668), .X(n1324) );
  UDB116SVT24_OAI21_0P75 U1966 ( .A1(n1670), .A2(n1027), .B(n1612), .X(n1669)
         );
  UDB116SVT24_NR2_0P75 U1967 ( .A1(n1668), .A2(n980), .X(n1671) );
  UDB116SVT24_OAI21_0P75 U1968 ( .A1(n1669), .A2(n1671), .B(n1340), .X(n1323)
         );
  UDB116SVT24_OAI31_1 U1969 ( .A1(n1610), .A2(n1340), .A3(n1324), .B(n1323), 
        .X(\sh_sync_inst/n276 ) );
  UDB116SVT24_OR2_0P75 U1970 ( .A1(\sh_sync_inst/n150 ), .A2(n1324), .X(n1326)
         );
  UDB116SVT24_AOI21_0P75 U1971 ( .A1(n920), .A2(n1326), .B(n1325), .X(n1600)
         );
  UDB116SVT24_ND2_MM_0P75 U1972 ( .A1(n995), .A2(n948), .X(n1599) );
  UDB116SVT24_OAI22_0P75 U1973 ( .A1(n995), .A2(n1600), .B1(n1599), .B2(n1326), 
        .X(\sh_sync_inst/n275 ) );
  UDB116SVT24_NR2_0P75 U1974 ( .A1(n1326), .A2(\sh_sync_inst/n149 ), .X(n1328)
         );
  UDB116SVT24_AN2_1 U1975 ( .A1(n1328), .A2(n895), .X(n1578) );
  UDB116SVT24_OAI21_0P75 U1976 ( .A1(n1578), .A2(n1736), .B(n1327), .X(n1576)
         );
  UDB116SVT24_AOI21_0P75 U1977 ( .A1(n1010), .A2(n949), .B(n1576), .X(n1330)
         );
  UDB116SVT24_ND2_MM_0P75 U1978 ( .A1(n948), .A2(n1328), .X(n1598) );
  UDB116SVT24_NR2_0P75 U1979 ( .A1(n1009), .A2(\sh_sync_inst/n148 ), .X(n1329)
         );
  UDB116SVT24_ND2_MM_0P75 U1980 ( .A1(n916), .A2(n1329), .X(n1333) );
  UDB116SVT24_OAI22_0P75 U1981 ( .A1(n916), .A2(n1330), .B1(n1598), .B2(n1333), 
        .X(\sh_sync_inst/n272 ) );
  UDB116SVT24_ND2_MM_0P75 U1982 ( .A1(\sh_sync_inst/n149 ), .A2(
        \sh_sync_inst/n146 ), .X(n1335) );
  UDB116SVT24_ND2_MM_0P75 U1983 ( .A1(n1335), .A2(n894), .X(n1339) );
  UDB116SVT24_AOI21_0P75 U1984 ( .A1(n1010), .A2(n1339), .B(
        \sh_sync_inst/n150 ), .X(n1332) );
  UDB116SVT24_OAI21_0P75 U1985 ( .A1(\sh_sync_inst/n147 ), .A2(n1339), .B(
        n1332), .X(n1351) );
  UDB116SVT24_INV_0P75 U1986 ( .A(n1351), .X(n1336) );
  UDB116SVT24_INV_0P75 U1987 ( .A(n1333), .X(n1334) );
  UDB116SVT24_INV_0P75 U1988 ( .A(n1010), .X(n1577) );
  UDB116SVT24_AOI21_0P75 U1989 ( .A1(n1577), .A2(n895), .B(n916), .X(n1347) );
  UDB116SVT24_INV_0P75 U1990 ( .A(\sh_sync_inst/n149 ), .X(n1346) );
  UDB116SVT24_OAI21_0P75 U1991 ( .A1(n1334), .A2(n1347), .B(n1346), .X(n1345)
         );
  UDB116SVT24_AOI21B_0P75 U1992 ( .A1(n1336), .A2(n1335), .B(n1345), .X(n1338)
         );
  UDB116SVT24_OAI21_0P75 U1993 ( .A1(\sh_sync_inst/n146 ), .A2(
        \sh_sync_inst/n147 ), .B(n894), .X(n1337) );
  UDB116SVT24_EN2_V2_0P75 U1994 ( .A1(n1338), .A2(n1337), .X(n1348) );
  UDB116SVT24_INV_0P75 U1995 ( .A(n1339), .X(n1343) );
  UDB116SVT24_NR2_0P75 U1996 ( .A1(\sh_sync_inst/n149 ), .A2(n916), .X(n1341)
         );
  UDB116SVT24_AOI31_0P75 U1997 ( .A1(n1009), .A2(n1343), .A3(n1341), .B(n1340), 
        .X(n1342) );
  UDB116SVT24_OAI21_0P75 U1998 ( .A1(n1010), .A2(n1343), .B(n1342), .X(n1344)
         );
  UDB116SVT24_AN2_1 U1999 ( .A1(n1351), .A2(n1344), .X(n1356) );
  UDB116SVT24_OA21_V2_1 U2000 ( .A1(n1347), .A2(n1346), .B(n1345), .X(n1352)
         );
  UDB116SVT24_ND2_MM_0P75 U2001 ( .A1(n1356), .A2(n1352), .X(n1354) );
  UDB116SVT24_AOI21_0P75 U2002 ( .A1(n1354), .A2(n1348), .B(
        \sh_sync_inst/n151 ), .X(n1355) );
  UDB116SVT24_AOI21_0P75 U2003 ( .A1(n1348), .A2(\sh_sync_inst/n151 ), .B(
        n1355), .X(n1360) );
  UDB116SVT24_ND2_MM_0P75 U2004 ( .A1(n1356), .A2(n1355), .X(n1349) );
  UDB116SVT24_AOI21B_0P75 U2005 ( .A1(n1352), .A2(n1351), .B(n1349), .X(n1350)
         );
  UDB116SVT24_OAI21_0P75 U2006 ( .A1(n1352), .A2(n1351), .B(n1350), .X(n1353)
         );
  UDB116SVT24_OAI21_0P75 U2007 ( .A1(\sh_sync_inst/n151 ), .A2(n1354), .B(
        n1353), .X(n1361) );
  UDB116SVT24_ND2_MM_0P75 U2008 ( .A1(n1356), .A2(n1360), .X(n1357) );
  UDB116SVT24_AOI21_0P75 U2009 ( .A1(n1361), .A2(n1357), .B(n908), .X(n1364)
         );
  UDB116SVT24_ND2_MM_0P75 U2010 ( .A1(n1360), .A2(n1364), .X(n1359) );
  UDB116SVT24_EN2_V2_0P75 U2011 ( .A1(n1356), .A2(n1355), .X(n1358) );
  UDB116SVT24_OA2BB2_0P75 U2012 ( .A1(n1359), .A2(n1358), .B1(n1357), .B2(n908), .X(n1362) );
  UDB116SVT24_INV_0P75 U2013 ( .A(n1360), .X(n1365) );
  UDB116SVT24_AOI21_0P75 U2014 ( .A1(n1361), .A2(\sh_sync_inst/n152 ), .B(
        n1364), .X(n1368) );
  UDB116SVT24_INV_0P75 U2015 ( .A(n1368), .X(n1373) );
  UDB116SVT24_NR2_0P75 U2016 ( .A1(n1365), .A2(n1373), .X(n1367) );
  UDB116SVT24_OAI21_0P75 U2017 ( .A1(n1367), .A2(n1362), .B(n892), .X(n1370)
         );
  UDB116SVT24_OAI21_0P75 U2018 ( .A1(n1362), .A2(n893), .B(n1370), .X(n1378)
         );
  UDB116SVT24_OAI22_0P75 U2019 ( .A1(n1373), .A2(n1370), .B1(n1365), .B2(n1364), .X(n1363) );
  UDB116SVT24_AOI21_0P75 U2020 ( .A1(n1365), .A2(n1364), .B(n1363), .X(n1366)
         );
  UDB116SVT24_AOI21_0P75 U2021 ( .A1(n1367), .A2(n892), .B(n1366), .X(n1369)
         );
  UDB116SVT24_INV_0P75 U2022 ( .A(\sh_sync_inst/n154 ), .X(n1607) );
  UDB116SVT24_INV_0P75 U2023 ( .A(n1378), .X(n1388) );
  UDB116SVT24_AOAI211_0P75 U2024 ( .A1(n1388), .A2(n1368), .B(n1369), .C(n1607), .X(n1382) );
  UDB116SVT24_OAI21_0P75 U2025 ( .A1(n1369), .A2(n1607), .B(n1382), .X(n1389)
         );
  UDB116SVT24_INV_0P75 U2026 ( .A(n1389), .X(n1377) );
  UDB116SVT24_INV_0P75 U2027 ( .A(n1370), .X(n1375) );
  UDB116SVT24_NR2_0P75 U2028 ( .A1(\sh_sync_inst/n154 ), .A2(n1378), .X(n1374)
         );
  UDB116SVT24_NR2_0P75 U2029 ( .A1(n992), .A2(n1382), .X(n1371) );
  UDB116SVT24_OAI21_0P75 U2030 ( .A1(n1375), .A2(n1371), .B(n1373), .X(n1372)
         );
  UDB116SVT24_OAI31_1 U2031 ( .A1(n1375), .A2(n1374), .A3(n1373), .B(n1372), 
        .X(n1380) );
  UDB116SVT24_AN2_1 U2032 ( .A1(n1380), .A2(n1381), .X(n1379) );
  UDB116SVT24_ND2_MM_0P75 U2033 ( .A1(n1377), .A2(n1379), .X(n1376) );
  UDB116SVT24_OAOAI2111_1 U2034 ( .A1(n1378), .A2(\sh_sync_inst/n155 ), .B(
        n1377), .C(n1379), .D(n1376), .X(n1391) );
  UDB116SVT24_NR3_0P75 U2035 ( .A1(n859), .A2(n1378), .A3(n1389), .X(n1384) );
  UDB116SVT24_NR2_0P75 U2036 ( .A1(n1384), .A2(n1379), .X(n1383) );
  UDB116SVT24_OAI21_0P75 U2037 ( .A1(n1381), .A2(n1380), .B(n1383), .X(n1396)
         );
  UDB116SVT24_INV_0P75 U2038 ( .A(n1382), .X(n1387) );
  UDB116SVT24_NR2_0P75 U2039 ( .A1(n1387), .A2(n1388), .X(n1386) );
  UDB116SVT24_OR2_0P75 U2040 ( .A1(n1389), .A2(n1383), .X(n1385) );
  UDB116SVT24_AOAOI2111_0P75 U2041 ( .A1(n1388), .A2(n1387), .B(n1386), .C(
        n1385), .D(n1384), .X(n1394) );
  UDB116SVT24_AN2_1 U2042 ( .A1(n1394), .A2(n1393), .X(n1398) );
  UDB116SVT24_NR3_0P75 U2043 ( .A1(\sh_sync_inst/n156 ), .A2(n1396), .A3(n1389), .X(n1390) );
  UDB116SVT24_NR2_0P75 U2044 ( .A1(n1398), .A2(n1390), .X(n1392) );
  UDB116SVT24_OR2_0P75 U2045 ( .A1(n1396), .A2(n1392), .X(n1397) );
  UDB116SVT24_AOI21_0P75 U2046 ( .A1(n1391), .A2(n1397), .B(n1390), .X(n1395)
         );
  UDB116SVT24_OAI21_0P75 U2047 ( .A1(n1394), .A2(n1393), .B(n1392), .X(n1410)
         );
  UDB116SVT24_NR2_0P75 U2048 ( .A1(n1396), .A2(n1410), .X(n1403) );
  UDB116SVT24_OAI21_0P75 U2049 ( .A1(n1403), .A2(n1395), .B(n926), .X(n1400)
         );
  UDB116SVT24_OAI21_0P75 U2050 ( .A1(n1395), .A2(n927), .B(n1400), .X(n1425)
         );
  UDB116SVT24_INV_0P75 U2051 ( .A(n1425), .X(n1417) );
  UDB116SVT24_INV_0P75 U2052 ( .A(n1410), .X(n1404) );
  UDB116SVT24_INV_0P75 U2053 ( .A(n1396), .X(n1399) );
  UDB116SVT24_OAI21_0P75 U2054 ( .A1(n1399), .A2(n1398), .B(n1397), .X(n1402)
         );
  UDB116SVT24_INV_0P75 U2055 ( .A(n1400), .X(n1412) );
  UDB116SVT24_ND2_MM_0P75 U2056 ( .A1(n1404), .A2(n1412), .X(n1401) );
  UDB116SVT24_AOI22_1 U2057 ( .A1(n1403), .A2(n926), .B1(n1402), .B2(n1401), 
        .X(n1406) );
  UDB116SVT24_AOAI211_0P75 U2058 ( .A1(n1417), .A2(n1404), .B(n1406), .C(n1405), .X(n1407) );
  UDB116SVT24_INV_0P75 U2059 ( .A(n1407), .X(n1416) );
  UDB116SVT24_NR2_0P75 U2060 ( .A1(n1416), .A2(n1417), .X(n1415) );
  UDB116SVT24_OAI21_0P75 U2061 ( .A1(n1406), .A2(n1405), .B(n1407), .X(n1421)
         );
  UDB116SVT24_NR3_0P75 U2062 ( .A1(\sh_sync_inst/n159 ), .A2(n1425), .A3(n1421), .X(n1413) );
  UDB116SVT24_NR2_0P75 U2063 ( .A1(\sh_sync_inst/n158 ), .A2(n1425), .X(n1411)
         );
  UDB116SVT24_NR2_0P75 U2064 ( .A1(n991), .A2(n1407), .X(n1408) );
  UDB116SVT24_OAI21_0P75 U2065 ( .A1(n1412), .A2(n1408), .B(n1410), .X(n1409)
         );
  UDB116SVT24_OAI31_1 U2066 ( .A1(n1412), .A2(n1411), .A3(n1410), .B(n1409), 
        .X(n1419) );
  UDB116SVT24_AN2_1 U2067 ( .A1(n1419), .A2(n890), .X(n1423) );
  UDB116SVT24_NR2_0P75 U2068 ( .A1(n1413), .A2(n1423), .X(n1418) );
  UDB116SVT24_OR2_0P75 U2069 ( .A1(n1421), .A2(n1418), .X(n1414) );
  UDB116SVT24_AOAOI2111_0P75 U2070 ( .A1(n1417), .A2(n1416), .B(n1415), .C(
        n1414), .D(n1413), .X(n1420) );
  UDB116SVT24_OAI21_0P75 U2071 ( .A1(n891), .A2(n1419), .B(n1418), .X(n1430)
         );
  UDB116SVT24_NR2_0P75 U2072 ( .A1(n1421), .A2(n1430), .X(n1428) );
  UDB116SVT24_OAI21_0P75 U2073 ( .A1(n1420), .A2(n1428), .B(n886), .X(n1429)
         );
  UDB116SVT24_OAI21_0P75 U2074 ( .A1(n1420), .A2(n887), .B(n1429), .X(n1446)
         );
  UDB116SVT24_NR2_0P75 U2075 ( .A1(n1430), .A2(n1446), .X(n1434) );
  UDB116SVT24_OR2_0P75 U2076 ( .A1(n1430), .A2(n1429), .X(n1427) );
  UDB116SVT24_INV_0P75 U2077 ( .A(n1421), .X(n1424) );
  UDB116SVT24_ND2_MM_0P75 U2078 ( .A1(n1424), .A2(n1423), .X(n1422) );
  UDB116SVT24_OAOAI2111_1 U2079 ( .A1(n1425), .A2(\sh_sync_inst/n159 ), .B(
        n1424), .C(n1423), .D(n1422), .X(n1426) );
  UDB116SVT24_AOI22_1 U2080 ( .A1(n1428), .A2(n886), .B1(n1427), .B2(n1426), 
        .X(n1435) );
  UDB116SVT24_OAI21_0P75 U2081 ( .A1(n1434), .A2(n1435), .B(n888), .X(n1440)
         );
  UDB116SVT24_NR2_0P75 U2082 ( .A1(n1446), .A2(n1440), .X(n1432) );
  UDB116SVT24_EO2_V2_1 U2083 ( .A1(n1430), .A2(n1429), .X(n1431) );
  UDB116SVT24_AO2BB2_0P75 U2084 ( .A1(n1432), .A2(n1431), .B1(n889), .B2(n1434), .X(n1438) );
  UDB116SVT24_ND2_MM_0P75 U2085 ( .A1(n1435), .A2(\sh_sync_inst/n161 ), .X(
        n1433) );
  UDB116SVT24_OAI31_1 U2086 ( .A1(n1435), .A2(\sh_sync_inst/n161 ), .A3(n1434), 
        .B(n1433), .X(n1442) );
  UDB116SVT24_OR3B_0P75 U2087 ( .B1(n1446), .B2(\sh_sync_inst/intadd_0/A[13] ), 
        .A(n1442), .X(n1443) );
  UDB116SVT24_ND2_MM_0P75 U2088 ( .A1(n1436), .A2(n1023), .X(n1535) );
  UDB116SVT24_AOI21_0P75 U2089 ( .A1(n1438), .A2(n1443), .B(n902), .X(n1437)
         );
  UDB116SVT24_OAI21B_1 U2090 ( .A1(\sh_sync_inst/n192 ), .A2(n862), .B(n1437), 
        .X(\sh_sync_inst/n322 ) );
  UDB116SVT24_NR2_0P75 U2091 ( .A1(\sh_sync_inst/intadd_0/A[13] ), .A2(n1438), 
        .X(n1439) );
  UDB116SVT24_ND2B_0P75 U2092 ( .A(n1439), .B(n1443), .X(n1441) );
  UDB116SVT24_AOI21_0P75 U2093 ( .A1(\sh_sync_inst/intadd_0/A[13] ), .A2(n1438), .B(n1441), .X(n1455) );
  UDB116SVT24_NR2_0P75 U2094 ( .A1(n1442), .A2(n1439), .X(n1447) );
  UDB116SVT24_ND2_MM_0P75 U2095 ( .A1(n1455), .A2(n1453), .X(n1450) );
  UDB116SVT24_NR2_0P75 U2096 ( .A1(n1447), .A2(n1450), .X(n1665) );
  UDB116SVT24_INV_0P75 U2097 ( .A(n1440), .X(n1445) );
  UDB116SVT24_ND2_MM_0P75 U2098 ( .A1(n1442), .A2(n1441), .X(n1448) );
  UDB116SVT24_OAI21_0P75 U2099 ( .A1(n1445), .A2(n851), .B(n1448), .X(n1444)
         );
  UDB116SVT24_AOAI211_0P75 U2100 ( .A1(n851), .A2(n1445), .B(n1444), .C(n1443), 
        .X(n1451) );
  UDB116SVT24_NR2_0P75 U2101 ( .A1(\sh_sync_inst/intadd_0/A[12] ), .A2(n1451), 
        .X(n1454) );
  UDB116SVT24_NR2_0P75 U2102 ( .A1(n1665), .A2(n1454), .X(n1452) );
  UDB116SVT24_NR2B_0P75 U2103 ( .A(n1455), .B(n1452), .X(n1461) );
  UDB116SVT24_NR2B_0P75 U2104 ( .A(n1448), .B(n1447), .X(n1449) );
  UDB116SVT24_MUXI2_1 U2105 ( .D0(n1461), .D1(n1450), .S(n1449), .X(n1456) );
  UDB116SVT24_INV_0P75 U2106 ( .A(n1456), .X(n1661) );
  UDB116SVT24_INV_0P75 U2107 ( .A(n1451), .X(n1664) );
  UDB116SVT24_OAI21_0P75 U2108 ( .A1(n1453), .A2(n1664), .B(n1452), .X(n1463)
         );
  UDB116SVT24_NR2_0P75 U2109 ( .A1(n1455), .A2(n1454), .X(n1460) );
  UDB116SVT24_NR3_0P75 U2110 ( .A1(n1463), .A2(\sh_sync_inst/intadd_0/A[11] ), 
        .A3(n1460), .X(n1662) );
  UDB116SVT24_NR2_0P75 U2111 ( .A1(\sh_sync_inst/intadd_0/A[11] ), .A2(n1456), 
        .X(n1462) );
  UDB116SVT24_NR2_0P75 U2112 ( .A1(n1662), .A2(n1462), .X(n1458) );
  UDB116SVT24_OAI21_0P75 U2113 ( .A1(n1457), .A2(n1661), .B(n1458), .X(n1465)
         );
  UDB116SVT24_NR2_0P75 U2114 ( .A1(n1463), .A2(n1458), .X(n1469) );
  UDB116SVT24_INV_0P75 U2115 ( .A(n1469), .X(n1459) );
  UDB116SVT24_OAOI211_0P75 U2116 ( .A1(n1461), .A2(n1460), .B(n1459), .C(n1662), .X(n1659) );
  UDB116SVT24_ND2_MM_0P75 U2117 ( .A1(n1467), .A2(n1659), .X(n1464) );
  UDB116SVT24_ND2_MM_0P75 U2118 ( .A1(n1465), .A2(n1464), .X(n1473) );
  UDB116SVT24_NR2B_0P75 U2119 ( .A(n1463), .B(n1462), .X(n1468) );
  UDB116SVT24_NR3_0P75 U2120 ( .A1(\sh_sync_inst/intadd_0/A[10] ), .A2(n1468), 
        .A3(n1465), .X(n1658) );
  UDB116SVT24_ND2B_0P75 U2121 ( .A(n1658), .B(n1464), .X(n1466) );
  UDB116SVT24_ND2B_0P75 U2122 ( .A(n1465), .B(n1466), .X(n1472) );
  UDB116SVT24_OAI21B_1 U2123 ( .A1(n1659), .A2(n1467), .B(n1466), .X(n1482) );
  UDB116SVT24_NR2B_0P75 U2124 ( .A(n1473), .B(n1482), .X(n1470) );
  UDB116SVT24_OAOI211_0P75 U2125 ( .A1(n1469), .A2(n1468), .B(n1472), .C(n1658), .X(n1655) );
  UDB116SVT24_OAI21_0P75 U2126 ( .A1(n1470), .A2(n1655), .B(n1474), .X(n1476)
         );
  UDB116SVT24_NR2_0P75 U2127 ( .A1(n1482), .A2(n1476), .X(n1471) );
  UDB116SVT24_ND2_MM_0P75 U2128 ( .A1(n1470), .A2(n1474), .X(n1654) );
  UDB116SVT24_AOAI211_0P75 U2129 ( .A1(n1473), .A2(n1472), .B(n1471), .C(n1654), .X(n1477) );
  UDB116SVT24_OAI21_0P75 U2130 ( .A1(n1655), .A2(n1474), .B(n1476), .X(n1485)
         );
  UDB116SVT24_NR2_0P75 U2131 ( .A1(n1482), .A2(n1485), .X(n1478) );
  UDB116SVT24_ND2_MM_0P75 U2132 ( .A1(n1478), .A2(n884), .X(n1479) );
  UDB116SVT24_AOI21_0P75 U2133 ( .A1(n1477), .A2(n1479), .B(n902), .X(n1475)
         );
  UDB116SVT24_OAI21B_1 U2134 ( .A1(\sh_sync_inst/n187 ), .A2(n1024), .B(n1475), 
        .X(\sh_sync_inst/n317 ) );
  UDB116SVT24_INV_0P75 U2135 ( .A(n1476), .X(n1481) );
  UDB116SVT24_INV_0P75 U2136 ( .A(n1477), .X(n1483) );
  UDB116SVT24_OAI21_0P75 U2137 ( .A1(n1483), .A2(n1478), .B(n884), .X(n1484)
         );
  UDB116SVT24_OR2_0P75 U2138 ( .A1(n1485), .A2(n1484), .X(n1494) );
  UDB116SVT24_OAI21_0P75 U2139 ( .A1(n1481), .A2(n990), .B(n1494), .X(n1480)
         );
  UDB116SVT24_AOAI211_0P75 U2140 ( .A1(n990), .A2(n1481), .B(n1480), .C(n1479), 
        .X(n1488) );
  UDB116SVT24_OAI21_0P75 U2141 ( .A1(n885), .A2(n1483), .B(n1484), .X(n1490)
         );
  UDB116SVT24_INV_0P75 U2142 ( .A(n1490), .X(n1498) );
  UDB116SVT24_ND2_MM_0P75 U2143 ( .A1(n1485), .A2(n1484), .X(n1493) );
  UDB116SVT24_ND3_0P75 U2144 ( .A1(n1498), .A2(n1486), .A3(n1493), .X(n1492)
         );
  UDB116SVT24_AOI21_0P75 U2145 ( .A1(n1488), .A2(n1492), .B(n901), .X(n1487)
         );
  UDB116SVT24_OAI21B_1 U2146 ( .A1(\sh_sync_inst/n186 ), .A2(n1025), .B(n1487), 
        .X(\sh_sync_inst/n316 ) );
  UDB116SVT24_NR2_0P75 U2147 ( .A1(n1488), .A2(\sh_sync_inst/intadd_0/A[7] ), 
        .X(n1497) );
  UDB116SVT24_NR2B_0P75 U2148 ( .A(n1492), .B(n1497), .X(n1491) );
  UDB116SVT24_AOI21B_0P75 U2149 ( .A1(\sh_sync_inst/intadd_0/A[7] ), .A2(n1488), .B(n1491), .X(n1507) );
  UDB116SVT24_ND3_0P75 U2150 ( .A1(n1498), .A2(n1507), .A3(n1489), .X(n1499)
         );
  UDB116SVT24_NR2_0P75 U2151 ( .A1(n1491), .A2(n1490), .X(n1496) );
  UDB116SVT24_AOAI211_0P75 U2152 ( .A1(n1494), .A2(n1493), .B(n1496), .C(n1492), .X(n1503) );
  UDB116SVT24_AOI21_0P75 U2153 ( .A1(n1499), .A2(n1503), .B(n902), .X(n1495)
         );
  UDB116SVT24_OAI21B_1 U2154 ( .A1(\sh_sync_inst/n185 ), .A2(n1026), .B(n1495), 
        .X(\sh_sync_inst/n315 ) );
  UDB116SVT24_OAI21B_1 U2155 ( .A1(n1498), .A2(n1497), .B(n1496), .X(n1501) );
  UDB116SVT24_INV_0P75 U2156 ( .A(n1499), .X(n1500) );
  UDB116SVT24_NR2_0P75 U2157 ( .A1(\sh_sync_inst/intadd_0/A[6] ), .A2(n1503), 
        .X(n1506) );
  UDB116SVT24_OR2_0P75 U2158 ( .A1(n1500), .A2(n1506), .X(n1502) );
  UDB116SVT24_ND2_MM_0P75 U2159 ( .A1(n1507), .A2(n1502), .X(n1505) );
  UDB116SVT24_AOI21_0P75 U2160 ( .A1(n1501), .A2(n1505), .B(n1500), .X(n1652)
         );
  UDB116SVT24_AOI21_0P75 U2161 ( .A1(\sh_sync_inst/intadd_0/A[6] ), .A2(n1503), 
        .B(n1502), .X(n1512) );
  UDB116SVT24_AN3B_0P75 U2162 ( .B1(n1507), .B2(n1512), .A(
        \sh_sync_inst/intadd_0/A[5] ), .X(n1651) );
  UDB116SVT24_AN2_1 U2163 ( .A1(n1652), .A2(n1504), .X(n1511) );
  UDB116SVT24_NR2_0P75 U2164 ( .A1(n1651), .A2(n1511), .X(n1508) );
  UDB116SVT24_OAI21_0P75 U2165 ( .A1(n1652), .A2(n1504), .B(n1508), .X(n1514)
         );
  UDB116SVT24_OAI21_0P75 U2166 ( .A1(n1507), .A2(n1506), .B(n1505), .X(n1510)
         );
  UDB116SVT24_NR2B_0P75 U2167 ( .A(n1512), .B(n1508), .X(n1518) );
  UDB116SVT24_INV_0P75 U2168 ( .A(n1518), .X(n1509) );
  UDB116SVT24_AOI21_0P75 U2169 ( .A1(n1510), .A2(n1509), .B(n1651), .X(n1649)
         );
  UDB116SVT24_ND2_MM_0P75 U2170 ( .A1(n1516), .A2(n1649), .X(n1513) );
  UDB116SVT24_ND2_MM_0P75 U2171 ( .A1(n1514), .A2(n1513), .X(n1522) );
  UDB116SVT24_NR2_0P75 U2172 ( .A1(n1512), .A2(n1511), .X(n1517) );
  UDB116SVT24_NR3_0P75 U2173 ( .A1(\sh_sync_inst/intadd_0/A[4] ), .A2(n1517), 
        .A3(n1514), .X(n1648) );
  UDB116SVT24_NR2B_0P75 U2174 ( .A(n1513), .B(n1648), .X(n1515) );
  UDB116SVT24_OR2_0P75 U2175 ( .A1(n1514), .A2(n1515), .X(n1521) );
  UDB116SVT24_OAI21_0P75 U2176 ( .A1(n1649), .A2(n1516), .B(n1515), .X(n1531)
         );
  UDB116SVT24_NR2B_0P75 U2177 ( .A(n1522), .B(n1531), .X(n1519) );
  UDB116SVT24_OAOI211_0P75 U2178 ( .A1(n1518), .A2(n1517), .B(n1521), .C(n1648), .X(n1645) );
  UDB116SVT24_OAI21_0P75 U2179 ( .A1(n1519), .A2(n1645), .B(n1523), .X(n1525)
         );
  UDB116SVT24_NR2_0P75 U2180 ( .A1(n1531), .A2(n1525), .X(n1520) );
  UDB116SVT24_ND2_MM_0P75 U2181 ( .A1(n1519), .A2(n1523), .X(n1644) );
  UDB116SVT24_AOAI211_0P75 U2182 ( .A1(n1522), .A2(n1521), .B(n1520), .C(n1644), .X(n1526) );
  UDB116SVT24_OAI21_0P75 U2183 ( .A1(n1645), .A2(n1523), .B(n1525), .X(n1534)
         );
  UDB116SVT24_NR2_0P75 U2184 ( .A1(n1531), .A2(n1534), .X(n1527) );
  UDB116SVT24_ND2_MM_0P75 U2185 ( .A1(n1527), .A2(n878), .X(n1528) );
  UDB116SVT24_AOI21_0P75 U2186 ( .A1(n1526), .A2(n1528), .B(n901), .X(n1524)
         );
  UDB116SVT24_OAI21B_1 U2187 ( .A1(\sh_sync_inst/n181 ), .A2(n862), .B(n1524), 
        .X(\sh_sync_inst/n311 ) );
  UDB116SVT24_INV_0P75 U2188 ( .A(n1525), .X(n1530) );
  UDB116SVT24_INV_0P75 U2189 ( .A(n1526), .X(n1532) );
  UDB116SVT24_OAI21_0P75 U2190 ( .A1(n1532), .A2(n1527), .B(n878), .X(n1533)
         );
  UDB116SVT24_OR2_0P75 U2191 ( .A1(n1534), .A2(n1533), .X(n1542) );
  UDB116SVT24_OAI21_0P75 U2192 ( .A1(n1530), .A2(n989), .B(n1542), .X(n1529)
         );
  UDB116SVT24_AOAI211_0P75 U2193 ( .A1(n989), .A2(n1530), .B(n1529), .C(n1528), 
        .X(n1537) );
  UDB116SVT24_OAI21_0P75 U2194 ( .A1(n1532), .A2(n879), .B(n1533), .X(n1552)
         );
  UDB116SVT24_ND2_MM_0P75 U2195 ( .A1(n1534), .A2(n1533), .X(n1541) );
  UDB116SVT24_OR3B_0P75 U2196 ( .B1(\sh_sync_inst/intadd_0/A[1] ), .B2(n1552), 
        .A(n1541), .X(n1539) );
  UDB116SVT24_ND2_MM_0P75 U2197 ( .A1(n1537), .A2(n1539), .X(n1536) );
  UDB116SVT24_AO2BB2_0P75 U2198 ( .A1(\sh_sync_inst/n180 ), .A2(n1025), .B1(
        n1536), .B2(n972), .X(\sh_sync_inst/n310 ) );
  UDB116SVT24_INV_0P75 U2199 ( .A(\sh_sync_inst/intadd_0/A[1] ), .X(n1735) );
  UDB116SVT24_ND2_MM_0P75 U2200 ( .A1(n1735), .A2(n1536), .X(n1538) );
  UDB116SVT24_INV_0P75 U2201 ( .A(n1538), .X(n1551) );
  UDB116SVT24_AOI21_0P75 U2202 ( .A1(\sh_sync_inst/intadd_0/A[1] ), .A2(n1537), 
        .B(n1551), .X(n1544) );
  UDB116SVT24_NR2_0P75 U2203 ( .A1(n1552), .A2(n1538), .X(n1540) );
  UDB116SVT24_AOAI211_0P75 U2204 ( .A1(n1542), .A2(n1541), .B(n1540), .C(n1539), .X(n1543) );
  UDB116SVT24_NR2_0P75 U2205 ( .A1(\sh_sync_inst/intadd_0/A[0] ), .A2(n1543), 
        .X(n1545) );
  UDB116SVT24_NR2_0P75 U2206 ( .A1(n1544), .A2(n1545), .X(n1556) );
  UDB116SVT24_INV_0P75 U2207 ( .A(n1543), .X(n1641) );
  UDB116SVT24_INV_0P75 U2208 ( .A(n1544), .X(n1547) );
  UDB116SVT24_NR3_0P75 U2209 ( .A1(\sh_sync_inst/intadd_0/A[0] ), .A2(n1552), 
        .A3(n1547), .X(n1642) );
  UDB116SVT24_NR2_0P75 U2210 ( .A1(n1642), .A2(n1545), .X(n1548) );
  UDB116SVT24_OAI21_0P75 U2211 ( .A1(n1641), .A2(n1546), .B(n1548), .X(n1553)
         );
  UDB116SVT24_NR3_0P75 U2212 ( .A1(\sh_sync_inst/n176 ), .A2(n1556), .A3(n1553), .X(n1639) );
  UDB116SVT24_NR2_0P75 U2213 ( .A1(n1548), .A2(n1547), .X(n1555) );
  UDB116SVT24_OAI21B_1 U2214 ( .A1(n1551), .A2(n852), .B(n1555), .X(n1550) );
  UDB116SVT24_INV_0P75 U2215 ( .A(n1642), .X(n1549) );
  UDB116SVT24_AOAI211_0P75 U2216 ( .A1(n852), .A2(n1551), .B(n1550), .C(n1549), 
        .X(n1637) );
  UDB116SVT24_MAJ3_0P75 U2217 ( .A1(\sh_sync_inst/n177 ), .A2(
        \sh_sync_inst/n176 ), .A3(n1637), .X(n1554) );
  UDB116SVT24_OAI22_0P75 U2218 ( .A1(n1556), .A2(n1555), .B1(n1554), .B2(n1553), .X(n1557) );
  UDB116SVT24_ND2_MM_0P75 U2219 ( .A1(n973), .A2(n1557), .X(n1558) );
  UDB116SVT24_OAI22_0P75 U2220 ( .A1(n1639), .A2(n1558), .B1(
        \sh_sync_inst/n193 ), .B2(n1024), .X(\sh_sync_inst/n323 ) );
  UDB116SVT24_AO21B_0P75 U2221 ( .A1(n1559), .A2(\fsm_sync_inst/sh_en_prev ), 
        .B(\sh_sync_inst/n204 ), .X(n1560) );
  UDB116SVT24_OA2BB2_0P75 U2222 ( .A1(\fsm_sync_inst/state_neg ), .A2(n1560), 
        .B1(rfin), .B2(\fsm_sync_inst/state_neg ), .X(n1579) );
  UDB116SVT24_OA2BB2_0P75 U2223 ( .A1(\fsm_sync_inst/state_pos ), .A2(n1560), 
        .B1(rfin), .B2(\fsm_sync_inst/state_pos ), .X(n1581) );
  UDB116SVT24_NR2_0P75 U2224 ( .A1(n1579), .A2(n1581), .X(n1564) );
  UDB116SVT24_OAI22_0P75 U2225 ( .A1(n1563), .A2(n1564), .B1(n1562), .B2(n1561), .X(\shift_buf_inst/n134 ) );
  UDB116SVT24_AOI211_0P75 U2226 ( .A1(\sh_sync_inst/rfin_edge ), .A2(n1565), 
        .B1(rst), .B2(n1564), .X(\sh_sync_inst/N528 ) );
  UDB116SVT24_AO21_0P75 U2227 ( .A1(counter[0]), .A2(n1938), .B(n1566), .X(
        n847) );
  UDB116SVT24_AO32_0P75 U2228 ( .A1(n1570), .A2(\sh_sync_inst/n232 ), .A3(
        n1002), .B1(n1568), .B2(n1567), .X(\sh_sync_inst/n327 ) );
  UDB116SVT24_NR2_0P75 U2229 ( .A1(\sh_sync_inst/n202 ), .A2(n959), .X(n1595)
         );
  UDB116SVT24_AOI21_0P75 U2230 ( .A1(n937), .A2(n882), .B(n881), .X(n1597) );
  UDB116SVT24_OAI21_0P75 U2231 ( .A1(n1573), .A2(n1571), .B(n1597), .X(n1572)
         );
  UDB116SVT24_AO32_0P75 U2232 ( .A1(n1595), .A2(n906), .A3(n1573), .B1(n877), 
        .B2(n1572), .X(\sh_sync_inst/n268 ) );
  UDB116SVT24_NR2_0P75 U2233 ( .A1(n981), .A2(n1574), .X(n1604) );
  UDB116SVT24_OAI21_0P75 U2234 ( .A1(n1575), .A2(n863), .B(n1612), .X(n1601)
         );
  UDB116SVT24_AO32_0P75 U2235 ( .A1(n1604), .A2(\sh_sync_inst/n153 ), .A3(
        n1607), .B1(n892), .B2(n1601), .X(\sh_sync_inst/n279 ) );
  UDB116SVT24_AO32_0P75 U2236 ( .A1(n1578), .A2(n1009), .A3(n949), .B1(n1577), 
        .B2(n1576), .X(\sh_sync_inst/n273 ) );
  UDB116SVT24_AN2_1 U2237 ( .A1(n1579), .A2(n1580), .X(\fsm_sync_inst/N13 ) );
  UDB116SVT24_AN2_1 U2238 ( .A1(n1581), .A2(n1580), .X(\fsm_sync_inst/N11 ) );
  UDB116SVT24_ND2_MM_0P75 U2239 ( .A1(\sh_sync_inst/N530 ), .A2(
        \sh_sync_inst/n225 ), .X(n1582) );
  UDB116SVT24_OAI21_0P75 U2240 ( .A1(n1584), .A2(n1583), .B(n1582), .X(
        \sh_sync_inst/n145 ) );
  UDB116SVT24_AOI21_0P75 U2241 ( .A1(\sh_sync_inst/intadd_0/B[12] ), .A2(n962), 
        .B(n1585), .X(n1586) );
  UDB116SVT24_OAI32_1 U2242 ( .A1(n874), .A2(n1018), .A3(n1587), .B1(n1683), 
        .B2(n1586), .X(\sh_sync_inst/n255 ) );
  UDB116SVT24_AO22_1 U2243 ( .A1(n1591), .A2(n1590), .B1(n1589), .B2(n922), 
        .X(\sh_sync_inst/n260 ) );
  UDB116SVT24_AOI21B_0P75 U2244 ( .A1(\sh_sync_inst/n201 ), .A2(n961), .B(
        n1597), .X(n1594) );
  UDB116SVT24_AOI31_0P75 U2245 ( .A1(n969), .A2(n1595), .A3(n1592), .B(n931), 
        .X(n1593) );
  UDB116SVT24_OAI21_0P75 U2246 ( .A1(n969), .A2(n1594), .B(n1593), .X(
        \sh_sync_inst/n269 ) );
  UDB116SVT24_AOI21_0P75 U2247 ( .A1(n1016), .A2(n1595), .B(n931), .X(n1596)
         );
  UDB116SVT24_OAI21_0P75 U2248 ( .A1(n1016), .A2(n1597), .B(n1596), .X(
        \sh_sync_inst/n270 ) );
  UDB116SVT24_AOI32_1 U2249 ( .A1(n1600), .A2(n894), .A3(n1599), .B1(
        \sh_sync_inst/n148 ), .B2(n1598), .X(\sh_sync_inst/n274 ) );
  UDB116SVT24_AOI21_0P75 U2250 ( .A1(n948), .A2(\sh_sync_inst/n153 ), .B(n1601), .X(n1602) );
  UDB116SVT24_OAI32_1 U2251 ( .A1(n907), .A2(n1603), .A3(n861), .B1(
        \sh_sync_inst/n152 ), .B2(n1602), .X(\sh_sync_inst/n278 ) );
  UDB116SVT24_INV_0P75 U2252 ( .A(n1604), .X(n1605) );
  UDB116SVT24_AOI32_1 U2253 ( .A1(n1608), .A2(n1607), .A3(n1606), .B1(
        \sh_sync_inst/n154 ), .B2(n1605), .X(\sh_sync_inst/n280 ) );
  UDB116SVT24_ND3_0P75 U2254 ( .A1(n1613), .A2(n949), .A3(n858), .X(n1611) );
  UDB116SVT24_OAOAI2111_1 U2255 ( .A1(n980), .A2(n1613), .B(n1612), .C(n858), 
        .D(n1611), .X(\sh_sync_inst/n302 ) );
  UDB116SVT24_AOI21_0P75 U2256 ( .A1(\sh_sync_inst/n207 ), .A2(n919), .B(n1614), .X(n1616) );
  UDB116SVT24_OAI32_1 U2257 ( .A1(n1618), .A2(n993), .A3(n1617), .B1(
        \sh_sync_inst/n206 ), .B2(n1616), .X(\sh_sync_inst/n306 ) );
  UDB116SVT24_AOI32_1 U2258 ( .A1(n1622), .A2(n1621), .A3(n1620), .B1(
        \sh_sync_inst/n246 ), .B2(n1619), .X(\sh_sync_inst/n332 ) );
  UDB116SVT24_AOI21_0P75 U2259 ( .A1(n1005), .A2(\sh_sync_inst/n247 ), .B(
        n1623), .X(n1625) );
  UDB116SVT24_OAI32_1 U2260 ( .A1(n1628), .A2(n1627), .A3(n1626), .B1(
        \sh_sync_inst/n248 ), .B2(n1625), .X(\sh_sync_inst/n334 ) );
  UDB116SVT24_INV_0P75 U2261 ( .A(\sh_sync_inst/n212 ), .X(n1631) );
  UDB116SVT24_AOI32_1 U2262 ( .A1(n1632), .A2(n1631), .A3(n1630), .B1(
        \sh_sync_inst/n212 ), .B2(n1629), .X(\sh_sync_inst/n342 ) );
  UDB116SVT24_AO22_1 U2263 ( .A1(n1636), .A2(n1635), .B1(n1634), .B2(n1633), 
        .X(\sh_sync_inst/n347 ) );
  UDB116SVT24_AN2_1 U2264 ( .A1(\sh_sync_inst/N535 ), .A2(\sh_sync_inst/n254 ), 
        .X(\sh_sync_inst/N536 ) );
  UDB116SVT24_INV_0P75 U2265 ( .A(n1637), .X(n1638) );
  UDB116SVT24_OAI21_0P75 U2266 ( .A1(n1639), .A2(n1638), .B(n973), .X(n1640)
         );
  UDB116SVT24_OAI21_0P75 U2267 ( .A1(\sh_sync_inst/n178 ), .A2(n1026), .B(
        n1640), .X(\sh_sync_inst/n308 ) );
  UDB116SVT24_OAI21_0P75 U2268 ( .A1(n1642), .A2(n1641), .B(n973), .X(n1643)
         );
  UDB116SVT24_OAI21_0P75 U2269 ( .A1(\sh_sync_inst/n179 ), .A2(n1023), .B(
        n1643), .X(\sh_sync_inst/n309 ) );
  UDB116SVT24_INV_0P75 U2270 ( .A(n1644), .X(n1646) );
  UDB116SVT24_OAI21_0P75 U2271 ( .A1(n1646), .A2(n1645), .B(n974), .X(n1647)
         );
  UDB116SVT24_OAI21_0P75 U2272 ( .A1(\sh_sync_inst/n182 ), .A2(n1024), .B(
        n1647), .X(\sh_sync_inst/n312 ) );
  UDB116SVT24_OAI21_0P75 U2273 ( .A1(n1649), .A2(n1648), .B(n972), .X(n1650)
         );
  UDB116SVT24_OAI21_0P75 U2274 ( .A1(\sh_sync_inst/n183 ), .A2(n1025), .B(
        n1650), .X(\sh_sync_inst/n313 ) );
  UDB116SVT24_OAI21_0P75 U2275 ( .A1(n1652), .A2(n1651), .B(n973), .X(n1653)
         );
  UDB116SVT24_OAI21_0P75 U2276 ( .A1(\sh_sync_inst/n184 ), .A2(n1026), .B(
        n1653), .X(\sh_sync_inst/n314 ) );
  UDB116SVT24_INV_0P75 U2277 ( .A(n1654), .X(n1656) );
  UDB116SVT24_OAI21_0P75 U2278 ( .A1(n1656), .A2(n1655), .B(n974), .X(n1657)
         );
  UDB116SVT24_OAI21_0P75 U2279 ( .A1(\sh_sync_inst/n188 ), .A2(n1023), .B(
        n1657), .X(\sh_sync_inst/n318 ) );
  UDB116SVT24_OAI21_0P75 U2280 ( .A1(n1659), .A2(n1658), .B(n974), .X(n1660)
         );
  UDB116SVT24_OAI21_0P75 U2281 ( .A1(\sh_sync_inst/n189 ), .A2(n1024), .B(
        n1660), .X(\sh_sync_inst/n319 ) );
  UDB116SVT24_OAI21_0P75 U2282 ( .A1(n1662), .A2(n1661), .B(n972), .X(n1663)
         );
  UDB116SVT24_OAI21_0P75 U2283 ( .A1(\sh_sync_inst/n190 ), .A2(n1025), .B(
        n1663), .X(\sh_sync_inst/n320 ) );
  UDB116SVT24_OAI21_0P75 U2284 ( .A1(n1665), .A2(n1664), .B(n972), .X(n1666)
         );
  UDB116SVT24_OAI21_0P75 U2285 ( .A1(\sh_sync_inst/n191 ), .A2(n1026), .B(
        n1666), .X(\sh_sync_inst/n321 ) );
  UDB116SVT24_AO22_1 U2286 ( .A1(n1671), .A2(n1670), .B1(n1669), .B2(n1668), 
        .X(\sh_sync_inst/n277 ) );
  UDB116SVT24_AO22_1 U2287 ( .A1(n1674), .A2(n1673), .B1(n1672), .B2(n927), 
        .X(\sh_sync_inst/n283 ) );
  UDB116SVT24_AO22_1 U2288 ( .A1(n1677), .A2(n1676), .B1(n1675), .B2(n890), 
        .X(\sh_sync_inst/n285 ) );
  UDB116SVT24_AO22_1 U2289 ( .A1(n1680), .A2(n1679), .B1(n888), .B2(n1678), 
        .X(\sh_sync_inst/n287 ) );
  UDB116SVT24_OAI21_0P75 U2290 ( .A1(n875), .A2(n1682), .B(n1681), .X(n1685)
         );
  UDB116SVT24_AOI21_0P75 U2291 ( .A1(n1686), .A2(n1685), .B(n1610), .X(n1684)
         );
  UDB116SVT24_OAI21_0P75 U2292 ( .A1(n1686), .A2(n1685), .B(n1684), .X(n1687)
         );
  UDB116SVT24_OAI21_0P75 U2293 ( .A1(n997), .A2(n1693), .B(n1687), .X(
        \sh_sync_inst/n288 ) );
  UDB116SVT24_AOI21_0P75 U2294 ( .A1(\sh_sync_inst/intadd_0/B[11] ), .A2(n999), 
        .B(n1688), .X(n1691) );
  UDB116SVT24_AOI21_0P75 U2295 ( .A1(n1691), .A2(n1690), .B(n861), .X(n1689)
         );
  UDB116SVT24_OAI21_0P75 U2296 ( .A1(n1691), .A2(n1690), .B(n1689), .X(n1692)
         );
  UDB116SVT24_OAI21_0P75 U2297 ( .A1(n999), .A2(n1693), .B(n1692), .X(
        \sh_sync_inst/n290 ) );
  UDB116SVT24_INV_0P75 U2298 ( .A(n1694), .X(n1741) );
  UDB116SVT24_AOI21_0P75 U2299 ( .A1(n1588), .A2(\sh_sync_inst/intadd_0/A[9] ), 
        .B(n1695), .X(n1698) );
  UDB116SVT24_AOI21_0P75 U2300 ( .A1(n1698), .A2(n1697), .B(n982), .X(n1696)
         );
  UDB116SVT24_OAI21_0P75 U2301 ( .A1(n1698), .A2(n1697), .B(n1696), .X(n1699)
         );
  UDB116SVT24_OAI21_0P75 U2302 ( .A1(\sh_sync_inst/intadd_0/A[9] ), .A2(n1741), 
        .B(n1699), .X(\sh_sync_inst/n292 ) );
  UDB116SVT24_AOI21_0P75 U2303 ( .A1(n1302), .A2(n996), .B(n1700), .X(n1703)
         );
  UDB116SVT24_AOI21_0P75 U2304 ( .A1(n1703), .A2(n1702), .B(n982), .X(n1701)
         );
  UDB116SVT24_OAI21_0P75 U2305 ( .A1(n1703), .A2(n1702), .B(n1701), .X(n1704)
         );
  UDB116SVT24_OAI21_0P75 U2306 ( .A1(n996), .A2(n1705), .B(n1704), .X(
        \sh_sync_inst/n294 ) );
  UDB116SVT24_AOI21_0P75 U2307 ( .A1(n954), .A2(\sh_sync_inst/intadd_0/A[5] ), 
        .B(n1706), .X(n1709) );
  UDB116SVT24_AOI21_0P75 U2308 ( .A1(n1709), .A2(n1708), .B(n981), .X(n1707)
         );
  UDB116SVT24_OAI21_0P75 U2309 ( .A1(n1709), .A2(n1708), .B(n1707), .X(n1710)
         );
  UDB116SVT24_OAI21_0P75 U2310 ( .A1(\sh_sync_inst/intadd_0/A[5] ), .A2(n1741), 
        .B(n1710), .X(\sh_sync_inst/n296 ) );
  UDB116SVT24_AOI21_0P75 U2311 ( .A1(n1713), .A2(n882), .B(n880), .X(n1712) );
  UDB116SVT24_OAI32_1 U2312 ( .A1(n1714), .A2(n959), .A3(n1713), .B1(n952), 
        .B2(n1712), .X(\sh_sync_inst/n267 ) );
  UDB116SVT24_ND2_MM_0P75 U2313 ( .A1(n961), .A2(n1715), .X(n1716) );
  UDB116SVT24_AOI32_1 U2314 ( .A1(n1719), .A2(n1718), .A3(n1717), .B1(n1007), 
        .B2(n1716), .X(\sh_sync_inst/n265 ) );
  UDB116SVT24_AOI21_0P75 U2315 ( .A1(n937), .A2(n963), .B(n932), .X(n1721) );
  UDB116SVT24_OAI21_0P75 U2316 ( .A1(\sh_sync_inst/n202 ), .A2(n1711), .B(
        n1721), .X(\sh_sync_inst/n271 ) );
  UDB116SVT24_AOI21_0P75 U2317 ( .A1(n955), .A2(n882), .B(n1723), .X(n1729) );
  UDB116SVT24_NR2_0P75 U2318 ( .A1(n960), .A2(n1725), .X(n1727) );
  UDB116SVT24_AOI31_0P75 U2319 ( .A1(n1012), .A2(n1727), .A3(n925), .B(n932), 
        .X(n1728) );
  UDB116SVT24_OAI21_0P75 U2320 ( .A1(n1012), .A2(n1729), .B(n1728), .X(
        \sh_sync_inst/n263 ) );
  UDB116SVT24_AOI21_0P75 U2321 ( .A1(\sh_sync_inst/intadd_0/B[3] ), .A2(
        \sh_sync_inst/intadd_0/A[3] ), .B(n1730), .X(n1733) );
  UDB116SVT24_AOI21_0P75 U2322 ( .A1(n1733), .A2(n1732), .B(n981), .X(n1731)
         );
  UDB116SVT24_OAI21_0P75 U2323 ( .A1(n1733), .A2(n1732), .B(n1731), .X(n1734)
         );
  UDB116SVT24_OAI21_0P75 U2324 ( .A1(\sh_sync_inst/intadd_0/A[3] ), .A2(n1741), 
        .B(n1734), .X(\sh_sync_inst/n298 ) );
  UDB116SVT24_AOI22_1 U2325 ( .A1(n998), .A2(n905), .B1(
        \sh_sync_inst/intadd_0/B[1] ), .B2(n1735), .X(n1738) );
  UDB116SVT24_AOI21_0P75 U2326 ( .A1(n1739), .A2(n1738), .B(n861), .X(n1737)
         );
  UDB116SVT24_OAI21_0P75 U2327 ( .A1(n1739), .A2(n1738), .B(n1737), .X(n1740)
         );
  UDB116SVT24_OAI21_0P75 U2328 ( .A1(n998), .A2(n1741), .B(n1740), .X(
        \sh_sync_inst/n300 ) );
  UDB116SVT24_AOI32_1 U2329 ( .A1(n1744), .A2(n1743), .A3(n1742), .B1(
        \sh_sync_inst/n220 ), .B2(n1748), .X(\sh_sync_inst/n350 ) );
  UDB116SVT24_AOI21_0P75 U2330 ( .A1(n976), .A2(\sh_sync_inst/n219 ), .B(n1745), .X(n1747) );
  UDB116SVT24_OAI32_1 U2331 ( .A1(n1750), .A2(n1749), .A3(n1748), .B1(
        \sh_sync_inst/n218 ), .B2(n1747), .X(\sh_sync_inst/n348 ) );
  UDB116SVT24_OAI21_0P75 U2332 ( .A1(n863), .A2(n1752), .B(n1751), .X(
        \sh_sync_inst/N31 ) );
  UDB116SVT24_INV_0P75 U2333 ( .A(SHIFT_OUT[35]), .X(n1843) );
  UDB116SVT24_OAI22_0P75 U2334 ( .A1(\sh_sync_inst/n194 ), .A2(n1846), .B1(
        n1843), .B2(n1754), .X(\shift_buf_inst/n99 ) );
  UDB116SVT24_OAI22_0P75 U2335 ( .A1(\sh_sync_inst/n194 ), .A2(n1843), .B1(
        n1841), .B2(n1754), .X(\shift_buf_inst/n98 ) );
  UDB116SVT24_OAI22_0P75 U2336 ( .A1(\sh_sync_inst/n194 ), .A2(n1851), .B1(
        n1848), .B2(n1755), .X(\shift_buf_inst/n101 ) );
  UDB116SVT24_INV_0P75 U2337 ( .A(n1756), .X(n1833) );
  UDB116SVT24_BUF_1 U2338 ( .A(n1833), .X(n1906) );
  UDB116SVT24_INV_0P75 U2339 ( .A(n1906), .X(n1929) );
  UDB116SVT24_ND2_MM_0P75 U2340 ( .A1(PKT_EN), .A2(n1757), .X(n1758) );
  UDB116SVT24_NR2_0P75 U2341 ( .A1(PKT_LD), .A2(n1758), .X(n1817) );
  UDB116SVT24_BUF_1 U2342 ( .A(n1817), .X(n1877) );
  UDB116SVT24_BUF_1 U2343 ( .A(n1877), .X(n1916) );
  UDB116SVT24_BUF_1 U2344 ( .A(n1916), .X(n1765) );
  UDB116SVT24_AOI22_1 U2345 ( .A1(n1765), .A2(\pkt_reg_inst/pkt_reg [55]), 
        .B1(n1925), .B2(\pkt_reg_inst/pkt_reg [63]), .X(n1759) );
  UDB116SVT24_OAI21_0P75 U2346 ( .A1(n1929), .A2(n1760), .B(n1759), .X(
        \pkt_reg_inst/n40 ) );
  UDB116SVT24_INV_0P75 U2347 ( .A(n1771), .X(n1770) );
  UDB116SVT24_BUF_1 U2348 ( .A(n1790), .X(n1772) );
  UDB116SVT24_AOI22_1 U2349 ( .A1(n1765), .A2(\pkt_reg_inst/pkt_reg [54]), 
        .B1(n1772), .B2(\pkt_reg_inst/pkt_reg [62]), .X(n1761) );
  UDB116SVT24_OAI21_0P75 U2350 ( .A1(n1770), .A2(n1762), .B(n1761), .X(
        \pkt_reg_inst/n41 ) );
  UDB116SVT24_AOI22_1 U2351 ( .A1(n1765), .A2(\pkt_reg_inst/pkt_reg [53]), 
        .B1(n1780), .B2(\pkt_reg_inst/pkt_reg [61]), .X(n1763) );
  UDB116SVT24_OAI21_0P75 U2352 ( .A1(n1770), .A2(n1764), .B(n1763), .X(
        \pkt_reg_inst/n42 ) );
  UDB116SVT24_AOI22_1 U2353 ( .A1(n1765), .A2(\pkt_reg_inst/pkt_reg [52]), 
        .B1(n1772), .B2(\pkt_reg_inst/pkt_reg [60]), .X(n1766) );
  UDB116SVT24_OAI21_0P75 U2354 ( .A1(n1770), .A2(n1767), .B(n1766), .X(
        \pkt_reg_inst/n43 ) );
  UDB116SVT24_BUF_1 U2355 ( .A(n1916), .X(n1777) );
  UDB116SVT24_AOI22_1 U2356 ( .A1(n1777), .A2(\pkt_reg_inst/pkt_reg [51]), 
        .B1(n1772), .B2(\pkt_reg_inst/pkt_reg [59]), .X(n1768) );
  UDB116SVT24_OAI21_0P75 U2357 ( .A1(n1770), .A2(n1769), .B(n1768), .X(
        \pkt_reg_inst/n44 ) );
  UDB116SVT24_INV_0P75 U2358 ( .A(n1771), .X(n1783) );
  UDB116SVT24_AOI22_1 U2359 ( .A1(n1777), .A2(\pkt_reg_inst/pkt_reg [50]), 
        .B1(n1772), .B2(\pkt_reg_inst/pkt_reg [58]), .X(n1773) );
  UDB116SVT24_OAI21_0P75 U2360 ( .A1(n1783), .A2(n1774), .B(n1773), .X(
        \pkt_reg_inst/n45 ) );
  UDB116SVT24_BUF_1 U2361 ( .A(n1790), .X(n1787) );
  UDB116SVT24_AOI22_1 U2362 ( .A1(n1777), .A2(\pkt_reg_inst/pkt_reg [49]), 
        .B1(n1787), .B2(\pkt_reg_inst/pkt_reg [57]), .X(n1775) );
  UDB116SVT24_OAI21_0P75 U2363 ( .A1(n1783), .A2(n1776), .B(n1775), .X(
        \pkt_reg_inst/n46 ) );
  UDB116SVT24_AOI22_1 U2364 ( .A1(n1777), .A2(\pkt_reg_inst/pkt_reg [48]), 
        .B1(n1787), .B2(\pkt_reg_inst/pkt_reg [56]), .X(n1778) );
  UDB116SVT24_OAI21_0P75 U2365 ( .A1(n1783), .A2(n1779), .B(n1778), .X(
        \pkt_reg_inst/n47 ) );
  UDB116SVT24_BUF_1 U2366 ( .A(n1817), .X(n1889) );
  UDB116SVT24_BUF_1 U2367 ( .A(n1889), .X(n1791) );
  UDB116SVT24_AOI22_1 U2368 ( .A1(n1791), .A2(\pkt_reg_inst/pkt_reg [47]), 
        .B1(\pkt_reg_inst/pkt_reg [55]), .B2(n1780), .X(n1781) );
  UDB116SVT24_OAI21_0P75 U2369 ( .A1(n1783), .A2(n1782), .B(n1781), .X(
        \pkt_reg_inst/n48 ) );
  UDB116SVT24_INV_0P75 U2370 ( .A(n1784), .X(n1796) );
  UDB116SVT24_AOI22_1 U2371 ( .A1(n1791), .A2(\pkt_reg_inst/pkt_reg [46]), 
        .B1(n1787), .B2(\pkt_reg_inst/pkt_reg [54]), .X(n1785) );
  UDB116SVT24_OAI21_0P75 U2372 ( .A1(n1796), .A2(n1786), .B(n1785), .X(
        \pkt_reg_inst/n49 ) );
  UDB116SVT24_AOI22_1 U2373 ( .A1(n1791), .A2(\pkt_reg_inst/pkt_reg [45]), 
        .B1(n1787), .B2(\pkt_reg_inst/pkt_reg [53]), .X(n1788) );
  UDB116SVT24_OAI21_0P75 U2374 ( .A1(n1796), .A2(n1789), .B(n1788), .X(
        \pkt_reg_inst/n50 ) );
  UDB116SVT24_BUF_1 U2375 ( .A(n1790), .X(n1799) );
  UDB116SVT24_AOI22_1 U2376 ( .A1(n1791), .A2(\pkt_reg_inst/pkt_reg [44]), 
        .B1(n1799), .B2(\pkt_reg_inst/pkt_reg [52]), .X(n1792) );
  UDB116SVT24_OAI21_0P75 U2377 ( .A1(n1796), .A2(n1793), .B(n1792), .X(
        \pkt_reg_inst/n51 ) );
  UDB116SVT24_BUF_1 U2378 ( .A(n1889), .X(n1802) );
  UDB116SVT24_AOI22_1 U2379 ( .A1(n1802), .A2(\pkt_reg_inst/pkt_reg [43]), 
        .B1(n1799), .B2(\pkt_reg_inst/pkt_reg [51]), .X(n1794) );
  UDB116SVT24_OAI21_0P75 U2380 ( .A1(n1796), .A2(n1795), .B(n1794), .X(
        \pkt_reg_inst/n52 ) );
  UDB116SVT24_INV_0P75 U2381 ( .A(n1833), .X(n1807) );
  UDB116SVT24_AOI22_1 U2382 ( .A1(n1802), .A2(\pkt_reg_inst/pkt_reg [42]), 
        .B1(n1799), .B2(\pkt_reg_inst/pkt_reg [50]), .X(n1797) );
  UDB116SVT24_OAI21_0P75 U2383 ( .A1(n1807), .A2(n1798), .B(n1797), .X(
        \pkt_reg_inst/n53 ) );
  UDB116SVT24_AOI22_1 U2384 ( .A1(n1802), .A2(\pkt_reg_inst/pkt_reg [41]), 
        .B1(n1799), .B2(\pkt_reg_inst/pkt_reg [49]), .X(n1800) );
  UDB116SVT24_OAI21_0P75 U2385 ( .A1(n1807), .A2(n1801), .B(n1800), .X(
        \pkt_reg_inst/n54 ) );
  UDB116SVT24_BUF_1 U2386 ( .A(n1826), .X(n1810) );
  UDB116SVT24_AOI22_1 U2387 ( .A1(n1802), .A2(\pkt_reg_inst/pkt_reg [40]), 
        .B1(n1810), .B2(\pkt_reg_inst/pkt_reg [48]), .X(n1803) );
  UDB116SVT24_OAI21_0P75 U2388 ( .A1(n1807), .A2(n1804), .B(n1803), .X(
        \pkt_reg_inst/n55 ) );
  UDB116SVT24_BUF_1 U2389 ( .A(n1889), .X(n1814) );
  UDB116SVT24_AOI22_1 U2390 ( .A1(n1814), .A2(\pkt_reg_inst/pkt_reg [39]), 
        .B1(n1810), .B2(\pkt_reg_inst/pkt_reg [47]), .X(n1805) );
  UDB116SVT24_OAI21_0P75 U2391 ( .A1(n1807), .A2(n1806), .B(n1805), .X(
        \pkt_reg_inst/n56 ) );
  UDB116SVT24_INV_0P75 U2392 ( .A(n1784), .X(n1820) );
  UDB116SVT24_AOI22_1 U2393 ( .A1(n1814), .A2(\pkt_reg_inst/pkt_reg [38]), 
        .B1(n1810), .B2(\pkt_reg_inst/pkt_reg [46]), .X(n1808) );
  UDB116SVT24_OAI21_0P75 U2394 ( .A1(n1820), .A2(n1809), .B(n1808), .X(
        \pkt_reg_inst/n57 ) );
  UDB116SVT24_AOI22_1 U2395 ( .A1(n1814), .A2(\pkt_reg_inst/pkt_reg [37]), 
        .B1(n1810), .B2(\pkt_reg_inst/pkt_reg [45]), .X(n1811) );
  UDB116SVT24_OAI21_0P75 U2396 ( .A1(n1820), .A2(n1812), .B(n1811), .X(
        \pkt_reg_inst/n58 ) );
  UDB116SVT24_BUF_1 U2397 ( .A(n1813), .X(n1823) );
  UDB116SVT24_AOI22_1 U2398 ( .A1(n1814), .A2(\pkt_reg_inst/pkt_reg [36]), 
        .B1(n1823), .B2(\pkt_reg_inst/pkt_reg [44]), .X(n1815) );
  UDB116SVT24_OAI21_0P75 U2399 ( .A1(n1820), .A2(n1816), .B(n1815), .X(
        \pkt_reg_inst/n59 ) );
  UDB116SVT24_BUF_1 U2400 ( .A(n1817), .X(n1902) );
  UDB116SVT24_BUF_1 U2401 ( .A(n1902), .X(n1827) );
  UDB116SVT24_AOI22_1 U2402 ( .A1(n1827), .A2(\pkt_reg_inst/pkt_reg [35]), 
        .B1(n1823), .B2(\pkt_reg_inst/pkt_reg [43]), .X(n1818) );
  UDB116SVT24_OAI21_0P75 U2403 ( .A1(n1820), .A2(n1819), .B(n1818), .X(
        \pkt_reg_inst/n60 ) );
  UDB116SVT24_INV_0P75 U2404 ( .A(n1833), .X(n1832) );
  UDB116SVT24_AOI22_1 U2405 ( .A1(n1827), .A2(\pkt_reg_inst/pkt_reg [34]), 
        .B1(n1823), .B2(\pkt_reg_inst/pkt_reg [42]), .X(n1821) );
  UDB116SVT24_OAI21_0P75 U2406 ( .A1(n1832), .A2(n1822), .B(n1821), .X(
        \pkt_reg_inst/n61 ) );
  UDB116SVT24_AOI22_1 U2407 ( .A1(n1827), .A2(\pkt_reg_inst/pkt_reg [33]), 
        .B1(n1823), .B2(\pkt_reg_inst/pkt_reg [41]), .X(n1824) );
  UDB116SVT24_OAI21_0P75 U2408 ( .A1(n1832), .A2(n1825), .B(n1824), .X(
        \pkt_reg_inst/n62 ) );
  UDB116SVT24_BUF_1 U2409 ( .A(n1826), .X(n1836) );
  UDB116SVT24_AOI22_1 U2410 ( .A1(n1827), .A2(\pkt_reg_inst/pkt_reg [32]), 
        .B1(n1836), .B2(\pkt_reg_inst/pkt_reg [40]), .X(n1828) );
  UDB116SVT24_OAI21_0P75 U2411 ( .A1(n1832), .A2(n1829), .B(n1828), .X(
        \pkt_reg_inst/n63 ) );
  UDB116SVT24_BUF_1 U2412 ( .A(n1902), .X(n1839) );
  UDB116SVT24_AOI22_1 U2413 ( .A1(n1839), .A2(\pkt_reg_inst/pkt_reg [31]), 
        .B1(n1836), .B2(\pkt_reg_inst/pkt_reg [39]), .X(n1830) );
  UDB116SVT24_OAI21_0P75 U2414 ( .A1(n1832), .A2(n1831), .B(n1830), .X(
        \pkt_reg_inst/n64 ) );
  UDB116SVT24_BUF_1 U2415 ( .A(n1833), .X(n1865) );
  UDB116SVT24_INV_0P75 U2416 ( .A(n1865), .X(n1905) );
  UDB116SVT24_AOI22_1 U2417 ( .A1(n1839), .A2(\pkt_reg_inst/pkt_reg [30]), 
        .B1(n1836), .B2(\pkt_reg_inst/pkt_reg [38]), .X(n1834) );
  UDB116SVT24_OAI21_0P75 U2418 ( .A1(n1905), .A2(n1835), .B(n1834), .X(
        \pkt_reg_inst/n65 ) );
  UDB116SVT24_AOI22_1 U2419 ( .A1(n1839), .A2(\pkt_reg_inst/pkt_reg [29]), 
        .B1(n1836), .B2(\pkt_reg_inst/pkt_reg [37]), .X(n1837) );
  UDB116SVT24_OAI21_0P75 U2420 ( .A1(n1905), .A2(n1838), .B(n1837), .X(
        \pkt_reg_inst/n66 ) );
  UDB116SVT24_AOI22_1 U2421 ( .A1(n1839), .A2(\pkt_reg_inst/pkt_reg [28]), 
        .B1(n1844), .B2(\pkt_reg_inst/pkt_reg [36]), .X(n1840) );
  UDB116SVT24_OAI21_0P75 U2422 ( .A1(n1905), .A2(n1841), .B(n1840), .X(
        \pkt_reg_inst/n67 ) );
  UDB116SVT24_INV_0P75 U2423 ( .A(n1865), .X(n1852) );
  UDB116SVT24_BUF_1 U2424 ( .A(n1902), .X(n1849) );
  UDB116SVT24_AOI22_1 U2425 ( .A1(n1849), .A2(\pkt_reg_inst/pkt_reg [27]), 
        .B1(n1844), .B2(\pkt_reg_inst/pkt_reg [35]), .X(n1842) );
  UDB116SVT24_OAI21_0P75 U2426 ( .A1(n1852), .A2(n1843), .B(n1842), .X(
        \pkt_reg_inst/n68 ) );
  UDB116SVT24_AOI22_1 U2427 ( .A1(n1849), .A2(\pkt_reg_inst/pkt_reg [26]), 
        .B1(n1844), .B2(\pkt_reg_inst/pkt_reg [34]), .X(n1845) );
  UDB116SVT24_OAI21_0P75 U2428 ( .A1(n1852), .A2(n1846), .B(n1845), .X(
        \pkt_reg_inst/n69 ) );
  UDB116SVT24_BUF_1 U2429 ( .A(n1858), .X(n1855) );
  UDB116SVT24_AOI22_1 U2430 ( .A1(n1849), .A2(\pkt_reg_inst/pkt_reg [25]), 
        .B1(n1855), .B2(\pkt_reg_inst/pkt_reg [33]), .X(n1847) );
  UDB116SVT24_OAI21_0P75 U2431 ( .A1(n1852), .A2(n1848), .B(n1847), .X(
        \pkt_reg_inst/n70 ) );
  UDB116SVT24_AOI22_1 U2432 ( .A1(n1849), .A2(\pkt_reg_inst/pkt_reg [24]), 
        .B1(n1855), .B2(\pkt_reg_inst/pkt_reg [32]), .X(n1850) );
  UDB116SVT24_OAI21_0P75 U2433 ( .A1(n1852), .A2(n1851), .B(n1850), .X(
        \pkt_reg_inst/n71 ) );
  UDB116SVT24_INV_0P75 U2434 ( .A(n1865), .X(n1864) );
  UDB116SVT24_BUF_1 U2435 ( .A(n1877), .X(n1861) );
  UDB116SVT24_AOI22_1 U2436 ( .A1(n1861), .A2(\pkt_reg_inst/pkt_reg [23]), 
        .B1(n1855), .B2(\pkt_reg_inst/pkt_reg [31]), .X(n1853) );
  UDB116SVT24_OAI21_0P75 U2437 ( .A1(n1864), .A2(n1854), .B(n1853), .X(
        \pkt_reg_inst/n72 ) );
  UDB116SVT24_AOI22_1 U2438 ( .A1(n1861), .A2(\pkt_reg_inst/pkt_reg [22]), 
        .B1(n1855), .B2(\pkt_reg_inst/pkt_reg [30]), .X(n1856) );
  UDB116SVT24_OAI21_0P75 U2439 ( .A1(n1864), .A2(n1857), .B(n1856), .X(
        \pkt_reg_inst/n73 ) );
  UDB116SVT24_BUF_1 U2440 ( .A(n1858), .X(n1868) );
  UDB116SVT24_AOI22_1 U2441 ( .A1(n1861), .A2(\pkt_reg_inst/pkt_reg [21]), 
        .B1(n1868), .B2(\pkt_reg_inst/pkt_reg [29]), .X(n1859) );
  UDB116SVT24_OAI21_0P75 U2442 ( .A1(n1864), .A2(n1860), .B(n1859), .X(
        \pkt_reg_inst/n74 ) );
  UDB116SVT24_AOI22_1 U2443 ( .A1(n1861), .A2(\pkt_reg_inst/pkt_reg [20]), 
        .B1(n1868), .B2(\pkt_reg_inst/pkt_reg [28]), .X(n1862) );
  UDB116SVT24_OAI21_0P75 U2444 ( .A1(n1864), .A2(n1863), .B(n1862), .X(
        \pkt_reg_inst/n75 ) );
  UDB116SVT24_INV_0P75 U2445 ( .A(n1865), .X(n1876) );
  UDB116SVT24_BUF_1 U2446 ( .A(n1877), .X(n1873) );
  UDB116SVT24_AOI22_1 U2447 ( .A1(n1873), .A2(\pkt_reg_inst/pkt_reg [19]), 
        .B1(n1868), .B2(\pkt_reg_inst/pkt_reg [27]), .X(n1866) );
  UDB116SVT24_OAI21_0P75 U2448 ( .A1(n1876), .A2(n1867), .B(n1866), .X(
        \pkt_reg_inst/n76 ) );
  UDB116SVT24_AOI22_1 U2449 ( .A1(n1873), .A2(\pkt_reg_inst/pkt_reg [18]), 
        .B1(n1868), .B2(\pkt_reg_inst/pkt_reg [26]), .X(n1869) );
  UDB116SVT24_OAI21_0P75 U2450 ( .A1(n1876), .A2(n1870), .B(n1869), .X(
        \pkt_reg_inst/n77 ) );
  UDB116SVT24_BUF_1 U2451 ( .A(n1912), .X(n1895) );
  UDB116SVT24_BUF_1 U2452 ( .A(n1895), .X(n1880) );
  UDB116SVT24_AOI22_1 U2453 ( .A1(n1873), .A2(\pkt_reg_inst/pkt_reg [17]), 
        .B1(n1880), .B2(\pkt_reg_inst/pkt_reg [25]), .X(n1871) );
  UDB116SVT24_OAI21_0P75 U2454 ( .A1(n1876), .A2(n1872), .B(n1871), .X(
        \pkt_reg_inst/n78 ) );
  UDB116SVT24_AOI22_1 U2455 ( .A1(n1873), .A2(\pkt_reg_inst/pkt_reg [16]), 
        .B1(n1880), .B2(\pkt_reg_inst/pkt_reg [24]), .X(n1874) );
  UDB116SVT24_OAI21_0P75 U2456 ( .A1(n1876), .A2(n1875), .B(n1874), .X(
        \pkt_reg_inst/n79 ) );
  UDB116SVT24_INV_0P75 U2457 ( .A(n1906), .X(n1888) );
  UDB116SVT24_BUF_1 U2458 ( .A(n1877), .X(n1885) );
  UDB116SVT24_AOI22_1 U2459 ( .A1(n1885), .A2(\pkt_reg_inst/pkt_reg [15]), 
        .B1(n1880), .B2(\pkt_reg_inst/pkt_reg [23]), .X(n1878) );
  UDB116SVT24_OAI21_0P75 U2460 ( .A1(n1888), .A2(n1879), .B(n1878), .X(
        \pkt_reg_inst/n80 ) );
  UDB116SVT24_AOI22_1 U2461 ( .A1(n1885), .A2(\pkt_reg_inst/pkt_reg [14]), 
        .B1(n1880), .B2(\pkt_reg_inst/pkt_reg [22]), .X(n1881) );
  UDB116SVT24_OAI21_0P75 U2462 ( .A1(n1888), .A2(n1882), .B(n1881), .X(
        \pkt_reg_inst/n81 ) );
  UDB116SVT24_BUF_1 U2463 ( .A(n1895), .X(n1892) );
  UDB116SVT24_AOI22_1 U2464 ( .A1(n1885), .A2(\pkt_reg_inst/pkt_reg [13]), 
        .B1(n1892), .B2(\pkt_reg_inst/pkt_reg [21]), .X(n1883) );
  UDB116SVT24_OAI21_0P75 U2465 ( .A1(n1888), .A2(n1884), .B(n1883), .X(
        \pkt_reg_inst/n82 ) );
  UDB116SVT24_AOI22_1 U2466 ( .A1(n1885), .A2(\pkt_reg_inst/pkt_reg [12]), 
        .B1(n1892), .B2(\pkt_reg_inst/pkt_reg [20]), .X(n1886) );
  UDB116SVT24_OAI21_0P75 U2467 ( .A1(n1888), .A2(n1887), .B(n1886), .X(
        \pkt_reg_inst/n83 ) );
  UDB116SVT24_INV_0P75 U2468 ( .A(n1906), .X(n1901) );
  UDB116SVT24_BUF_1 U2469 ( .A(n1889), .X(n1898) );
  UDB116SVT24_AOI22_1 U2470 ( .A1(n1898), .A2(\pkt_reg_inst/pkt_reg [11]), 
        .B1(n1892), .B2(\pkt_reg_inst/pkt_reg [19]), .X(n1890) );
  UDB116SVT24_OAI21_0P75 U2471 ( .A1(n1901), .A2(n1891), .B(n1890), .X(
        \pkt_reg_inst/n84 ) );
  UDB116SVT24_AOI22_1 U2472 ( .A1(n1898), .A2(\pkt_reg_inst/pkt_reg [10]), 
        .B1(n1892), .B2(\pkt_reg_inst/pkt_reg [18]), .X(n1893) );
  UDB116SVT24_OAI21_0P75 U2473 ( .A1(n1901), .A2(n1894), .B(n1893), .X(
        \pkt_reg_inst/n85 ) );
  UDB116SVT24_BUF_1 U2474 ( .A(n1895), .X(n1907) );
  UDB116SVT24_AOI22_1 U2475 ( .A1(n1898), .A2(\pkt_reg_inst/pkt_reg [9]), .B1(
        n1907), .B2(\pkt_reg_inst/pkt_reg [17]), .X(n1896) );
  UDB116SVT24_OAI21_0P75 U2476 ( .A1(n1901), .A2(n1897), .B(n1896), .X(
        \pkt_reg_inst/n86 ) );
  UDB116SVT24_AOI22_1 U2477 ( .A1(n1898), .A2(\pkt_reg_inst/pkt_reg [8]), .B1(
        n1907), .B2(\pkt_reg_inst/pkt_reg [16]), .X(n1899) );
  UDB116SVT24_OAI21_0P75 U2478 ( .A1(n1901), .A2(n1900), .B(n1899), .X(
        \pkt_reg_inst/n87 ) );
  UDB116SVT24_BUF_1 U2479 ( .A(n1902), .X(n1913) );
  UDB116SVT24_AOI22_1 U2480 ( .A1(n1913), .A2(\pkt_reg_inst/pkt_reg [7]), .B1(
        n1907), .B2(\pkt_reg_inst/pkt_reg [15]), .X(n1903) );
  UDB116SVT24_OAI21_0P75 U2481 ( .A1(n1905), .A2(n1904), .B(n1903), .X(
        \pkt_reg_inst/n88 ) );
  UDB116SVT24_INV_0P75 U2482 ( .A(n1906), .X(n1919) );
  UDB116SVT24_AOI22_1 U2483 ( .A1(n1913), .A2(\pkt_reg_inst/pkt_reg [6]), .B1(
        n1907), .B2(\pkt_reg_inst/pkt_reg [14]), .X(n1908) );
  UDB116SVT24_OAI21_0P75 U2484 ( .A1(n1919), .A2(n1909), .B(n1908), .X(
        \pkt_reg_inst/n89 ) );
  UDB116SVT24_AOI22_1 U2485 ( .A1(n1913), .A2(\pkt_reg_inst/pkt_reg [5]), .B1(
        n1920), .B2(\pkt_reg_inst/pkt_reg [13]), .X(n1910) );
  UDB116SVT24_OAI21_0P75 U2486 ( .A1(n1919), .A2(n1911), .B(n1910), .X(
        \pkt_reg_inst/n90 ) );
  UDB116SVT24_AOI22_1 U2487 ( .A1(n1913), .A2(\pkt_reg_inst/pkt_reg [4]), .B1(
        n1912), .B2(\pkt_reg_inst/pkt_reg [12]), .X(n1914) );
  UDB116SVT24_OAI21_0P75 U2488 ( .A1(n1919), .A2(n1915), .B(n1914), .X(
        \pkt_reg_inst/n91 ) );
  UDB116SVT24_BUF_1 U2489 ( .A(n1916), .X(n1926) );
  UDB116SVT24_AOI22_1 U2490 ( .A1(n1926), .A2(\pkt_reg_inst/pkt_reg [3]), .B1(
        n1920), .B2(\pkt_reg_inst/pkt_reg [11]), .X(n1917) );
  UDB116SVT24_OAI21_0P75 U2491 ( .A1(n1919), .A2(n1918), .B(n1917), .X(
        \pkt_reg_inst/n92 ) );
  UDB116SVT24_AOI22_1 U2492 ( .A1(n1926), .A2(\pkt_reg_inst/pkt_reg [2]), .B1(
        n1920), .B2(\pkt_reg_inst/pkt_reg [10]), .X(n1921) );
  UDB116SVT24_OAI21_0P75 U2493 ( .A1(n1929), .A2(n1922), .B(n1921), .X(
        \pkt_reg_inst/n93 ) );
  UDB116SVT24_AOI22_1 U2494 ( .A1(n1926), .A2(\pkt_reg_inst/pkt_reg [1]), .B1(
        n1925), .B2(\pkt_reg_inst/pkt_reg [9]), .X(n1923) );
  UDB116SVT24_OAI21_0P75 U2495 ( .A1(n1929), .A2(n1924), .B(n1923), .X(
        \pkt_reg_inst/n94 ) );
  UDB116SVT24_AOI22_1 U2496 ( .A1(n1926), .A2(\pkt_reg_inst/pkt_reg [0]), .B1(
        n1925), .B2(\pkt_reg_inst/pkt_reg [8]), .X(n1927) );
  UDB116SVT24_OAI21_0P75 U2497 ( .A1(n1929), .A2(n1928), .B(n1927), .X(
        \pkt_reg_inst/n95 ) );
  UDB116SVT24_AO22_1 U2498 ( .A1(n945), .A2(SPI_IN[0]), .B1(
        \pkt_reg_inst/pkt_reg [56]), .B2(n1003), .X(\pkt_reg_inst/n32 ) );
  UDB116SVT24_AO22_1 U2499 ( .A1(n944), .A2(SPI_IN[1]), .B1(
        \pkt_reg_inst/pkt_reg [57]), .B2(n1004), .X(\pkt_reg_inst/n33 ) );
  UDB116SVT24_AO22_1 U2500 ( .A1(n945), .A2(SPI_IN[2]), .B1(
        \pkt_reg_inst/pkt_reg [58]), .B2(n1003), .X(\pkt_reg_inst/n34 ) );
  UDB116SVT24_AO22_1 U2501 ( .A1(n944), .A2(SPI_IN[5]), .B1(
        \pkt_reg_inst/pkt_reg [61]), .B2(n1004), .X(\pkt_reg_inst/n37 ) );
  UDB116SVT24_AO22_1 U2502 ( .A1(n945), .A2(SPI_IN[3]), .B1(
        \pkt_reg_inst/pkt_reg [59]), .B2(n1003), .X(\pkt_reg_inst/n35 ) );
  UDB116SVT24_AO22_1 U2503 ( .A1(n944), .A2(SPI_IN[7]), .B1(
        \pkt_reg_inst/pkt_reg [63]), .B2(n1004), .X(\pkt_reg_inst/n39 ) );
  UDB116SVT24_AO22_1 U2504 ( .A1(n945), .A2(SPI_IN[4]), .B1(
        \pkt_reg_inst/pkt_reg [60]), .B2(n1003), .X(\pkt_reg_inst/n36 ) );
  UDB116SVT24_AO22_1 U2505 ( .A1(\tx_buf_inst/buffer [0]), .A2(n943), .B1(n947), .B2(SPI_OUT[0]), .X(\tx_buf_inst/n12 ) );
  UDB116SVT24_AOI21_0P75 U2506 ( .A1(n897), .A2(n1935), .B(n1934), .X(n1939)
         );
  UDB116SVT24_AOAI211_0P75 U2507 ( .A1(counter[2]), .A2(rx_state[2]), .B(n1936), .C(counter[3]), .X(n1937) );
  UDB116SVT24_OAI21_0P75 U2508 ( .A1(n1939), .A2(n1938), .B(n1937), .X(n846)
         );
  UDB116SVT24_OAI21_0P75 U2509 ( .A1(n1000), .A2(n1941), .B(n1940), .X(n1942)
         );
  UDB116SVT24_OAI21_0P75 U2510 ( .A1(n1943), .A2(n971), .B(n1942), .X(n844) );
  UDB116SVT24_OAI21_0P75 U2511 ( .A1(n1946), .A2(n1945), .B(n1944), .X(n839)
         );
  UDB116SVT24_AO22_1 U2512 ( .A1(counter3[0]), .A2(n1949), .B1(n1948), .B2(
        n1947), .X(n833) );
  UDB116SVT24_ND2_MM_0P75 U2513 ( .A1(n1952), .A2(TX_EN), .X(n1950) );
  UDB116SVT24_OAI21_0P75 U2514 ( .A1(n1952), .A2(n1951), .B(n1950), .X(n829)
         );
  UDB116SVT24_AO21B_0P75 U2515 ( .A1(n866), .A2(n1953), .B(SPI_LD), .X(n1954)
         );
  UDB116SVT24_OAI21_0P75 U2516 ( .A1(n1955), .A2(n1020), .B(n1954), .X(n828)
         );
>>>>>>> 8334d12b4657a094ccdd22848e8853946d20d6e8
endmodule
