...
add wave -noupdate /testbench/TX_BY
add wave -noupdate /testbench/set_ext_counter
...
add wave -noupdate /testbench/top_slave/SPI_OUT_RDY
add wave -noupdate /testbench/top_slave/SPI_OUT
add wave -noupdate /testbench/top_slave/ext_counter
add wave -noupdate /testbench/top_slave/ext_counter_msb
...
add wave -noupdate /testbench/top_slave/sh_sync_inst/state
